...
public class ManifestMF extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_21 = NL + "Provide-Capability: ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (genModel.getOSGiStyle().contains(GenOSGiStyle.PROVIDE_CAPABILITY_GENERATED_PACKAGE)) {
			Iterator<String> provideCapabilitiesIterator = genModel.getModelProvideCapabilities().iterator();
			if (provideCapabilitiesIterator.hasNext()) {
				String cap = provideCapabilitiesIterator.next();
				stringBuffer.append(TEXT_21);
				stringBuffer.append(cap);
				while (provideCapabilitiesIterator.hasNext()) {
					cap = provideCapabilitiesIterator.next();
					stringBuffer.append(TEXT_14);
					stringBuffer.append(TEXT_15);
					stringBuffer.append(cap);
				}
