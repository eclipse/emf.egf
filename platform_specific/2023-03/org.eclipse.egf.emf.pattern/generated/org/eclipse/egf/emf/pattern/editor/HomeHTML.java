...
public class HomeHTML extends org.eclipse.egf.emf.pattern.base.GenModelText {
  ...
  protected final String TEXT_2 = " Application</title>" + NL + "    " + NL + "    <style TYPE=\"text/css\">" + NL
      + "      <!--" + NL + "        .ToolBar" + NL + "        {" + NL + "          background-color: #d0e4f6;" + NL
      + "        }" + NL + "        .ToolBarButton" + NL + "        {" + NL + "          float: left;" + NL
      + "          margin-top: 5px;" + NL + "        }" + NL + "        .ToolBarButtonLeftMargin" + NL + "        {"
      + NL + "          float: left;" + NL + "          margin-left: 10px;" + NL + "          margin-top: 5px;" + NL
      + "        }" + NL + "        .Header" + NL + "        {" + NL + "          background-color: #628cd5;" + NL
      + "          color: #FFFFFF;" + NL + "          float: left;" + NL + "          font-weight: bold;" + NL
      + "          font-size: xx-large;" + NL + "        }" + NL + "        .HeaderLabel" + NL + "        {" + NL
      + "          float: left;" + NL + "          margin-left: 10px;" + NL + "        }" + NL
      + "        .PropertiesTitle" + NL + "        {" + NL + "          background-color: #628cd5;" + NL
      + "          color: #FFFFFF;" + NL + "          font-weight: bold;" + NL + "          font-size: large;" + NL
      + "        }" + NL + "        .PropertiesTitleLabel" + NL + "        {" + NL + "          float: left;" + NL
  ...
  protected final String TEXT_4 = ".nocache.js\"></script>" + NL + "  </head>" + NL + "" + NL
      + "  <body style=\"height : 100%\">" + NL + "    <div id=\"main\" style=\"height : 100%\">" + NL + "    </div>"
      + NL + "  </body>" + NL + "</html>" + NL;
