...
public class SwitchClass extends org.eclipse.egf.emf.pattern.base.GenPackageJava {
  ...
  protected final String TEXT_4 = NL + NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL
      ...
      + " * until a non-null result is returned," + NL + " * which is the result of the switch." + NL
      + " * <!-- end-user-doc -->" + NL + " * @see ";
  ...
  protected final String TEXT_20 = NL + "\t/**" + NL + "\t * Checks whether this is a switch for the given package."
      ...
      + "\t * @return whether this is a switch for the given package." + NL + "\t * @generated" + NL + "\t */" + NL
      + "\t@Override" + NL + "\tprotected boolean isSwitchFor(EPackage ePackage)" + NL + "\t{" + NL
  ...
  protected final String TEXT_60 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * This implementation returns null;" + NL + "\t * returning a non-null result will terminate the switch."
      + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param object the target of the switch." + NL
