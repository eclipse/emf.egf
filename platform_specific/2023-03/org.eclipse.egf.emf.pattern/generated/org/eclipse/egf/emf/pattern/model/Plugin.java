...
public class Plugin extends org.eclipse.egf.emf.pattern.base.GenModelJava {
  ...
  protected final String TEXT_26 = NL + "\t/**" + NL + "\t * Returns the singleton instance of the Eclipse plugin." + NL
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the singleton instance."
  ...
  protected final String TEXT_32 = ");" + NL + "" + NL + "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL
      + "\t\t\tplugin = this;" + NL + "\t\t}";
  ...
  protected final String TEXT_37 = " createBundle()" + NL + "\t\t\t{" + NL + "\t\t\t\treturn new Implementation();" + NL
      + "\t\t\t}" + NL + "\t\t}";
