...
public class Class extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_108 = NL + "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
	protected final String TEXT_109 = NL + "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
	protected final String TEXT_110 = NL + "\t}" + NL;
	protected final String TEXT_111 = " eInverseRemove(";
	protected final String TEXT_112 = ")((";
	protected final String TEXT_113 = "()).eMap()).basicRemove(otherEnd, msgs);";
	protected final String TEXT_114 = ".Internal.Wrapper)";
	protected final String TEXT_115 = "()).featureMap()).basicRemove(otherEnd, msgs);";
	protected final String TEXT_116 = "()).basicRemove(otherEnd, msgs);";
	protected final String TEXT_117 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
	protected final String TEXT_118 = NL + "\t\t\t\treturn basicUnset";
	protected final String TEXT_119 = "(msgs);";
	protected final String TEXT_120 = "(null, msgs);";
	protected final String TEXT_121 = NL + "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
	protected final String TEXT_122 = NL + "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
	protected final String TEXT_123 = " eBasicRemoveFromContainerFeature(";
	protected final String TEXT_124 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID()";
	protected final String TEXT_125 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
	protected final String TEXT_126 = NL + "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
	protected final String TEXT_127 = NL + "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
	protected final String TEXT_128 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL
			+ "\t{" + NL + "\t\tswitch (featureID";
	protected final String TEXT_129 = NL + "\t\t\t\treturn ";
	protected final String TEXT_130 = "() ? Boolean.TRUE : Boolean.FALSE;";
	protected final String TEXT_131 = NL + "\t\t\t\treturn new ";
	protected final String TEXT_132 = "());";
	protected final String TEXT_133 = NL + "\t\t\t\tif (resolve) return ";
	protected final String TEXT_134 = "();" + NL + "\t\t\t\treturn basicGet";
	protected final String TEXT_135 = NL + "\t\t\t\tif (coreType) return ((";
	protected final String TEXT_136 = "()).eMap();" + NL + "\t\t\t\telse return ";
	protected final String TEXT_137 = NL + "\t\t\t\tif (coreType) return ";
	protected final String TEXT_138 = "();" + NL + "\t\t\t\telse return ";
	protected final String TEXT_139 = "().map();";
	protected final String TEXT_140 = "()).featureMap();" + NL + "\t\t\t\treturn ";
	protected final String TEXT_141 = "();" + NL + "\t\t\t\treturn ((";
	protected final String TEXT_142 = ".Internal)";
	protected final String TEXT_143 = "()).getWrapper();";
	protected final String TEXT_144 = NL + "\t\treturn super.eGet(featureID, resolve, coreType);";
	protected final String TEXT_145 = NL + "\t\treturn eDynamicGet(featureID, resolve, coreType);";
	protected final String TEXT_146 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL
			+ "\t\tswitch (featureID";
	protected final String TEXT_147 = NL + "\t\t\t\t((";
	protected final String TEXT_148 = ".Internal)((";
	protected final String TEXT_149 = "()).featureMap()).set(newValue);";
	protected final String TEXT_150 = "()).set(newValue);";
	protected final String TEXT_151 = ".Setting)((";
	protected final String TEXT_152 = "()).eMap()).set(newValue);";
	protected final String TEXT_153 = ".Setting)";
	protected final String TEXT_154 = "().clear();" + NL + "\t\t\t\t";
	protected final String TEXT_155 = "().addAll((";
	protected final String TEXT_156 = "<? extends ";
	protected final String TEXT_157 = ">";
	protected final String TEXT_158 = ")newValue);";
	...
	protected final String TEXT_164 = NL + "\t\tsuper.eSet(featureID, newValue);";
	protected final String TEXT_165 = NL + "\t\teDynamicSet(featureID, newValue);";
	protected final String TEXT_166 = NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class";
	protected final String TEXT_167 = " baseClass)" + NL + "\t{";
	protected final String TEXT_168 = NL + "\t\tif (baseClass == ";
	protected final String TEXT_169 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID";
	protected final String TEXT_170 = ")" + NL + "\t\t\t{";
	protected final String TEXT_171 = NL + "\t\t\t\tcase ";
	protected final String TEXT_172 = ": return ";
	protected final String TEXT_173 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_174 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);"
			+ NL + "\t}";
	protected final String TEXT_175 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_176 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
	protected final String TEXT_177 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
	protected final String TEXT_178 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID";
	protected final String TEXT_179 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);"
			+ NL + "\t}" + NL;
	protected final String TEXT_180 = NL + "\tpublic int eDerivedOperationID(int baseOperationID, Class";
	protected final String TEXT_181 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID)" + NL + "\t\t\t{";
	protected final String TEXT_182 = NL
			+ "\t\t\t\tdefault: return super.eDerivedOperationID(baseOperationID, baseClass);" + NL + "\t\t\t}" + NL
			+ "\t\t}";
	protected final String TEXT_183 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID";
	protected final String TEXT_184 = NL + "\t\treturn super.eDerivedOperationID(baseOperationID, baseClass);" + NL
			+ "\t}" + NL;
	protected final String TEXT_185 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
	protected final String TEXT_186 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_187 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL
			+ "\t\t";
	protected final String TEXT_188 = " = newValues;" + NL + "\t}" + NL;
	protected final String TEXT_189 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL
			+ "\t\tswitch (offset)" + NL + "\t\t{";
	protected final String TEXT_190 = " :" + NL + "\t\t\t\treturn ";
	protected final String TEXT_191 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();"
			+ NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_192 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL
			+ "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
	protected final String TEXT_193 = " :" + NL + "\t\t\t\t";
	protected final String TEXT_194 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
	protected final String TEXT_195 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();"
			+ NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_196 = NL + "\t@SuppressWarnings(";
	protected final String TEXT_197 = "\"unchecked\"";
	protected final String TEXT_198 = "{\"rawtypes\", \"unchecked\" }";
	protected final String TEXT_199 = NL + "\tpublic Object eInvoke(int operationID, ";
	protected final String TEXT_200 = " arguments) throws ";
	protected final String TEXT_201 = NL + "\t{" + NL + "\t\tswitch (operationID";
	protected final String TEXT_202 = NL + "\t\t\t\ttry" + NL + "\t\t\t\t{";
	protected final String TEXT_203 = "arguments.get(";
	protected final String TEXT_204 = ").";
	protected final String TEXT_205 = ");" + NL + "\t\t\t\t";
	protected final String TEXT_206 = "return null;";
	protected final String TEXT_207 = "return ";
	protected final String TEXT_208 = "new ";
	protected final String TEXT_209 = NL + "\t\t\t\t}" + NL + "\t\t\t\tcatch (";
	protected final String TEXT_210 = " throwable)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tthrow new ";
	protected final String TEXT_211 = "(throwable);" + NL + "\t\t\t\t}";
	protected final String TEXT_212 = NL + "\t\treturn super.eInvoke(operationID, arguments);";
	protected final String TEXT_213 = NL + "\t\treturn eDynamicInvoke(operationID, arguments);";
	protected final String TEXT_214 = NL + "\tpublic String toString()" + NL + "\t{" + NL
			+ "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\t";
	protected final String TEXT_215 = " result = new ";
	protected final String TEXT_216 = "(super.toString());";
	protected final String TEXT_217 = NL + "\t\tresult.append(\" (";
	protected final String TEXT_218 = ": \");";
	protected final String TEXT_219 = NL + "\t\tresult.append(\", ";
	protected final String TEXT_220 = NL + "\t\tif (eVirtualIsSet(";
	protected final String TEXT_221 = ")) result.append(eVirtualGet(";
	protected final String TEXT_222 = ")); else result.append(\"<unset>\");";
	protected final String TEXT_223 = NL + "\t\tif (";
	protected final String TEXT_224 = " & ";
	protected final String TEXT_225 = "_ESETFLAG) != 0";
	protected final String TEXT_226 = "ESet";
	protected final String TEXT_227 = ") result.append((";
	protected final String TEXT_228 = "_EFLAG) != 0); else result.append(\"<unset>\");";
	protected final String TEXT_229 = ") result.append(";
	protected final String TEXT_230 = "_EFLAG_VALUES[(";
	protected final String TEXT_231 = "_EFLAG) >>> ";
	protected final String TEXT_232 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
	protected final String TEXT_233 = "); else result.append(\"<unset>\");";
	protected final String TEXT_234 = NL + "\t\tresult.append(eVirtualGet(";
	protected final String TEXT_235 = "));";
	protected final String TEXT_236 = NL + "\t\tresult.append((";
	protected final String TEXT_237 = "_EFLAG) != 0);";
	protected final String TEXT_238 = NL + "\t\tresult.append(";
	protected final String TEXT_239 = "_EFLAG_OFFSET]);";
