...
method_setupVariable(ictx.getBuffer(), ictx, parameter);
    ExecutionContext ctx__GS_zABupEda8fQhd1F89Q = new ExecutionContext(ictx);
ctx__GS_zABupEda8fQhd1F89Q.setValue(PatternContext.INJECTED_CONTEXT, variable);
CallHelper.execute("_RdSMYBViEd-JoY-b5_Vpcw", ctx__GS_zABupEda8fQhd1F89Q);
