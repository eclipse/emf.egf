package org.eclipse.emf.examples.library.egf.editor.pluginproperties;
...
public class EditorPluginPropertiesExtensionRedefinitionSolution extends
		org.eclipse.egf.emf.pattern.editor.PluginProperties {
	protected static String nl;

	public static synchronized EditorPluginPropertiesExtensionRedefinitionSolution create(
	...
	protected final String TEXT_8 = NL + "#--  Customization - Start" + NL
			+ "_UI_CreateChild_menu_item = &[Library] New Child" + NL
			+ "_UI_CreateSibling_menu_item = [Library] N&ew Sibling" + NL
			+ "#--  Customization - End" + NL;
	protected final String TEXT_9 = NL
			+ "_UI_ShowPropertiesView_menu_item = Show &Properties View" + NL
			+ "_UI_RefreshViewer_menu_item = &Refresh" + NL + "" + NL
			+ "_UI_SelectionPage_label = Selection";
	protected final String TEXT_10 = NL + "_UI_ParentPage_label = Parent" + NL
			+ "_UI_ListPage_label = List" + NL + "_UI_TreePage_label = Tree"
			+ NL + "_UI_TablePage_label = Table" + NL
			+ "_UI_TreeWithColumnsPage_label = Tree with Columns" + NL
			+ "_UI_ObjectColumn_label = Object" + NL
	...
	protected final String TEXT_23 = NL
			...
			+ NL + "" + NL + "_UI_ModelObject = &Model Object" + NL
			+ "_UI_XMLEncoding = &XML Encoding" + NL
	...
	protected final String TEXT_29 = " Action Set" + NL
			+ "_UI_Perspective_label = ";
	...
	protected final String TEXT_31 = " Application"
			+ NL
			...
			+ NL + "_UI_Menu_Edit_label = &Edit" + NL
			+ "_UI_Menu_Window_label = &Window" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		for (GenPackage genPackage : genModel
			...
			stringBuffer
					.append(genPackage.isMultipleFileExtensions() ? genPackage
							.getFileExtensions() : genPackage
							.getFileExtension());
