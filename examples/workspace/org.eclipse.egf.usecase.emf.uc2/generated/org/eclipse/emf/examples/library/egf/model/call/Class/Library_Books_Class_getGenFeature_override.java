...
public class Library_Books_Class_getGenFeature_override extends
		org.eclipse.egf.emf.pattern.model.call.Class.ClassgetGenFeatureoverride {
	protected static String nl;

	public static synchronized Library_Books_Class_getGenFeature_override create(
	...
	protected final String TEXT_4 = "() "
			...
			+ NL + "            //    with the \"stock\" superset" + NL
			+ "            books = new ";
	protected final String TEXT_5 = "<Book>(Book.class, this, EXTLibraryPackage.LIBRARY__BOOKS) {"
			+ NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		stringBuffer.append(genModel
				.getImportedName("org.eclipse.emf.ecore.util.EObjectEList"));
