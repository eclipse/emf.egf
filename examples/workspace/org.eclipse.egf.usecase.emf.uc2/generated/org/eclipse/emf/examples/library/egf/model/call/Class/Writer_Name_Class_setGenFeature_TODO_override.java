...
public class Writer_Name_Class_setGenFeature_TODO_override
		extends
		org.eclipse.egf.emf.pattern.model.call.Class.ClasssetGenFeatureTODOoverride {
	protected static String nl;

	public static synchronized Writer_Name_Class_setGenFeature_TODO_override create(
	...
	protected final String TEXT_1 = "    if (newName == null || newName.length() == 0) {"
			+ NL
			+ "        setFirstName(null);"
			+ NL
			+ "        setLastName(null);"
	...
	public String orchestration(PatternContext ctx) throws Exception {
		...
		if (ictx.useReporter()) {
			...
			parameterValues.put("setAccessorOperation",
					this.setAccessorOperation);
