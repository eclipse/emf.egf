...
public class Writer_Name_Class_getGenFeature_TODO_override
	...
	public static synchronized Writer_Name_Class_getGenFeature_TODO_override create(
	...
	protected final String TEXT_1 = "        if (getFirstName() == null) {"
			+ NL + "            if (getLastName() == null) {" + NL
			+ "                return \"\"; ";
