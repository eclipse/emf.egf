...
public class Writer_Name_Class_getGenFeature_TODO_override
	...
	protected final String TEXT_1 = "//INJECTED-CODE-BEGIN : Writer.getName()" + NL
			+ "        if (getFirstName() == null) {" + NL + "            if (getLastName() == null) {" + NL
			+ "                return \"\"; ";
	protected final String TEXT_2 = NL + "            }" + NL + "            return getLastName();" + NL
			+ "        } else if (getLastName() == null) {" + NL + "            return getFirstName();" + NL
			+ "        } else {" + NL + "            StringBuffer result = new StringBuffer();" + NL
			+ "            result.append(getFirstName()).append(' ').append(getLastName());" + NL
