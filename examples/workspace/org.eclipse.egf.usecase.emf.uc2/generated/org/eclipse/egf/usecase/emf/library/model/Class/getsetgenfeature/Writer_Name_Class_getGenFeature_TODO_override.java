...
public class Writer_Name_Class_getGenFeature_TODO_override extends org.eclipse.egf.emf.pattern.model.call.Class.ClassgetGenFeatureTODOoverride {
    ...
    public String orchestration(PatternContext ctx) throws Exception {
        ...
        ictx.getBuffer().append("// begin pattern Writer_Name_Class_getGenFeature_TODO_override\n");

        super.orchestration(new SuperOrchestrationContext(ictx));

        ictx.getBuffer().append("// End pattern Writer_Name_Class_getGenFeature_TODO_override\n");
