...
public class Library_Stock_Class_getGenFeature_override extends org.eclipse.egf.emf.pattern.model.call.Class.ClassgetGenFeatureoverride {
    ...
    public String orchestration(PatternContext ctx) throws Exception {
        ...
        ictx.getBuffer().append("// begin pattern Library_Stock_Class_getGenFeature_override\n");

        super.orchestration(new SuperOrchestrationContext(ictx));

        ictx.getBuffer().append("// End pattern Library_Stock_Class_getGenFeature_override\n");
