...
package org.eclipse.egf.usecase.emf.library.model.Class.constructoroverride;
...
public class ConstructorOverride
		extends org.eclipse.egf.emf.pattern.model.call.Class.ClassegfCustomconstructoroverride {
	protected static String nl;

	public static synchronized ConstructorOverride create(String lineSeparator) {
		nl = lineSeparator;
		ConstructorOverride result = new ConstructorOverride();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "// Constructor overriden" + NL + "super()";
