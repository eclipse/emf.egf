...
public class ReservationgetDescription extends org.eclipse.egf.emf.pattern.model.call.Class.Classinsert {
	...
	protected final String TEXT_1 = "//INJECTED-CODE-BEGIN : ReservationImpl#getDescription()" + NL + "/**" + NL
			...
			+ "\tif (isFinished())" + NL + "\t\tresult = result + \"[DONE] items [\";" + NL + "\telse" + NL
			+ "\t\tresult = result + \"[TODO] items [\";" + NL + "" + NL + "\tresult=result + items;" + NL
