...
package org.eclipse.egf.example.type.extension.util;
...
public class ExtensionSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ExtensionPackage.EXTENDED_TYPE: {
                ExtendedType extendedType = (ExtendedType)theEObject;
                T result = caseExtendedType(extendedType);
                if (result == null) result = caseType(extendedType);
                if (result == null) result = caseTypeElement(extendedType);
