...
package org.eclipse.egf.productionplan.ui.l10n;

import org.eclipse.osgi.util.NLS;

public class ProductionPlanUIMessages {

  private static final String BUNDLE_NAME = "org.eclipse.egf.productionplan.ui.l10n.messages"; //$NON-NLS-1$

  private ProductionPlanUIMessages() {
    // Do not instantiate
  }

  static {
    // load message values from bundle file
    NLS.initializeMessages(BUNDLE_NAME, ProductionPlanUIMessages.class);
  }
