 ...
 * 
 */
package org.eclipse.egf.productionplan.ui.internal.ui;
...
/**
 * Bundle of most images used by the EGF Production Plan UI plug-in.
 */
public class ProductionPlanUIImages {
  ...
  private static ImageDescriptor create(String prefix, String name, boolean useMissingImageDescriptor) {
    ...
    return createImageDescriptor(ProductionPlanUIPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
  }
