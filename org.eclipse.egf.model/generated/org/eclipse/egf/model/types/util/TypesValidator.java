...
public class TypesValidator extends EObjectValidator {
  ...
  protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case TypesPackage.PRIMITIVE_OBJECT_TYPE:
      return validatePrimitiveObjectType((PrimitiveObjectType) value, diagnostics, context);
    ...
    case TypesPackage.PATTERN_EXECUTION_REPORTER_TYPE:
      return validatePatternExecutionReporterType((PatternExecutionReporterType) value, diagnostics, context);
  ...
  public boolean validateTypeElement(TypeElement typeElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validate_EveryMultiplicityConforms(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryDataValueConforms(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(typeElement, diagnostics, context);
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(typeElement, diagnostics, context);
    return result;
  }

  /**
   * Validates the overall constraint of '<em>Type Element</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateTypeElement_overall(TypeElement typeElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(createDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, "_UI_GenericConstraint_diagnostic", //$NON-NLS-1$
            new Object[] { "overall", getObjectLabel(typeElement, context) }, //$NON-NLS-1$
            new Object[] { typeElement }, context));
      }
      return false;
    }
    return true;
  ...
  public boolean validateType(Type type, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(type, diagnostics, context);
    return result;
  }
  ...
  public boolean validatePrimitiveObjectType(PrimitiveObjectType primitiveObjectType, DiagnosticChain diagnostics,
    ...
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(primitiveObjectType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(primitiveObjectType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(primitiveObjectType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(primitiveObjectType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(primitiveObjectType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(primitiveObjectType, diagnostics, context);
    return result;
  }
  ...
  public boolean validateBooleanType(BooleanType booleanType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(booleanType, diagnostics, context);
    return result;
  }
  ...
  public boolean validateStringType(StringType stringType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(stringType, diagnostics, context);
    return result;
  }
  ...
  public boolean validateClassType(ClassType classType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validate_EveryMultiplicityConforms(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryDataValueConforms(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(classType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(classType, diagnostics, context);
    return result;
  }
  ...
  public boolean validatePatternExecutionReporterType(PatternExecutionReporterType patternExecutionReporterType,
    ...
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(patternExecutionReporterType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(patternExecutionReporterType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(patternExecutionReporterType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(patternExecutionReporterType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(patternExecutionReporterType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(patternExecutionReporterType, diagnostics, context);
    return result;
  }
  ...
  public boolean validateGeneratorAdapterFactoryType(GeneratorAdapterFactoryType generatorAdapterFactoryType, DiagnosticChain diagnostics,
    ...
    if (result || diagnostics != null)
      result &= validateTypeElement_overall(generatorAdapterFactoryType, diagnostics, context);
    return result;
  }
