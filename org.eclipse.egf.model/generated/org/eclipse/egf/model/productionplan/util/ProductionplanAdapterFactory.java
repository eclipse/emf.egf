 ...
 * @generated
 */
public class ProductionplanAdapterFactory extends AdapterFactoryImpl {
  /**
   ...
   * @generated
   */
  protected static ProductionplanPackage modelPackage;
   ...
   * @generated
   */
  public ProductionplanAdapterFactory() {
    if (modelPackage == null) {
      modelPackage = ProductionplanPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected ProductionplanSwitch<Adapter> modelSwitch = new ProductionplanSwitch<Adapter>() {
    @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.egf.model.productionplan.ProductionPlan <em>Production Plan</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.egf.model.productionplan.ProductionPlanInvocation <em>Production Plan Invocation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.egf.model.productionplan.FactoryComponentInvocation <em>Factory Component Invocation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
