...
public class DomainValueImpl extends ContextValueImpl implements DomainValue {
  ...
  protected EClass eStaticClass() {
    return DomainPackage.Literals.DOMAIN_VALUE;
  }
  ...
  public void setDomain(Domain newDomain) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.DOMAIN_VALUE__DOMAIN, oldDomain, domain));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case DomainPackage.DOMAIN_VALUE__DOMAIN:
      return getDomain();
    }
