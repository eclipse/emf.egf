...
public class PatternSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PatternPackage.SUPER_METHOD: {
			...
			if (result == null)
				result = casePatternUnit(superMethod);
			if (result == null)
				result = caseModelElement(superMethod);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PatternPackage.LIBRARY: {
			...
			if (result == null)
				result = casePatternElement(library);
			if (result == null)
				result = casePatternUnit(library);
			if (result == null)
				result = caseModelElement(library);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
