...
public class PatternValidator extends EObjectValidator {
    ...
    protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        case PatternPackage.PATTERN_EXECUTION_REPORTER_TYPE:
    ...
    public boolean validatePatternExecutionReporterType(PatternExecutionReporterType patternExecutionReporterType, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null)
            result &= typesValidator.validateTypeClass_LoadableValue(patternExecutionReporterType, diagnostics, context);
        if (result || diagnostics != null)
            result &= typesValidator.validateTypeClass_ValidValue(patternExecutionReporterType, diagnostics, context);
        return result;
    }
