...
public class PatternValidator extends EObjectValidator {
  ...
  protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case PatternPackage.PATTERN_UNIT:
      return validatePatternUnit((PatternUnit) value, diagnostics, context);
    ...
    case PatternPackage.PATTERN_SUPER_METHOD:
      return validatePatternSuperMethod((PatternSuperMethod) value, diagnostics, context);
  ...
  public boolean validatePatternUnit(PatternUnit patternUnit, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validate_EveryMultiplicityConforms(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryDataValueConforms(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(patternUnit, diagnostics, context);
    if (result || diagnostics != null)
      result &= factoryComponentValidator.validateModelElement_overall(patternUnit, diagnostics, context);
    return result;
  }
  ...
  public boolean validatePatternSuperMethod(PatternSuperMethod patternSuperMethod, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validate_EveryMultiplicityConforms(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryDataValueConforms(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryReferenceIsContained(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryProxyResolves(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_UniqueID(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryKeyUnique(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= validate_EveryMapEntryUnique(patternSuperMethod, diagnostics, context);
    if (result || diagnostics != null)
      result &= factoryComponentValidator.validateModelElement_overall(patternSuperMethod, diagnostics, context);
    return result;
  }
