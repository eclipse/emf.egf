...
public class PatternValidator extends EObjectValidator {
    ...
    protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        case PatternPackage.PATTERN_ENGINE:
            return validatePatternEngine((PatternEngine) value, diagnostics, context);
     ...
     * @generated
     */
    public boolean validatePatternEngine(PatternEngine patternEngine, DiagnosticChain diagnostics, Map<Object, Object> context) {
        boolean result = validate_EveryMultiplicityConforms(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_EveryDataValueConforms(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_EveryReferenceIsContained(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_EveryProxyResolves(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_UniqueID(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_EveryKeyUnique(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= validate_EveryMapEntryUnique(patternEngine, diagnostics, context);
        if (result || diagnostics != null)
            result &= factoryComponentValidator.validateModelElement_overall(patternEngine, diagnostics, context);
        return result;
    }
