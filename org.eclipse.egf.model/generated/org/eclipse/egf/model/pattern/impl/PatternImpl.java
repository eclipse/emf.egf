...
public class PatternImpl extends PatternElementImpl implements Pattern {
  /**
   * The cached value of the '{@link #getHeaderMethod() <em>Header Method</em>}'
   * reference.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getFooterMethod() <em>Footer Method</em>}'
   * reference.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getSuperPattern() <em>Super Pattern</em>}'
   * reference.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getNature() <em>Nature</em>}' containment
   * reference.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getNature()
