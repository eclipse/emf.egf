...
public class PatternImpl extends PatternElementImpl implements Pattern {
  /**
   * The cached value of the '{@link #getHeaderMethod() <em>Header Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getHeaderMethod()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getFooterMethod() <em>Footer Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getFooterMethod()
   * @generated
  ...
  public NotificationChain basicSetHeaderMethod(PatternMethod newHeaderMethod, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatternPackage.PATTERN__HEADER_METHOD,
          oldHeaderMethod, newHeaderMethod);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setHeaderMethod(PatternMethod newHeaderMethod) {
    if (newHeaderMethod != headerMethod) {
      ...
      if (headerMethod != null)
        msgs = ((InternalEObject) headerMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatternPackage.PATTERN__HEADER_METHOD, null,
            msgs);
      if (newHeaderMethod != null)
        msgs = ((InternalEObject) newHeaderMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatternPackage.PATTERN__HEADER_METHOD, null,
            msgs);
  ...
  public NotificationChain basicSetFooterMethod(PatternMethod newFooterMethod, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatternPackage.PATTERN__FOOTER_METHOD,
          oldFooterMethod, newFooterMethod);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setFooterMethod(PatternMethod newFooterMethod) {
    if (newFooterMethod != footerMethod) {
      ...
      if (footerMethod != null)
        msgs = ((InternalEObject) footerMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatternPackage.PATTERN__FOOTER_METHOD, null,
            msgs);
      if (newFooterMethod != null)
        msgs = ((InternalEObject) newFooterMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatternPackage.PATTERN__FOOTER_METHOD, null,
            msgs);
