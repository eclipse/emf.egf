 ...
 * <ul>
 *   <li>{@link org.eclipse.egf.model.pattern.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends ModelElementImpl implements Parameter {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PatternPackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EModelElement newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatternPackage.PARAMETER__TYPE, oldType, type));
	}
