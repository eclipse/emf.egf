...
public class PatternPackageImpl extends EPackageImpl implements PatternPackage {
   ...
   * @generated
   */
  public EReference getBackCall_Called() {
    return (EReference) backCallEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents() {
    ...
    createEReference(backCallEClass, BACK_CALL__CALLED);
  ...
  public void initializePackageContents() {
    ...
    initEReference(getBackCall_Called(), this.getPatternMethod(), null, "called", null, 1, 1, BackCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
