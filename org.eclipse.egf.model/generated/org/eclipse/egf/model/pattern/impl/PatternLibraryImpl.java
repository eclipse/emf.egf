...
public class PatternLibraryImpl extends PatternElementImpl implements PatternLibrary {
  ...
  public EList<PatternElement> getElements() {
    if (elements == null) {
      elements = new EObjectContainmentWithInverseEList<PatternElement>(PatternElement.class, this,
          PatternPackage.PATTERN_LIBRARY__ELEMENTS, PatternPackage.PATTERN_ELEMENT__CONTAINER);
    }
    return elements;
  }
  ...
  public EList<PatternLibrary> getRuntimeOrchestration() {
    if (runtimeOrchestration == null) {
      runtimeOrchestration = new EObjectEList<PatternLibrary>(PatternLibrary.class, this,
          PatternPackage.PATTERN_LIBRARY__RUNTIME_ORCHESTRATION);
    }
