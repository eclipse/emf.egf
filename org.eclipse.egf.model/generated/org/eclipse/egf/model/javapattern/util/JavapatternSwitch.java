...
public class JavapatternSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case JavapatternPackage.JAVA_RUNNER: {
			JavaRunner javaRunner = (JavaRunner) theEObject;
			T result = caseJavaRunner(javaRunner);
			if (result == null)
				result = casePatternRunner(javaRunner);
			if (result == null)
				result = caseModelElement(javaRunner);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Java Runner</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Java Runner</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJavaRunner(JavaRunner object) {
		return null;
	}
