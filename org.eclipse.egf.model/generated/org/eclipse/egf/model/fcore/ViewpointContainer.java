 ...
 * <li>{@link org.eclipse.egf.model.fcore.ViewpointContainer#getViewpoints <em>
 * Viewpoints</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface ViewpointContainer extends ModelElement {
  /**
   * Returns the value of the '<em><b>Factory Component</b></em>' container
   * reference.
   ...
   * @model opposite="viewpointContainer" resolveProxies="false" required="true"
   *        transient="false"
   * @generated
   */
   ...
   * 
   * @param value
   *          the new value of the '<em>Factory Component</em>' container
   *          reference.
  ...
  /**
   * Returns the value of the '<em><b>Viewpoints</b></em>' containment reference
   * list.
