...
public class FactoryComponentFactoryImpl extends EFactoryImpl implements FactoryComponentFactory {
  ...
  public static FactoryComponentFactory init() {
    try {
      FactoryComponentFactory theFactoryComponentFactory = (FactoryComponentFactory) EPackage.Registry.INSTANCE
          .getEFactory("http://www.eclipse.org/egf/1.0.0/factorycomponent"); //$NON-NLS-1$ 
