...
public interface MappingPackage extends EPackage {
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT__ID = FactoryComponentPackage.VIEWPOINT__ID;
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT__NAME = FactoryComponentPackage.VIEWPOINT__NAME;
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT__DESCRIPTION = FactoryComponentPackage.VIEWPOINT__DESCRIPTION;
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT__VIEWERPOINT_CONTAINER = FactoryComponentPackage.VIEWPOINT__VIEWERPOINT_CONTAINER;
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT__MAPPINGS = FactoryComponentPackage.VIEWPOINT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int MAPPING_VIEWPOINT_FEATURE_COUNT = FactoryComponentPackage.VIEWPOINT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int MAPPING__ID = FactoryComponentPackage.MODEL_ELEMENT__ID;
   ...
   * @ordered
   */
  int MAPPING__NAME = FactoryComponentPackage.MODEL_ELEMENT__NAME;
   ...
   * @ordered
   */
  int MAPPING__DESCRIPTION = FactoryComponentPackage.MODEL_ELEMENT__DESCRIPTION;
   ...
   * @ordered
   */
  int MAPPING_FEATURE_COUNT = FactoryComponentPackage.MODEL_ELEMENT_FEATURE_COUNT + 0;
