...
public class SampleExtensionSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SampleExtensionPackage.SAMPLE_ELEMENT: {
				SampleElement sampleElement = (SampleElement)theEObject;
				T result = caseSampleElement(sampleElement);
				if (result == null) result = caseEcoreElement(sampleElement);
				if (result == null) result = caseGenerationElement(sampleElement);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sample Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sample Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSampleElement(SampleElement object) {
		return null;
	}
