 ...
 */
public class RadioGroupFieldEditor2 extends FieldEditor {
     ...
     */
    protected RadioGroupFieldEditor2() {
    }
     ...
     * list of radio button [label, value] entries;
     * the value is returned when the radio button is selected
     * @param parent
     * the parent of the field editor's control
     */
    public RadioGroupFieldEditor2(String name, String labelText, int numColumns, String[][] labelAndValues, Composite parent) {
     ...
     */
    public RadioGroupFieldEditor2(String name, String labelText, int numColumns, String[][] labelAndValues, Composite parent, boolean useGroup) {
        init(name, labelText);
     ...
     */
    @Override
    protected void adjustForNumColumns(int innerNumColumns) {
        Control control = getLabelControl();
        if (control != null) {
            ((GridData) control.getLayoutData()).horizontalSpan = innerNumColumns;
        }
        ((GridData) radioBox.getLayoutData()).horizontalSpan = innerNumColumns;
    }
     ...
     */
    @Override
    protected void doFillIntoGrid(Composite parent, int innerNumColumns) {
        if (useGroup) {
            ...
            gd.horizontalSpan = innerNumColumns;
            control.setLayoutData(gd);
