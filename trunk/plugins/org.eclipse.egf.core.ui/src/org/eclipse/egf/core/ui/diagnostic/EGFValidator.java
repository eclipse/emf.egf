...
public class EGFValidator {
    ...
    public Diagnostic validate() {
        ...
        final Shell shell = EGFCoreUIPlugin.getActiveWorkbenchShell();
    ...
    public static void handleDiagnostic(String title, String message, Diagnostic diagnostic) {
        ...
        // Display Dialog
        int result = 0;
        EGFDiagnosticDialog dialog = new EGFDiagnosticDialog(EGFCoreUIPlugin.getActiveWorkbenchShell(), title, message, diagnostic, Diagnostic.OK | Diagnostic.INFO | Diagnostic.WARNING | Diagnostic.ERROR);
        result = dialog.open();
