//Generated on Wed Jan 11 15:09:46 CET 2012 with EGF 0.6.1.qualifier
...
public class WebXML extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_3 = NL + "<web-app>" + NL + "  <servlet>" + NL + "    <servlet-name>uriServlet</servlet-name>" + NL + "    <servlet-class>org.eclipse.emf.server.ecore.resource.URIServiceImpl</servlet-class>" + NL + "  </servlet>" + NL + "  " + NL + "  <servlet-mapping>" + NL + "    <servlet-name>uriServlet</servlet-name>" + NL + "    <url-pattern>/";
