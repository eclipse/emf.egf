...
public class InterfacebasicSetGenFeatureoverride {
	...
	protected final String TEXT_32 = "_ESETFLAG) != 0;" + NL + "\t\t";
	protected final String TEXT_33 = " |= ";
	protected final String TEXT_34 = "_ESETFLAG;";
	protected final String TEXT_35 = NL + "\t\tboolean old";
	protected final String TEXT_36 = "ESet = ";
	protected final String TEXT_37 = "ESet;" + NL + "\t\t";
	protected final String TEXT_38 = "ESet = true;";
	protected final String TEXT_39 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{";
	protected final String TEXT_40 = NL + "\t\t\t";
	protected final String TEXT_41 = " notification = new ";
	protected final String TEXT_42 = "(this, ";
	protected final String TEXT_43 = ".SET, ";
	protected final String TEXT_44 = ", ";
	protected final String TEXT_45 = "isSetChange ? null : old";
	protected final String TEXT_46 = "old";
	protected final String TEXT_47 = ", new";
	protected final String TEXT_48 = ", ";
	protected final String TEXT_49 = "isSetChange";
	protected final String TEXT_50 = "!old";
	protected final String TEXT_51 = "ESet";
	protected final String TEXT_52 = ");";
	protected final String TEXT_53 = NL + "\t\t\t";
	protected final String TEXT_54 = " notification = new ";
	protected final String TEXT_55 = "(this, ";
	protected final String TEXT_56 = ".SET, ";
	protected final String TEXT_57 = ", ";
	protected final String TEXT_58 = "old";
	protected final String TEXT_59 = " == EVIRTUAL_NO_VALUE ? null : old";
	protected final String TEXT_60 = "old";
	protected final String TEXT_61 = ", new";
	protected final String TEXT_62 = ");";
	protected final String TEXT_63 = NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}";
	protected final String TEXT_64 = NL;
	protected final String TEXT_65 = NL + "\t\treturn msgs;";
	protected final String TEXT_66 = NL + "\t\treturn ((";
	protected final String TEXT_67 = ".Internal)((";
	protected final String TEXT_68 = ".Internal.Wrapper)get";
	protected final String TEXT_69 = "()).featureMap()).basicAdd(";
	protected final String TEXT_70 = ", new";
	protected final String TEXT_71 = ", msgs);";
	protected final String TEXT_72 = NL + "\t\treturn ((";
	protected final String TEXT_73 = ".Internal)get";
	protected final String TEXT_74 = "()).basicAdd(";
	protected final String TEXT_75 = ", new";
	protected final String TEXT_76 = ", msgs);";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (genFeature.isContainer()) {
			...
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#LogicalName=org.eclipse.egf.emf.pattern.model.call.Interface.Interface.basicSetGenFeature.pre.insert" args="genFeature:genFeature,genClass:genClass,genPackage:genPackage,genModel:genModel,isInterface:isInterface,isImplementation:isImplementation,publicStaticFinalFlag:publicStaticFinalFlag,singleWildcard:singleWildcard,negativeOffsetCorrection:negativeOffsetCorrection,positiveOffsetCorrection:positiveOffsetCorrection"%>
			...
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#LogicalName=org.eclipse.egf.emf.pattern.model.call.Interface.Interface.basicSetGenFeature.post.insert" args="genFeature:genFeature,genClass:genClass,genPackage:genPackage,genModel:genModel,isInterface:isInterface,isImplementation:isImplementation,publicStaticFinalFlag:publicStaticFinalFlag,singleWildcard:singleWildcard,negativeOffsetCorrection:negativeOffsetCorrection,positiveOffsetCorrection:positiveOffsetCorrection"%>
