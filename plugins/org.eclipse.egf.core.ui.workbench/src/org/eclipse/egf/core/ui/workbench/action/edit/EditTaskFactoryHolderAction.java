...
/**
 * Open a wizard to edit the {@link TaskFactoryHolder} model element.
 * @author fournier
 */
public class EditTaskFactoryHolderAction extends EditModelElementAction {
   ...
   */
  public EditTaskFactoryHolderAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected Class<?> getModelElementClass() {
    return TaskFactoryHolder.class;
  }
  ...
  protected Wizard getWizardFor(NamedModelElementWithId modelElement_p) {
    return new TaskFactoryHolderWizard(modelElement_p.eContainer(), modelElement_p, isReadOnly());
  }
}
