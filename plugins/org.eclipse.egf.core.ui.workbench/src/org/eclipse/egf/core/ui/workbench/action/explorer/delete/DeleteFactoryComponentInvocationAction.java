 ...
 * @author fournier
 */
public class DeleteFactoryComponentInvocationAction extends DeleteModelElementAction {
  /**
   * Constructor.
   * @param shell_p
   ...
   */
  public DeleteFactoryComponentInvocationAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected String[] getConfirmDeleteMessage() {
    String[] message = { Messages.DeleteFactoryComponentInvocationAction_Message, getModelElement().getName() };
    return message;
  }
