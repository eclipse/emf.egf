...
import org.eclipse.egf.core.ui.wizard.FactoryComponentInvocationWizard;
...
/**
 * Open a wizard to create an {@link FactoryComponentInvocation} model element.
 * @author fournier
 */
public class CreateFactoryComponentInvocationAction extends CreateModelElementAction {
  /**
   * Constructor.
   * @param shell_p
   ...
   */
  public CreateFactoryComponentInvocationAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
    super(shell_p, selectionProvider_p, readOnlyMode_p);
    setText(Messages.CreateFactoryComponentInvocationAction_Title);
    setToolTipText(Messages.CreateFactoryComponentInvocationAction_Tooltip);
    setImageDescriptor(EgfWorkbenchActivator.getDefault().getImageDescriptor(IImageKeys.IMG_NEW_FACTORY_COMPONENT_INVOCATION));
  }
  ...
  protected Wizard getWizardFor(NamedModelElementWithId modelElement_p) {
    return new FactoryComponentInvocationWizard(modelElement_p, null, isReadOnly());
  }
}