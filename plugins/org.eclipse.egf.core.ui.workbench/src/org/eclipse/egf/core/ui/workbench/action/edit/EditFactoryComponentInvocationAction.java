...
/**
 * Open a wizard to edit the {@link FactoryComponentInvocation} model element.
 * @author fournier
 */
public class EditFactoryComponentInvocationAction extends EditModelElementAction {
  /**
   * Constructor.
   * @param shell_p
   ...
   */
  public EditFactoryComponentInvocationAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected Wizard getWizardFor(NamedModelElementWithId modelElement_p) {
    return new FactoryComponentInvocationWizard(modelElement_p.eContainer(), modelElement_p, isReadOnly());
  }
}