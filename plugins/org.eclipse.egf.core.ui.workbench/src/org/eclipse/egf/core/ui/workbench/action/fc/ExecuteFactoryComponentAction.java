 ...
 */
public class ExecuteFactoryComponentAction extends AbstractFactoryExecutionAction {
  /**
   * Constructor.
   * @param shell_p
   ...
   */
  public ExecuteFactoryComponentAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
