 ...
 * @author fournier
 */
public class DeleteContextElementAction extends DeleteModelElementAction {
   ...
   */
  public DeleteContextElementAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected String[] getConfirmDeleteMessage() {
    String[] message = { Messages.DeleteContextElementAction_Message, DataHelper.getLabel((ContextElement) getModelElement()) };
    return message;
  }
