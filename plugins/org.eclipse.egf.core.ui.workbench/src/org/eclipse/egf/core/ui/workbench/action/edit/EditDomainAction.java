...
import org.eclipse.egf.core.ui.wizard.EditDomainWizard;
 ...
 * @author fournier
 */
public class EditDomainAction extends EditModelElementAction {
   ...
   */
  public EditDomainAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected Wizard getWizardFor(NamedModelElementWithId modelElement_p) {
    return new EditDomainWizard(modelElement_p.eContainer(), modelElement_p, isReadOnly());
  }
