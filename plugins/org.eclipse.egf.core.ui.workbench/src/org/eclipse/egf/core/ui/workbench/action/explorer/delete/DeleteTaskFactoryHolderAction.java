 ...
 * @author fournier
 */
public class DeleteTaskFactoryHolderAction extends DeleteModelElementAction {
   ...
   */
  public DeleteTaskFactoryHolderAction(Shell shell_p, ISelectionProvider selectionProvider_p, boolean readOnlyMode_p) {
  ...
  protected String[] getConfirmDeleteMessage() {
    String[] message = { Messages.DeleteTaskFactoryHolderAction_Message, ICommonConstants.EMPTY_STRING };
    return message;
  }
