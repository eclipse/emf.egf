...
/**
 * This wizard allows the end-user to create or edit a pattern library as a child of another one.
 * @author Guillaume Brocard
 */
public class PatternLibraryWizard extends AbstractPatternLibraryWizard {
  /**
   * Constructor.
   * @param parent_p
   ...
   */
  public PatternLibraryWizard(EObject parent_p, NamedModelElementWithId modelElement_p, boolean readOnlyMode_p, boolean creationMode_p) {
  ...
  protected Command getAddCommandForCreatedElement(AdapterFactoryEditingDomain editingDomain_p, EObject parent_p, NamedModelElementWithId createdElement_p) {
    // Add the pattern library to its parent : ie a pattern library.
    return AddCommand.create(editingDomain_p, parent_p, ModelPackage.Literals.PATTERN_LIBRARY__PATTERN_ELEMENTS, createdElement_p);
  }
}