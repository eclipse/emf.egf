...
public interface ICommonConstants {
   ...
   */
  public static final IPath GENERATED_FOLDER_IPATH = new Path("generated"); //$NON-NLS-1$  
   ...
   */
  public static final IPath TEMPLATES_FOLDER_IPATH = new Path("templates"); //$NON-NLS-1$  
