...
import static org.eclipse.egf.common.constant.ICommonConstants.TAB_CHARACTER;
...
public class EmfProjectGenerator {
  ...
  protected boolean validate(GenModel genModel_p) {
    boolean result = true;
    // TODO Stephane: revoir en juillet le post titr� "EcoreImporterWizard can use invalid genModel ?" sur le forum EMF.
