...
public interface IPlatformGenModelConstants {
     ...
     * qualified id.
     */
    public static final String FULLY_QUALIFIED_EXTENSION_POINT_ID = ExtensionPointHelper.getExtensionPointId(EcorePlugin.getPlugin().getBundle().getSymbolicName(), GENERATED_PACKAGE_EXTENSION_POINT_ID);
