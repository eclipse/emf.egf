 ...
 */
public class PatternContextPage extends AbstractPatternPage {
  
  /**
   * Page id.
   */
  protected static final String ID = "egf_pattern_context_page"; //$NON-NLS-1$
   ...
   * @param editor_p
   */
  public PatternContextPage(FormEditor editor_p) {
    super(editor_p, ID, Messages.PatternContextPage_Title);
  }
