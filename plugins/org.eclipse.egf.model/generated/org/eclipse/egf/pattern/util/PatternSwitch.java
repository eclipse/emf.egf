  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case PatternPackage.PATTERN: {
        ...
        if (result == null) result = caseEClass(pattern);
        if (result == null) result = caseGenerator(pattern);
        if (result == null) result = caseEClassifier(pattern);
        if (result == null) result = caseENamedElement(pattern);
