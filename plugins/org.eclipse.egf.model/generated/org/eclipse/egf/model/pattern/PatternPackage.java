...
public interface PatternPackage extends EPackage {
  ...
  /**
   * Returns the meta object for the reference '{@link org.eclipse.egf.model.pattern.Substitution#getOutcoming <em>Outcoming</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Outcoming</em>'.
   * @see org.eclipse.egf.model.pattern.Substitution#getOutcoming()
   * @see #getSubstitution()
   * @generated
   */
  EReference getSubstitution_Outcoming();
  ...
  interface Literals {
     ...
     */
    @SuppressWarnings("hiding")
    EReference SUBSTITUTION__OUTCOMING = eINSTANCE.getSubstitution_Outcoming();
