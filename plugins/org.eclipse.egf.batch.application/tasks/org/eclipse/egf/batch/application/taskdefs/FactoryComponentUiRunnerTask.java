...
import org.eclipse.egf.batch.application.FactoryComponentRunnerApplication;


/**
 * Run a factory component from provided factory component id.<br>
 * It instantiates {@link FactoryComponentRunnerApplication} to run the provided FC in a workbench window.<br>
 * Hence, <b>it must be launched by a non UI Thread Java application</b>.
 * <P>
 ...
 */
public class FactoryComponentUiRunnerTask extends AbstractFactoryComponentRunnerTask {
  /**
   * @see org.eclipse.egf.common.ant.AbstractAntTask#doExecute()
   */
  @Override
  protected void doExecute() throws Exception {
    new FactoryComponentRunnerApplication().run(new String[] { FactoryComponentRunnerApplication.FACTORY_COMPONENT_ID, getFactoryComponentId() });
  }
}
