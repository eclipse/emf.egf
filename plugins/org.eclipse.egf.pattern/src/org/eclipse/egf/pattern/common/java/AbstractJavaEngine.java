...
public abstract class AbstractJavaEngine extends PatternEngine {
    ...
    public boolean checkCondition(PatternContext context, Map<PatternParameter, Object> parameters) throws PatternException {
        Object result = doExecute((InternalPatternContext) context, PatternExtensionFactory.PRECONDITION_METHOD_NAME, parameters);
    ...
    private Object doExecute(InternalPatternContext context, String methodName, Map<PatternParameter, Object> parameters) throws PatternException {
        try {
            ...
            } else if (PatternExtensionFactory.PRECONDITION_METHOD_NAME.equals(methodName)) {
                parameterClasses = new Class<?>[0];
                parameterValues = new Object[0];
            } else
                throw new IllegalStateException();

            if (AssemblyHelper.ORCHESTRATION_METHOD.equals(methodName) || PatternExtensionFactory.PRECONDITION_METHOD_NAME.equals(methodName)) {
            ...
            try {
                ...
                if (PatternExtensionFactory.PRECONDITION_METHOD_NAME.equals(methodName))
                    return Boolean.TRUE;
                throw e;
            }
