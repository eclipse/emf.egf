...
/**
 * Provides an implementation to host the {@link IPatternExecutionReporter} type.
 * @author Guillaume Brocard
 */
public class PatternExecutionReporterTypeHolder extends ClassTypeHolder {
  ...
  public Class<?> getExpectedType() {
    return IPatternExecutionReporter.class;
  }
