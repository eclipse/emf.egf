 ...
 * @author fournier
 */
public class RemoveContextInFcInvocationWrapperCommand extends SetFactoryComponentInvocationWrapperCommand {
  /**
   * Constructor.
   * @param domain_p
   ...
   * @param value_p
   */
  public RemoveContextInFcInvocationWrapperCommand(EditingDomain domain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
  ...
  public List<IPluginChangesCommand> getExecutablePluginChangeCommand() {
    ...
    IContractElementRefExtensionFactory contractElementRefHelper = EgfPdeActivator.getDefault().getContractElementRefExtensionHelper();
  ...
  protected List<IPluginChangesCommand> getUndoablePluginChangeCommand() {
    ...
    AddContextInFcInvocationConfWrapperCommand addCommand = new AddContextInFcInvocationConfWrapperCommand(getDomain(), getModelElement(), getFeature(), value);
