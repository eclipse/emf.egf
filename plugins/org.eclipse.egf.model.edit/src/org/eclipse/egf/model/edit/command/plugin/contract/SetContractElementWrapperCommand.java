 ...
 * @author fournier
 */
public class SetContractElementWrapperCommand extends AbstractContractWrapperCommand {
   ...
   * @param value_p
   */
  public SetContractElementWrapperCommand(EditingDomain domain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
