 ...
 * @author fournier
 */
public class SetContextElementWrapperCommand extends AbstractContextElementWrapperCommand {
  /**
   * Constructor.
   * @param domain_p
   ...
   * @param value_p
   */
  public SetContextElementWrapperCommand(EditingDomain domain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
