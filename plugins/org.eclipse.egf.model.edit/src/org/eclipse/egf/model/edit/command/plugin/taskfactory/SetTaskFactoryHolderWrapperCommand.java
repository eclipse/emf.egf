 ...
 * @author fournier
 */
public class SetTaskFactoryHolderWrapperCommand extends PluginChangeWrapperCommand {
  /**
   * Constructor.
   * @param domain_p
   ...
   * @param value_p
   */
  public SetTaskFactoryHolderWrapperCommand(EditingDomain domain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
  ...
  protected List<IPluginChangesCommand> getExecutablePluginChangeCommand() {
    ...
    // Get the modified task factory holder.
    TaskFactoryHolder taskFactoryHolder = (TaskFactoryHolder) getModelElement();
    ...
    commands.add(taskFactoryHelper.setTaskFactoryExtension(taskFactoryHolder.getId(), taskFactoryHolder.getFactoryClass()));
    return commands;
  }
