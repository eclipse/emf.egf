...
/**
 * Implements a Set command that modifies a {@link NamedModelElementWithId} object with forwarding model element changes to related plug-in file.
 * @author fournier
 */
public class SetModelElementCommand extends AbstractModelElementCommand {
   ...
   * @param value_p
   */
  public SetModelElementCommand(EditingDomain editingDomain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
  ...
  protected Command getCrudCommand(EditingDomain editingDomain_p, EObject modelElement_p, EStructuralFeature feature_p, Object value_p) {
    return new SetCommand(editingDomain_p, modelElement_p, feature_p, value_p);
  }
}
