...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.PatternViewpoint} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class PatternViewpointItemProvider extends AbstractViewpointItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
  /**
   * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated NOT
   */
  public PatternViewpointItemProvider(AdapterFactory adapterFactory_p) {
  ...
  protected Command createAddCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p, int index_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new AddPatternLibraryWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ModelPackage.Literals.PATTERN_VIEWPOINT__LIBRARIES);
    }
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_PatternViewpoint_type") : //$NON-NLS-1$
