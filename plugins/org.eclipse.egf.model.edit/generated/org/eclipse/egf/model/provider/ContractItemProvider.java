...
import org.eclipse.egf.model.edit.command.plugin.contract.AddContractElementWrapperCommand;
import org.eclipse.egf.model.edit.command.plugin.contract.RemoveContractElementWrapperCommand;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.Contract} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ContractItemProvider extends AbstractViewpointItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
  /**
   * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated NOT
   */
  public ContractItemProvider(AdapterFactory adapterFactory_p) {
  ...
  protected Command createAddCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p, int index_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new AddContractElementWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  protected Command createRemoveCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new RemoveContractElementWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ModelPackage.Literals.CONTRACT__CONTRACT_ELEMENTS);
    }
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_Contract_type") : //$NON-NLS-1$
