...
import org.eclipse.egf.model.edit.command.plugin.mapping.AddMappingWrapperCommand;
import org.eclipse.egf.model.edit.command.plugin.mapping.RemoveMappingWrapperCommand;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.MappingViewpoint} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class MappingViewpointItemProvider extends AbstractViewpointItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
  /**
   * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated NOT
   */
  public MappingViewpointItemProvider(AdapterFactory adapterFactory_p) {
  ...
  public boolean hasChildren(Object object_p) {
    // Force returning 'true' to keep the lazy loading mechanism, even if no child will be loaded later...
    return true;
  }
  ...
  protected Command createAddCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p, int index_p) {
    ...
    if (null != value) {
      result = new AddModelElementCommand(domain_p, owner_p, feature_p, value);
      result.setPluginChangeCommand(new AddMappingWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  protected Command createRemoveCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new RemoveMappingWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ModelPackage.Literals.MAPPING_VIEWPOINT__MAPPINGS);
    }
  ...
  public String getText(Object object) {
    String label = ((MappingViewpoint)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_MappingViewpoint_type") : //$NON-NLS-1$
      getString("_UI_MappingViewpoint_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
