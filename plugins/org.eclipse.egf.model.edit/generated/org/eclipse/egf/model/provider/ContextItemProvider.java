...
import org.eclipse.egf.model.edit.command.plugin.context.AddContextElementWrapperCommand;
import org.eclipse.egf.model.edit.command.plugin.context.RemoveContextElementWrapperCommand;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.Context} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider extends NamedModelElementWithIdItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
  /**
   * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated NOT
   */
  public ContextItemProvider(AdapterFactory adapterFactory_p) {
  ...
  protected Command createAddCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p, int index_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new AddContextElementWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  protected Command createRemoveCommand(EditingDomain domain_p, EObject owner_p, EStructuralFeature feature_p, Collection<?> collection_p) {
    ...
    if (null != value) {
      ...
      result.setPluginChangeCommand(new RemoveContextElementWrapperCommand(domain_p, owner_p, feature_p, value));
    }
    return result;
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ModelPackage.Literals.CONTEXT__CONTEXT_ELEMENTS);
    }
