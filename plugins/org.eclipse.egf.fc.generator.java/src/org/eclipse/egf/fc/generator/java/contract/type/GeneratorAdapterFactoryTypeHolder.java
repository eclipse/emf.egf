...
/**
 * Provides an implementation to host the {@link AbstractGenModelGeneratorAdapterFactory} type.
 * @author fournier
 */
public class GeneratorAdapterFactoryTypeHolder extends ClassTypeHolder {
  ...
  public Class<?> getExpectedType() {
    return AbstractGenModelGeneratorAdapterFactory.class;
  }
