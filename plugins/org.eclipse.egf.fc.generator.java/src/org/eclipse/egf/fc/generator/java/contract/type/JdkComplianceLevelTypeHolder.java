...
/**
 * Provides an implementation to host the {@link GenJDKLevel} enumeration.
 * @author Guillaume Brocard
 */
public class JdkComplianceLevelTypeHolder extends PrimitiveTypeHolder {

  /**
   * @see org.eclipse.egf.model.contract.type.ITypeHolder#getValue(java.lang.String)
   */
  public Object getValue(String value_p) {
    return GenJDKLevel.get(value_p);
  }
  ...
  public boolean isValid(String value_p) {
    return GenJDKLevel.get(value_p) != null;
  }
