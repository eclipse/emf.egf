...
/**
 * Provides the task for the factory component GeneratorJavaCode.
 * @author fournier
 */
public class GeneratorJavaTaskFactory implements ITaskFactory {
  
  /**
   * @see org.eclipse.egf.core.task.ITaskFactory#createTask()
   */
  public AbstractTask createTask() {
    return new GeneratorJavaTask();
  }
