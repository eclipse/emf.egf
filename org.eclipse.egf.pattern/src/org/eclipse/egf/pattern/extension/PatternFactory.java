...
public abstract class PatternFactory {
	...
	public Pattern createDebugPattern1()
	{
		Pattern createPattern = createPattern();
		createPattern.setName("MyPattern");
		return createPattern;
	}
	
	// currently broken since there is a problem with SuperMethod
	public List<Pattern> createDebugPattern2()
	{
		List<Pattern> result = new ArrayList<Pattern>();
		Pattern parent = createPattern();
		parent.setName("parent");
		Pattern child = createPattern();
		child.setName("child");
	...
	public List<Pattern> createDebugPattern3(){
		List<Pattern> result = new ArrayList<Pattern>();
		Pattern parent = createPattern();
		parent.setName("parent");
		Pattern child = createPattern();
	...
	public List<Pattern> createDebugPattern4(){
		List<Pattern> result = new ArrayList<Pattern>();
		Pattern parent = createPattern();
