...
public class InterfacegetGenFeaturejavadocoverride {
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "org.eclipse.egf.model.pattern.impl.PatternMethodImpl@12c17ce (description: null) (name: doGenerate) (patternFilePath: platform:/plugin/org.eclipse.egf.emf.pattern/templates/pattern._0vtMUGJ-Ed-FqczH3ESmRw/method._0vtMYmJ-Ed-FqczH3ESmRw.pt)", stringBuffer.toString());
	}
