...
public class ItemProvidernewChildDescriptorsCrossPackageFeatureoverride {
    protected static String nl;

    public static synchronized ItemProvidernewChildDescriptorsCrossPackageFeatureoverride create(String lineSeparator) {
        nl = lineSeparator;
        ItemProvidernewChildDescriptorsCrossPackageFeatureoverride result = new ItemProvidernewChildDescriptorsCrossPackageFeatureoverride();
        nl = null;
        return result;
    }
    ...
    public ItemProvidernewChildDescriptorsCrossPackageFeatureoverride() {
    ...
    protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
        ...
        for (GenClass createClass : genClass.getCrossPackageChildrenClasses(createFeature)) {
            ...
            stringBuffer.append(TEXT_10);
            {
                ...
                CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_9d8ScKVTEd--2dbcyH2cnQ", new ExecutionContext((InternalPatternContext) ctx), callParameters);
            }
