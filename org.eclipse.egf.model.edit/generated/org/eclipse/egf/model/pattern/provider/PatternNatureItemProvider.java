 ...
 * @generated
 */
public class PatternNatureItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PatternNature_type") : //$NON-NLS-1$
				getString("_UI_PatternNature_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
