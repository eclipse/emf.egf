 ...
 * @generated
 */
public class PatternRunnerItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider,
  ...
  protected void addPatternPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
        getResourceLocator(), getString("_UI_PatternRunner_pattern_feature"), //$NON-NLS-1$
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PatternRunner_type") : //$NON-NLS-1$
        getString("_UI_PatternRunner_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
