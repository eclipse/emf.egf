...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.pattern.PatternMethod} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternMethodItemProvider extends PatternUnitItemProvider implements IEditingDomainItemProvider,
  ...
  protected void addPatternFilePathPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
        getResourceLocator(),
        getString("_UI_PatternMethod_patternFilePath_feature"), //$NON-NLS-1$
        ...
        PatternPackage.Literals.PATTERN_METHOD__PATTERN_FILE_PATH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        null));
  }

  /**
   * This returns PatternMethod.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated NOT
   */
  ...
  public Object getImage(Object object) {
    ...
    if (method.eContainer().eGet(PatternPackage.Literals.PATTERN__HEADER_METHOD) == method) {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PatternHeaderMethod")); //$NON-NLS-1$
    } else if (method.eContainer().eGet(PatternPackage.Literals.PATTERN__FOOTER_METHOD) == method) {
  ...
  public String getText(Object object) {
    ...
    String type = getString("_UI_PatternMethod_type");
    if (method.eContainer().eGet(PatternPackage.Literals.PATTERN__HEADER_METHOD) == method) {
      type = getString("_UI_Pattern_headerMethod_feature") + " " + type; //$NON-NLS-1$
    } else if (method.eContainer().eGet(PatternPackage.Literals.PATTERN__FOOTER_METHOD) == method) {
      type = getString("_UI_Pattern_footerMethod_feature") + " " + type; //$NON-NLS-1$
    } else if (method.eContainer().eGet(PatternPackage.Literals.PATTERN__METHODS) != null) {
      @SuppressWarnings("unchecked")
      EList<PatternMethod> list = (EList<PatternMethod>) method.eContainer().eGet(PatternPackage.Literals.PATTERN__METHODS);
      if (list.contains(method)) {
        type = getString("_UI_Pattern_methods_feature") + " " + type; //$NON-NLS-1$
      }
    }
