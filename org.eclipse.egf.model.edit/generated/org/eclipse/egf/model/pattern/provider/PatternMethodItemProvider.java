...
public class PatternMethodItemProvider extends PatternUnitItemProvider implements IEditingDomainItemProvider,
  ...
  public String getText(Object object) {
    String label = ((PatternMethod) object).getName();
    return label == null || label.length() == 0 ? getString("_UI_PatternMethod_type") : //$NON-NLS-1$
        getString("_UI_PatternMethod_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
