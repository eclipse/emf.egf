 ...
 * @generated
 */
public class PatternItemProvider extends PatternElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
  ...
  protected void addSuperPatternPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
        getResourceLocator(), getString("_UI_Pattern_superPattern_feature"), //$NON-NLS-1$
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__HEADER_METHOD, PatternFactory.eINSTANCE
        .createPatternMethod()));
    ...
    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__FOOTER_METHOD, PatternFactory.eINSTANCE
        .createPatternMethod()));
    ...
    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__ORCHESTRATION, PatternFactory.eINSTANCE
        .createPatternMethod()));

    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__ORCHESTRATION, PatternFactory.eINSTANCE
        .createPatternSuperMethod()));

    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__ORCHESTRATION, PatternFactory.eINSTANCE
        .createPatternLibrary()));

    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN__PARAMETERS, PatternFactory.eINSTANCE
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
    ...
    boolean qualify = childFeature == PatternPackage.Literals.PATTERN__HEADER_METHOD
        || childFeature == PatternPackage.Literals.PATTERN__METHODS || childFeature == PatternPackage.Literals.PATTERN__FOOTER_METHOD
        || childFeature == PatternPackage.Literals.PATTERN__ORCHESTRATION;
