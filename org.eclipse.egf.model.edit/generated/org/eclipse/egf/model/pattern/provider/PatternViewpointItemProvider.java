 ...
 * @generated
 */
public class PatternViewpointItemProvider extends ViewpointItemProvider implements IEditingDomainItemProvider,
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PatternViewpoint_type") : //$NON-NLS-1$
        getString("_UI_PatternViewpoint_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(PatternPackage.Literals.PATTERN_VIEWPOINT__LIBRARIES, PatternFactory.eINSTANCE
        .createLibrary()));
  }
