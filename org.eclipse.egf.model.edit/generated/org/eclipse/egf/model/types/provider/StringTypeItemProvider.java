 ...
 * @generated
 */
public class StringTypeItemProvider extends PrimitiveObjectTypeItemProvider implements IEditingDomainItemProvider,
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? "[" + getString("_UI_StringType_type") + "]" : //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        label + " [" + getString("_UI_StringType_type") + "]"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
  }
