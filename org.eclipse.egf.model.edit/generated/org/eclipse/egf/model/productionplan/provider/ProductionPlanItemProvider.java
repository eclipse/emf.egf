...
import org.eclipse.egf.model.factorycomponent.provider.OrchestrationItemProvider;
...
public class ProductionPlanItemProvider extends OrchestrationItemProvider implements IEditingDomainItemProvider,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ProductionplanPackage.Literals.PRODUCTION_PLAN__PRODUCTION_PLAN_INVOCATIONS);
    }
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_ProductionPlan_type") : //$NON-NLS-1$
