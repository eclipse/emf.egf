...
public class FactoryComponentInvocationItemProvider extends ProductionPlanInvocationItemProvider implements IEditingDomainItemProvider,
  ...
  protected void addFactoryComponentPropertyDescriptor(Object object) {
    itemPropertyDescriptors
        .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
            getResourceLocator(),
            getString("_UI_FactoryComponentInvocation_factoryComponent_feature"), //$NON-NLS-1$
            getString(
                "_UI_PropertyDescriptor_description", "_UI_FactoryComponentInvocation_factoryComponent_feature", "_UI_FactoryComponentInvocation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_FactoryComponentInvocation_type") : //$NON-NLS-1$
        getString("_UI_FactoryComponentInvocation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
