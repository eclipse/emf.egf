...
import org.eclipse.egf.model.factorycomponent.provider.InvocationItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.productionplan.ProductionPlanInvocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductionPlanInvocationItemProvider extends InvocationItemProvider implements IEditingDomainItemProvider,
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_ProductionPlanInvocation_type") : //$NON-NLS-1$
        getString("_UI_ProductionPlanInvocation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
