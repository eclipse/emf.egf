...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.factorycomponent.ViewpointContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewpointContainerItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(FactoryComponentPackage.Literals.VIEWPOINT_CONTAINER__VIEWPOINTS);
    }
  ...
  public String getText(Object object) {
    String label = ((ViewpointContainer) object).getName();
    return label == null || label.length() == 0 ? "[" + getString("_UI_ViewpointContainer_type") + "]" : //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        label + " [" + getString("_UI_ViewpointContainer_type") + "]"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
  }
