...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.model.factorycomponent.ContractContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContractContainerItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(FactoryComponentPackage.Literals.CONTRACT_CONTAINER__CONTRACTS);
    }
  ...
  public String getText(Object object) {
    String label = ((ContractContainer) object).getName();
    return label == null || label.length() == 0 ? "[" + getString("_UI_ContractContainer_type") + "]" : //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        label + " [" + getString("_UI_ContractContainer_type") + "]"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
  }
