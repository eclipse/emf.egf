...
public class JetPatternSwitch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    ...
    case JetPatternPackage.JET_ENGINE: {
      JetEngine jetEngine = (JetEngine) theEObject;
      T result = caseJetEngine(jetEngine);
      if (result == null)
        result = casePatternEngine(jetEngine);
      if (result == null)
        result = caseModelElement(jetEngine);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Jet Engine</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Jet Engine</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseJetEngine(JetEngine object) {
    return null;
  }
