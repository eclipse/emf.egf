...
public class JetPatternPackageImpl extends EPackageImpl implements JetPatternPackage {
  ...
  public static JetPatternPackage init() {
    ...
    JetPatternPackageImpl theJetPatternPackage = (JetPatternPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JetPatternPackageImpl ? EPackage.Registry.INSTANCE
        .get(eNS_URI)
        : new JetPatternPackageImpl());
   ...
   * @generated
   */
  public EAttribute getJetNature_CompileTemplate() {
   ...
   * @generated
   */
  public EAttribute getJetNature_TemplateFilePath() {
    return (EAttribute) jetNatureEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents() {
    ...
    createEAttribute(jetNatureEClass, JET_NATURE__COMPILE_TEMPLATE);
    createEAttribute(jetNatureEClass, JET_NATURE__TEMPLATE_FILE_PATH);
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(
        getJetNature_CompileTemplate(),
        theEcorePackage.getEBoolean(),
        "compileTemplate", "false", 1, 1, JetNature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
    initEAttribute(
        getJetNature_TemplateFilePath(),
        theFactoryComponentPackage.getURI(),
        "templateFilePath", null, 0, 1, JetNature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
