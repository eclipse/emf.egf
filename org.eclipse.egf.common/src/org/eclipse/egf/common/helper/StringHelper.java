...
public class StringHelper {
   ...
   * @return Each non-conforming character in given string is replaced by a dot character.
   */
  public static String replaceNonWordCharactersWithDot(String originalString_p) {
    return replaceNonWordCharacters(
      originalString_p, 
      String.valueOf(ICommonConstants.DOT_CHARACTER)
    );
  }
   ...
   * @param originalString_p
   * @return Each non-conforming character in given string is replaced by an underscore character.
   */
  public static String replaceNonWordCharactersWithUnderscore(String originalString_p) {
    return replaceNonWordCharacters(
      originalString_p, 
      String.valueOf(ICommonConstants.UNDERSCORE_CHARACTER)
    );
  }  
   ...
   * @param originalString_p
   * @param replacementString_p each non word character is replaced by given string.
   * @return
   */
  public static String replaceNonWordCharacters(String originalString_p, String replacementString_p) {
    return
      originalString_p.replaceAll(
      REGEXP_NON_WORD_CHARACTERS, 
      replacementString_p != null ? replacementString_p : ICommonConstants.EMPTY_STRING
    );
  }
