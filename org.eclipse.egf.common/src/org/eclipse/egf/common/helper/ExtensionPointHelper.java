...
public class ExtensionPointHelper {
    ...
    /**
     * Define a constant for the attribute named <code>id</code> in
     * ExtensionPoint tab of plug-in xml files.
     */
    ...
    /**
     * Get the configuration elements for a specified plugin id & extension
     * point id.
     * 
     * @param pluginId_p
     ...
     * @return an array of {@link IConfigurationElement} or an empty array if
     *         the extension point does not exist,has no extensions configured,
     ...
     *            The identifier of the plug-in potentially declaring extensions
     ...
     * @param idValue_p
     *            the value of the 'id' attribute declared into the extension
     *            point.
     ...
     *            the simple identifier of the extension point.
     * @param attributeId_p
     *            the identifier of the attribute used into the comparison. If
     *            null, matching is not performed.
     * @param attributeValue_p
     *            the value of the attribute used for comparison matching. If
     *            null, matching is not performed.
     ...
     *            instantiate.
     * @param idValue_p
     *            the extension id value (attribute 'id') that matches the
     *            extension point estensionPointId_p.<br>
     *            If null, comparison is not performed.
     * @return an Object instance if instantiation is successful; null
     *         otherwise.
     */
