...
public class FtaskAdapterFactory extends AdapterFactoryImpl {
  ...
  protected FtaskSwitch<Adapter> modelSwitch = new FtaskSwitch<Adapter>() {
    ...
    @Override
    public Adapter caseTaskJava(TaskJava object) {
      return createTaskJavaAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.egf.model.ftask.TaskJava <em>Task Java</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createTaskJavaAdapter() {
    return null;
  }
