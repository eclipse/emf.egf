...
public class MultiRootTaskCreateAction extends StaticSelectionCommandAction {
     ...
     * createActionCommand(org.eclipse
    ...
    protected Command createActionCommand(EditingDomain inputEditingDomain, Collection<?> collection) {
        if (collection != null && collection.size() == 1) {
            for (Object object : collection) {
                ...
                return new MultiRootAddCommand(inputEditingDomain, (Resource) object, FtaskPackage.Literals.TASK, FtaskFactory.eINSTANCE.createTask());
            }
        }
        return null;
    }
