...
public class FcoreActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
  ...
  /**
   * Fcore Load Resource Action
   * 
   * @generated NOT
   */
  public static class FcoreLoadResourceAction extends LoadResourceAction {
    ...
    public static class ExtendedLoadResourceDialog extends LoadResourceDialog {
      ...
      protected Control createDialogArea(Composite parent) {
        ...
        browseRegisteredFCsButton.setText(EGFModelsEditorPlugin.INSTANCE.getString("_UI_BrowseRegisteredFcores_label")); //$NON-NLS-1$
   ...
   * handling {@link org.eclipse.jface.viewers.SelectionChangedEvent}s by querying for the children
   * and siblings
   ...
   * based on the {@link org.eclipse.jface.action.IAction}s contained in the <code>actions</code>
   * collection,
