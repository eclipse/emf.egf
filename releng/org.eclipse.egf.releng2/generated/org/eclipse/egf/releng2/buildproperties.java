...
public class buildproperties extends org.eclipse.egf.portfolio.eclipse.build.buckminster.call.buildpropertiesadd {
    ...
    protected final String TEXT_1 = "eclipse.staging.area=/shared/download-staging.priv/modeling/egf/" + NL + "eclipse.download.prefix=file:/home/data/httpd/download.eclipse.org" + NL + "#target.os=*" + NL + "#target.ws=*" + NL + "#target.arch=*" + NL + "site.retain.unpacked=true" + NL;
