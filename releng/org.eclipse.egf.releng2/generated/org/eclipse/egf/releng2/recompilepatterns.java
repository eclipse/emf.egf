...
public class recompilepatterns
		extends
	...
	protected final String TEXT_3 = "init,install.buckminster, install.egf\">"
			+ NL;
	protected final String TEXT_4 = "        <echo message=\"Recompile all patterns workspace ${workspace}\" />"
			+ NL
			+ "\t\t<egf>"
			+ NL
			+ "            <globargs>"
	...
	public String generate(Object argument) throws Exception {
		...
		paramDesc = new IQuery.ParameterDescription("buildStep",
				"http://www.eclipse.org/egf/1.0.0/buildstep#//BuildStep");
	...
	protected void method_begin(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {

		stringBuffer.append(TEXT_1);
		stringBuffer.append(stepName);
		stringBuffer.append(TEXT_2);
		stringBuffer.append(new GenerationHelper().getCleanTypeString("", ",",
				buildStep.getCleanBeforeBuild()));
