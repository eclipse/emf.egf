...
public class rmapsvnprovider
		extends
		org.eclipse.egf.portfolio.eclipse.build.buckminster.additions.buildrmapsvn {
	...
	public String generate(Object argument) throws Exception {
		...
		paramDesc = new IQuery.ParameterDescription("scmBuildLocation",
				"http://www.eclipse.org/egf/1.0.0/buildstep#//SCMBuildLocation");
		queryCtx = new HashMap<String, String>();
		List<Object> scmBuildLocationList = QueryHelper.load(ctx,
	...
	protected void method_body(final StringBuffer stringBuffer,
		...
		SVNLocation svnLocation = ((SVNLocation) scmBuildLocation
				.getScmLocation());
		...
		stringBuffer.append(new GenerationHelper()
				.getPatternString(scmBuildLocation));
		...
		stringBuffer.append(new GenerationHelper()
				.getStringIfNotNull(scmBuildLocation.getSuffix()));
