 ...
 * <ul>
 *   <li>{@link org.eclipse.egf.portfolio.eclipse.build.buildcore.impl.StepImpl#getName <em>Name</em>}</li>
...
public abstract class StepImpl extends EObjectImpl implements Step {
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BuildcorePackage.STEP__NAME, oldName, name));
