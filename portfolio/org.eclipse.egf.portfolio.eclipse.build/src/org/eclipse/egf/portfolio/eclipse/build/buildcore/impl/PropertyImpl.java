 ...
 * <ul>
 *   <li>{@link org.eclipse.egf.portfolio.eclipse.build.buildcore.impl.PropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends KeyValueImpl implements Property {
     ...
     * @ordered
     */
    protected static final PropertyType TYPE_EDEFAULT = PropertyType.RUNTIME;
    /**
    ...
    public void setType(PropertyType newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BuildcorePackage.PROPERTY__TYPE, oldType, type));
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case BuildcorePackage.PROPERTY__TYPE:
                return getType();
        }
