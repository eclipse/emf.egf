...
public interface GIT extends SCM {
    ...
    GITLocation getLocations();
				...
				/**
	 * Sets the value of the '{@link org.eclipse.egf.portfolio.eclipse.build.buildscm.GIT#getLocations <em>Locations</em>}' containment reference.
	...
	void setLocations(GITLocation value);
