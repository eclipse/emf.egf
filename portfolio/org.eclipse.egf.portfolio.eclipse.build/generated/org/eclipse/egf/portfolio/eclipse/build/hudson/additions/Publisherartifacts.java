...
public class Publisherartifacts extends org.eclipse.egf.portfolio.eclipse.build.hudson.call.Publisheradd {
	protected static String nl;

	public static synchronized Publisherartifacts create(String lineSeparator) {
		nl = lineSeparator;
		Publisherartifacts result = new Publisherartifacts();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "    <hudson.tasks.ArtifactArchiver>" + NL + "      <artifacts>result/publish/**</artifacts>" + NL + "      <latestOnly>false</latestOnly>"
			+ NL + "    </hudson.tasks.ArtifactArchiver>" + NL;
	protected final String TEXT_2 = NL;
	protected final String TEXT_3 = NL;

	public Publisherartifacts() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return new GenerationHelper().needPublish(job);
	}
}