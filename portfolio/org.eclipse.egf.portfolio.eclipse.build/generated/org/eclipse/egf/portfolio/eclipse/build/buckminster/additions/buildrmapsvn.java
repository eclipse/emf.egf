...
public class buildrmapsvn extends org.eclipse.egf.portfolio.eclipse.build.buckminster.call.buildrmaplocationadd {
	...
	protected final String TEXT_8 = "\">" + NL + "\t\t\t\t<bc:propertyRef key=\"build.root\" />" + NL
			...
			+ "\t\t<provider componentTypes=\"eclipse.feature,osgi.bundle\" readerType=\"svn\" source=\"true\">" + NL
			+ "\t\t\t<uri format=\"";
	protected final String TEXT_9 = ":";
	protected final String TEXT_10 = "@";
	protected final String TEXT_11 = "/{0}";
	protected final String TEXT_12 = "\">" + NL + "\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL
	...
	public String generate(Object argument) throws Exception {
		...
		paramDesc = new IQuery.ParameterDescription("svnBuildLocation",
				"http://www.eclipse.org/egf/1.0.0/buildscm#//SVNBuildLocation");
		queryCtx = new HashMap<String, String>();
		List<Object> svnBuildLocationList = QueryHelper
