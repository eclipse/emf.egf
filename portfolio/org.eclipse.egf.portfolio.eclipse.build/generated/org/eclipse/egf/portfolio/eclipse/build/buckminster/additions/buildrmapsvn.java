...
public class buildrmapsvn extends org.eclipse.egf.portfolio.eclipse.build.buckminster.call.buildrmaplocationadd {
	...
	protected final String TEXT_4 = "\">" + NL + "\t    <!-- provider for windows if checkouted with Hudson -->" + NL
			+ "\t\t<provider componentTypes=\"eclipse.feature,osgi.bundle\" readerType=\"local\" source=\"true\">" + NL + "\t\t\t<uri format=\"file:/{0}/svn/";
	...
	protected final String TEXT_10 = "\">" + NL + "\t\t\t\t<bc:propertyRef key=\"build.root\" />" + NL + "\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL
			...
			+ "\t\t<provider componentTypes=\"eclipse.feature,osgi.bundle\" readerType=\"svn\" source=\"true\">" + NL + "\t\t\t<uri format=\"";
	protected final String TEXT_11 = ":";
	protected final String TEXT_12 = "@";
	protected final String TEXT_13 = "/";
	protected final String TEXT_14 = "/{0}";
	protected final String TEXT_15 = "\">" + NL + "\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL + "\t\t\t</uri>" + NL + "\t\t</provider>" + NL
			+ "\t</searchPath>" + NL + NL;
