...
public class buildxmlunzipStep extends org.eclipse.egf.portfolio.eclipse.build.buckminster.call.buildxmladd {
	...
	public String generate(Object argument) throws Exception {
		...
		paramDesc = new IQuery.ParameterDescription("unzipStep",
				"http://www.eclipse.org/egf/1.0.0/buildfile#//UnzipStep");
		queryCtx = new HashMap<String, String>();
		List<Object> unzipStepList = QueryHelper.load(ctx, "org.eclipse.egf.pattern.query.EObjectInjectedContextQuery")
