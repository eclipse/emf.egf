...
public class buildtarget extends org.eclipse.egf.portfolio.eclipse.build.BuildStepFilePattern {
	...
	protected final String TEXT_1 = "<?pde version=\"3.5\"?>" + NL + "" + NL + "<target name=\"build.target\">" + NL
			+ "\t<locations>" + NL;
	...
	public String orchestration(PatternContext ctx) throws Exception {
		...
		method_begin(new StringBuffer(), ictx);
		{
			...
			CallHelper.executeWithContextInjection(
					"platform:/plugin/org.eclipse.egf.portfolio.eclipse.build/egf/Build.fcore#_geJq4J4XEd-3wvN5SnesGA",
					ctx_local);
		}
