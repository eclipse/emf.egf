//Generated on Wed Jan 04 11:49:33 CET 2012 with EGF 0.6.1.qualifier
...
public class buildxml extends org.eclipse.egf.portfolio.eclipse.build.JobFilePattern {
    ...
    protected final String TEXT_5 = NL + "                    <arg value=\"-data\" />" + NL + "                    <arg value=\"@{workspace}\" />" + NL + "\t                <arg value=\"-DrelengDir=${relengDir}\"/>" + NL + "\t                <arg value=\"-Dbuild.root=${build.root}\"/>" + NL + "\t                <arg value=\"-Dtools=${tools}\"/>" + NL + "\t                <arg value=\"-Dresult=${result}\"/>" + NL + "\t                <arg value=\"-Dpublish=${publish}\"/>" + NL + "\t                <arg value=\"-Dworkspace=${workspace}\"/>" + NL + "\t                <arg value=\"-Dtimestamp=${timestamp}\"/>" + NL + "                <args />" + NL + "            </java>" + NL + "        </sequential>" + NL + "    </macrodef>" + NL;
