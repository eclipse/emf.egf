//Generated on Fri Feb 03 15:22:30 CET 2012 with EGF 0.6.1.qualifier
...
public class buildxml extends org.eclipse.egf.portfolio.eclipse.build.JobFilePattern {
    ...
    protected final String TEXT_5 = NL + "\t                <jvmarg value=\"-DrelengDir=${relengDir}\"/>" + NL + "\t                <jvmarg value=\"-Dbuild.root=${build.root}\"/>" + NL + "\t                <jvmarg value=\"-Dtools=${tools}\"/>" + NL + "\t                <jvmarg value=\"-Dresult=${result}\"/>" + NL + "\t                <jvmarg value=\"-Dpublish=${publish}\"/>" + NL + "\t                <jvmarg value=\"-Dworkspace=${workspace}\"/>" + NL + "\t                <jvmarg value=\"-Dtimestamp=${timestamp}\"/>" + NL + "                    <arg value=\"-data\" />" + NL + "                    <arg value=\"@{workspace}\" />" + NL + "                <args />" + NL + "            </java>" + NL + "        </sequential>" + NL + "    </macrodef>" + NL;
