//Generated on Fri Feb 03 16:46:19 CET 2012 with EGF 0.6.1.qualifier
...
public class buildxml extends org.eclipse.egf.portfolio.eclipse.build.JobFilePattern {
    ...
    protected final String TEXT_17 = "\t<target name=\"init\" depends=\"init.build.properties\" >" + NL + "\t\t<echo message=\"Available variables are : \"/>" + NL + "\t\t<echo message=\"Build Releng directory (relengDir) : ${relengDir}\" />" + NL + "\t\t<echo message=\"Build Root directory (build.root) : ${build.root}\" />" + NL + "\t\t<echo message=\"Build Tools directory (tools) : ${tools}\" />" + NL + "\t\t<echo message=\"Build Results directory (result) : ${result}\" />" + NL + "\t\t<echo message=\"Build Publish directory (publish) : ${publish}\" />" + NL + "\t\t<echo message=\"Build Eclipse workspace directory (workspace) : ${workspace}\" />\t" + NL + "\t\t<echo message=\"Build Timestamp (timestamp) : ${timestamp}\" />\t" + NL + "\t</target>" + NL + "" + NL
