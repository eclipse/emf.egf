//Generated on Wed Feb 01 11:26:55 CET 2012 with EGF 0.6.1.qualifier
...
public class buildxmlcopyStep extends org.eclipse.egf.portfolio.eclipse.build.buckminster.call.buildxmladd {
    ...
    public String generate(Object argument) throws Exception {
        ...
        paramDesc = new IQuery.ParameterDescription("copyStep", "http://www.eclipse.org/egf/1.0.0/buildfile#//CopyStep");
        queryCtx = new HashMap<String, String>();
        List<Object> copyStepList = QueryHelper.load(ctx, "org.eclipse.egf.pattern.query.EObjectInjectedContextQuery").execute(paramDesc, queryCtx, ctx);
    ...
    protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
        ...
        String stepName = new GenerationHelper().getIdOrPositionString(copyStep);
