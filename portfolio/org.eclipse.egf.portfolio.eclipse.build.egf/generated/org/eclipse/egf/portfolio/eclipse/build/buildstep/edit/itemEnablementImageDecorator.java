...
public class itemEnablementImageDecorator
	...
	protected final String TEXT_1 = "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    @Override" + NL
			+ "    protected Object overlayImage(Object object, Object image) {" + NL + "        " + NL
			+ "        if (object instanceof Item && !((Item) object).isEnabled())" + NL + "        {" + NL
			+ "          List<Object> images = new java.util.ArrayList<Object>(2);" + NL
			+ "          images.add(image);" + NL
			...
			+ NL + "          image = new org.eclipse.emf.edit.provider.ComposedImage(images) {" + NL + "" + NL
			+ "                @Override" + NL + "                public List<Point> getDrawPoints(Size size) {" + NL
			+ "                    List<Point> results = new java.util.ArrayList<Point>();" + NL
			+ "                    results.add(new Point());" + NL + "                    Point overlay = new Point();"
			+ NL + "                    overlay.x = 0;" + NL + "                    overlay.y = 9;" + NL
			+ "                    results.add(overlay);" + NL + "                    return results;" + NL
			+ "                }" + NL + "            };" + NL + "        }" + NL + "" + NL
			+ "        return super.overlayImage(object, image);" + NL + "    }";
