//Generated on Wed Jan 04 14:35:45 CET 2012 with EGF 0.6.1.qualifier
...
public class publishStepgetText extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
    ...
    protected final String TEXT_1 = "        PublishStep publishStep = (PublishStep)object;" + NL + "        if (publishStep.getComponent() != null)" + NL + "        \treturn getString(\"_UI_PublishStep_type\") + \" \" + publishStep.getComponent().getName();" + NL + "        return super.getText(object);" + NL;
