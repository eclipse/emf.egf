 ...
 * @generated
 */
public class EcoreToolsExtensionSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public EcoreToolsExtensionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EcoreToolsExtensionPackage.ECORE_TOOLS_GENERATION: {
			EcoreToolsGeneration ecoreToolsGeneration = (EcoreToolsGeneration) theEObject;
			T result = caseEcoreToolsGeneration(ecoreToolsGeneration);
			if (result == null)
				result = caseEcoreElement(ecoreToolsGeneration);
			if (result == null)
				result = caseGenerationElement(ecoreToolsGeneration);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ecore Tools Generation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ecore Tools Generation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEcoreToolsGeneration(EcoreToolsGeneration object) {
		return null;
	}
