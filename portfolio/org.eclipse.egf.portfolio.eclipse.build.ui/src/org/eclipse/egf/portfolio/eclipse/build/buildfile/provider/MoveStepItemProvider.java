...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.portfolio.eclipse.build.buildfile.MoveStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveStepItemProvider
     ...
     * @generated
     */
    public MoveStepItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addDestinationFolderPathPropertyDescriptor(Object object) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MoveStep_destinationFolderPath_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MoveStep_destinationFolderPath_feature", "_UI_MoveStep_type"),
                 BuildfilePackage.Literals.MOVE_STEP__DESTINATION_FOLDER_PATH,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/MoveStep"));
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MoveStep.class)) {
