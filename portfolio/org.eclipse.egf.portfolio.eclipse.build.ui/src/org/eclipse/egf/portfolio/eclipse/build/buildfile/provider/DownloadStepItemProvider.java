...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.portfolio.eclipse.build.buildfile.DownloadStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DownloadStepItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DownloadStep_sourceFilePath_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DownloadStep_sourceFilePath_feature", "_UI_DownloadStep_type"),
                 BuildfilePackage.Literals.DOWNLOAD_STEP__SOURCE_FILE_PATH,
                 true,
                 false,
                 false,
    ...
    protected void addDestinationFilePathPropertyDescriptor(Object object) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DownloadStep_destinationFilePath_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DownloadStep_destinationFilePath_feature", "_UI_DownloadStep_type"),
                 BuildfilePackage.Literals.DOWNLOAD_STEP__DESTINATION_FILE_PATH,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
