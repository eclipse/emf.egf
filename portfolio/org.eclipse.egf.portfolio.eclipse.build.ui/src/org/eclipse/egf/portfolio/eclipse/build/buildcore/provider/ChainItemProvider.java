...
/**
 * This is the item provider adapter for a {@link org.eclipse.egf.portfolio.eclipse.build.buildcore.Chain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChainItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BuildcorePackage.Literals.CHAIN__JOBS);
        }
    ...
    public String getText(Object object) {
        ...
        String label = ((Chain)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_Chain_type") :
            getString("_UI_Chain_type") + " " + label;
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (BuildcorePackage.Literals.CHAIN__JOBS,
                 BuildcoreFactory.eINSTANCE.createJob()));
