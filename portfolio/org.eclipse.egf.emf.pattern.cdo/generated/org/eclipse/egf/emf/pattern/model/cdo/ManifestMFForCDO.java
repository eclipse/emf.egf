...
public class ManifestMFForCDO extends org.eclipse.egf.emf.pattern.model.ManifestMF {
    ...
    protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
        ...
        TreeIterator<GenPackage> genPackagesIterator = new AbstractTreeIterator<GenPackage>(genModel.getGenPackages(), false) {
            protected Iterator<GenPackage> getChildren(Object object) {
                return object instanceof Collection<?> ? ((Collection<GenPackage>) object).iterator() : ((GenPackage) object).getNestedGenPackages().iterator();
            }
        };
        ...
        TreeIterator<GenPackage> genPackagesIterator2 = new AbstractTreeIterator<GenPackage>(genModel.getGenPackages(), false) {
            protected Iterator<GenPackage> getChildren(Object object) {
                return object instanceof Collection<?> ? ((Collection<GenPackage>) object).iterator() : ((GenPackage) object).getNestedGenPackages().iterator();
            }
        };
