...
public class ItemProvideraddPropertyDescriptoroverride {
	...
	public static synchronized ItemProvideraddPropertyDescriptoroverride create(
	...
	protected final String TEXT_1 = NL + "\t\titemPropertyDescriptors.add" + NL
			+ "\t\t\t(createItemPropertyDescriptor" + NL + "\t\t\t\t(((";
	protected final String TEXT_2 = ")adapterFactory).getRootAdapterFactory(),"
			+ NL + "\t\t\t\t getResourceLocator()," + NL
			+ "\t\t\t\t getString(\"_UI_";
	protected final String TEXT_3 = "_";
	protected final String TEXT_4 = "_feature\"),";
	protected final String TEXT_5 = NL
			+ "\t\t\t\t getString(\"_UI_PropertyDescriptor_description\", \"_UI_";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		stringBuffer
				.append(genModel
						.getImportedName("org.eclipse.emf.edit.provider.ComposeableAdapterFactory"));
		...
		if (genFeature.getPropertyDescription() == null
				|| genFeature.getPropertyDescription().length() == 0) {
		...
		stringBuffer
				.append(genFeature.getProperty() == GenPropertyKind.EDITABLE_LITERAL ? "true"
						: "false");
		stringBuffer.append(TEXT_14);
		stringBuffer
				.append(genFeature.isPropertyMultiLine() ? "true" : "false");
		stringBuffer.append(TEXT_15);
		stringBuffer.append(genFeature.isPropertySortChoices() ? "true"
				: "false");
		...
		if (genFeature.isReferenceType()) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.edit.provider.ItemPropertyDescriptor"));
			stringBuffer.append(TEXT_19);
			stringBuffer.append(genFeature.getPropertyImageName());
			stringBuffer.append(TEXT_20);
		}
		if (genFeature.getPropertyCategory() == null
				|| genFeature.getPropertyCategory().length() == 0) {
			stringBuffer.append(TEXT_21);
		} else {
			stringBuffer.append(TEXT_22);
			stringBuffer.append(genModel.getPropertyCategoryKey(genFeature
					.getPropertyCategory()));
		...
		if (genFeature.getPropertyFilterFlags().isEmpty()) {
			...
			for (Iterator<String> j = genFeature.getPropertyFilterFlags()
					.iterator(); j.hasNext();) {
