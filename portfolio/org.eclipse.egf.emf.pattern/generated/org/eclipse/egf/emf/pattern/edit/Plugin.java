...
public class Plugin extends org.eclipse.egf.emf.pattern.base.GenModelJava {
	...
	protected final String TEXT_15 = NL + "\t/**" + NL
			+ "\t * Create the instance." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_16 = "()" + NL + "\t{" + NL + "\t\tsuper" + NL
	...
	protected final String TEXT_31 = ");" + NL + "" + NL
			+ "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL
			+ "\t\t\tplugin = this;" + NL + "\t\t}" + NL + "\t}" + NL;
	...
	protected final String TEXT_35 = ".class);" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Override" + NL
	...
	protected final String TEXT_43 = " if (\"_UI_Unknown_type\".equals(key)) return PROPERTIES.unknownType();"
			+ NL
	...
	protected final String TEXT_72 = ".class);" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Override" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genModel.getRuntimePlatform() != GenRuntimePlatform.GWT) {
			...
			stringBuffer.append(genModel.getImportedName(genModel
					.getQualifiedEditPluginClassName() + "Properties"));
			stringBuffer.append(TEXT_33);
			stringBuffer.append(genModel
					.getImportedName("com.google.gwt.core.client.GWT"));
			...
			for (GenPackage genPackage : genModel
				...
				if (genPackage.getGenModel() == genModel
						|| !genPackage.getGenModel().hasEditSupport()) {
			...
			for (GenFeature genFeature : genModel.getFilteredAllGenFeatures()) {
				...
				if (description != null && description.length() > 0) {
					...
					stringBuffer
							.append(genFeature.getGenClass().getUncapName());
			...
			stringBuffer.append(genModel.getImportedName(genModel
					.getQualifiedEditPluginClassName() + "Images"));
