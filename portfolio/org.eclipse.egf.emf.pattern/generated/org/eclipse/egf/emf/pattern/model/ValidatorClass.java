...
public class ValidatorClass extends
	...
	protected final String TEXT_4 = NL + NL + "/**" + NL
			+ " * <!-- begin-user-doc -->" + NL
			+ " * The <b>Validator</b> for the model." + NL
			+ " * <!-- end-user-doc -->" + NL + " * @see ";
	protected final String TEXT_5 = NL + " * @generated" + NL + " */" + NL
			+ "public class ";
	...
	protected final String TEXT_14 = "();"
			...
			+ NL + "\t * @see org.eclipse.emf.common.util.Diagnostic#getCode()"
			+ NL + "\t * @generated" + NL + "\t */" + NL
	...
	protected final String TEXT_19 = "'." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic static final int ";
	...
	protected final String TEXT_24 = NL + "\t/**" + NL
			+ "\t * The cached base package validator." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	...
	protected final String TEXT_34 = " source, int code)" + NL + "\t{" + NL
			+ "\t\treturn ";
	...
	protected final String TEXT_36 = NL + "\t/**" + NL
			+ "\t * Creates an instance of the switch." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	...
	protected final String TEXT_41 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * Returns the package of this validator switch." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_42 = NL + "\t@Override";
	protected final String TEXT_43 = NL + "\tprotected EPackage getEPackage()"
			+ NL + "\t{" + NL + "\t  return ";
	...
	protected final String TEXT_48 = " context)" + NL + "\t{" + NL
	...
	protected final String TEXT_67 = NL + "\t\t\tdefault:" + NL
			+ "\t\t\t\treturn true;" + NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_68 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic boolean validate";
	...
	protected final String TEXT_133 = NL + "\t */" + NL
			+ "\tpublic static final  PatternMatcher [][] ";
	protected final String TEXT_134 = "__VALUES =" + NL
			+ "\t\tnew PatternMatcher [][]" + NL + "\t\t{";
	...
	protected final String TEXT_147 = "__VALUES =" + NL
			+ "\t\twrapEnumerationValues" + NL + "\t\t\t(new Object[]" + NL
			+ "\t\t\t {";
	...
	protected final String TEXT_155 = "</em>'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected static final ";
	...
	protected final String TEXT_163 = "</em>'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic boolean validate";
	...
	protected final String TEXT_174 = ".iterator(); i.hasNext() && (result || diagnostics != null); )"
			+ NL + "\t\t{" + NL + "\t\t\tObject item = i.next();";
	protected final String TEXT_175 = NL + "\t\t\tif (";
	protected final String TEXT_176 = ".isInstance(item))" + NL + "\t\t\t{"
			+ NL + "\t\t\t\tresult &= ";
	...
	protected final String TEXT_192 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL
			+ "\t\treturn result;";
	protected final String TEXT_193 = NL + "\t\tif (diagnostics != null)" + NL
			+ "\t\t{" + NL + "\t\t\t";
	...
	protected final String TEXT_215 = " diagnostic : tempDiagnostics.getChildren())"
			+ NL
			+ "\t\t\t{"
			+ NL
	...
	protected final String TEXT_217 = " children = tempDiagnostics.getChildren();"
			+ NL
	...
	protected final String TEXT_492 = NL + "\t\treturn" + NL + "\t\t\tvalidate"
			+ NL + "\t\t\t\t(";
	...
	protected final String TEXT_507 = NL + "\t\t\t\t\t(createDiagnostic" + NL
			+ "\t\t\t\t\t\t(";
	protected final String TEXT_508 = ".ERROR," + NL
			+ "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
	...
	protected final String TEXT_518 = ".ERROR," + NL
			+ "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t\t ";
	...
	protected final String TEXT_530 = NL + "\t\t\t\t\t(createDiagnostic" + NL
			+ "\t\t\t\t\t\t(";
	protected final String TEXT_531 = ".ERROR," + NL
			+ "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
	...
	protected final String TEXT_540 = ".ERROR," + NL
			+ "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t\t ";
	...
	protected final String TEXT_559 = NL + "\t\treturn" + NL + "\t\t\tvalidate"
			+ NL + "\t\t\t\t(";
	...
	protected final String TEXT_584 = ".ERROR," + NL
			+ "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t\t ";
	...
	protected final String TEXT_599 = NL
			...
			+ NL
			+ "\t\t// Ensure that you remove @generated or mark it @generated NOT"
			+ NL + "\t\treturn super.getResourceLocator();";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		final String _Map = genModel.useGenerics() ? "Map<"
				+ genModel.getImportedName("java.lang.Object") + ", "
				+ genModel.getImportedName("java.lang.Object") + ">" : "Map";
		final String objectArgument = genModel.useGenerics() ? "<"
				+ genModel.getImportedName("java.lang.Object") + ">" : "";
		...
		stringBuffer
				.append(genModel
						.getImportedName("org.eclipse.emf.ecore.util.EObjectValidator"));
		...
		for (GenPackage baseGenPackage : genPackage
			...
			stringBuffer.append(genPackage
					.getValidatorPackageUniqueSafeName(baseGenPackage));
		...
		for (GenClassifier genClassifier : genPackage.getGenClassifiers()) {
			...
			if (genClassifier instanceof GenDataType) {
				...
				if (genDataType.isPrimitiveType()) {
					...
					stringBuffer.append(genDataType.getObjectType()
		...
		for (GenClassifier genClassifier : genPackage.getGenClassifiers()) {
			String result = "result".equals(genClassifier.getSafeUncapName()) ? "theResult"
					: "result";
			String diagnostics = "diagnostics".equals(genClassifier
					.getSafeUncapName()) ? "theDiagnostics" : "diagnostics";
			String item = "item".equals(genClassifier.getSafeUncapName()) ? "theItem"
					: "item";
			String context = "context".equals(genClassifier.getSafeUncapName()) ? "theContext"
					: "context";
			...
			if (genClassifier.getAllGenConstraints().isEmpty()) {
				...
				for (String constraint : genClassifier.getAllGenConstraints()) {
					GenClassifier constraintImplementor = genClassifier
							.getConstraintImplementor(constraint);
					String delegate = constraintImplementor == null
							|| constraintImplementor.getGenPackage() == genPackage ? ""
							: genPackage
									.getValidatorPackageUniqueSafeName(constraintImplementor
											.getGenPackage())
									+ "Validator.";
					String cast = constraintImplementor == null
							&& genClassifier instanceof GenClass
							&& !((GenClass) genClassifier).isEObjectExtension() ? "("
							+ genModel
									.getImportedName("org.eclipse.emf.ecore.EObject")
							+ ")"
							: "";
					String accessor = constraintImplementor != null
							&& genClassifier instanceof GenDataType
							&& !((GenDataType) genClassifier).isPrimitiveType()
							&& ((GenDataType) constraintImplementor)
									.isPrimitiveType()
					...
					if ("NoCircularContainment".equals(constraint)) {
						...
						stringBuffer.append(constraintImplementor == null ? ""
								: constraintImplementor.getName());
			...
			for (String constraint : genClassifier.getGenConstraints()) {
				GenClassifier constraintDelegate = genClassifier
						.getConstraintDelegate(constraint);
				String constant = genClassifier.getClassifierID()
						+ "__"
						+ CodeGenUtil.format(constraint, '_', null, false,
								false).toUpperCase(
								genClassifier.getGenModel().getLocale());
				String delegate = constraintDelegate == null
						|| constraintDelegate.getGenPackage() == genPackage ? ""
						: genPackage
								.getValidatorPackageUniqueSafeName(constraintDelegate
										.getGenPackage())
								+ "Validator.";
				String cast = constraintDelegate == null
						&& genClassifier instanceof GenClass
						&& !((GenClass) genClassifier).isEObjectExtension() ? "("
						+ genModel
								.getImportedName("org.eclipse.emf.ecore.EObject")
						+ ")"
						: "";
				String accessor = constraintDelegate != null
						&& genClassifier instanceof GenDataType
						&& !((GenDataType) genClassifier).isPrimitiveType()
						&& ((GenDataType) constraintDelegate).isPrimitiveType()
						&& genModel.getComplianceLevel().getValue() < GenJDKLevel.JDK50 ? "."
						+ ((GenDataType) constraintDelegate)
								.getPrimitiveValueFunction() + "()"
						: "";
				if (genClassifier instanceof GenDataType) {
					GenDataType genDataType = (GenDataType) genClassifier;
					if (constraint.equals("Min")
							&& genDataType.getMinLiteral() != null) {
						...
						stringBuffer.append(genDataType
								.getStaticValue(genDataType.getMinLiteral()));
						stringBuffer.append(TEXT_113);
					} else if (constraint.equals("Max")
							&& genDataType.getMaxLiteral() != null) {
						...
						stringBuffer.append(genDataType
								.getStaticValue(genDataType.getMaxLiteral()));
						stringBuffer.append(TEXT_119);
					} else if (constraint.equals("TotalDigits")
							&& genDataType.getTotalDigits() != -1
							&& !"java.math.BigDecimal".equals(genDataType
						...
						stringBuffer.append(genDataType.getStaticValue("-"
								+ value));
						stringBuffer.append(TEXT_130);
					} else if (constraint.equals("Pattern")
							&& !genDataType.getPatterns().isEmpty()) {
						...
						for (Iterator<List<String>> k = genDataType
								.getPatterns().iterator(); k.hasNext();) {
							List<String> patternList = k.next();
							stringBuffer.append(TEXT_135);
							for (Iterator<String> p = patternList.iterator(); p
									.hasNext();) {
						...
						stringBuffer.append(TEXT_140);
							...
							&& !genDataType.getEnumerationLiterals().isEmpty()) {
						...
						for (Iterator<String> k = genDataType
								.getEnumerationLiterals().iterator(); k
								.hasNext();) {
				...
				if (genClassifier.hasConstraintExpression(constraint)) {
					...
					stringBuffer.append(genClassifier.getConstraintExpression(
							constraint, "\t\t"));
				...
				if (genClassifier instanceof GenDataType) {
					...
					if (constraint.equals("ItemType")
						...
						String itemDelegate = itemType.getGenPackage() == genPackage ? ""
								: genPackage
										.getValidatorPackageUniqueSafeName(itemType
												.getGenPackage())
										+ "Validator.";
					...
					} else if (constraint.equals("MemberTypes")
							&& !genDataType.getMemberTypes().isEmpty()) {
						stringBuffer.append(TEXT_193);
						stringBuffer
								.append(genModel
										.getImportedName("org.eclipse.emf.common.util.BasicDiagnostic"));
						stringBuffer.append(TEXT_194);
						for (ListIterator<GenDataType> k = genDataType
								.getMemberTypes().listIterator(); k.hasNext();) {
							GenDataType memberType = k.next();
							String memberDelegate = memberType.getGenPackage() == genPackage ? ""
									: genPackage
											.getValidatorPackageUniqueSafeName(memberType
													.getGenPackage())
											+ "Validator.";
							if (genDataType.isPrimitiveType()) {
						...
						if (genModel.useGenerics()) {
							...
							stringBuffer
									.append(genModel
											.getImportedName("org.eclipse.emf.common.util.Diagnostic"));
						...
						if (genDataType.isPrimitiveType()) {
							...
							stringBuffer
									.append(genDataType.isMinInclusive() ? ">="
											: ">");
							...
							String comparison = "comparison"
									.equals(genClassifier.getSafeUncapName()) ? "theComparison"
									: "comparison";
							...
							stringBuffer
									.append(genDataType.isMinInclusive() ? "true"
											: "false");
						...
						if (genDataType.isPrimitiveType()) {
							...
							stringBuffer
									.append(genDataType.isMaxInclusive() ? "<="
											: "<");
							...
							stringBuffer
									.append(genDataType.isMaxInclusive() ? "true"
											: "false");
					...
					} else if (constraint.equals("MinLength")
							&& genDataType.getMinLength() != -1) {
					...
					} else if (constraint.equals("MaxLength")
							&& genDataType.getMaxLength() != -1) {
						...
						} else if ("java.math.BigDecimal".equals(genDataType
								.getQualifiedInstanceClassName())) {
						...
						stringBuffer.append(TEXT_450);
							...
							&& genDataType.getFractionDigits() != -1
							&& "java.math.BigDecimal".equals(genDataType
									.getQualifiedInstanceClassName())) {
						...
						if (genClassifier.hasConstraintExpression(constraint)) {
							...
							stringBuffer.append(genClassifier
									.getValidationDelegate(constraint));
							...
							stringBuffer
									.append(genClassifier.getClassifierID());
							stringBuffer.append(TEXT_501);
							stringBuffer.append(CodeGenUtil
									.upperName(constraint));
					...
					GenOperation genOperation = ((GenClass) genClassifier)
							.getInvariantOperation(constraint);
