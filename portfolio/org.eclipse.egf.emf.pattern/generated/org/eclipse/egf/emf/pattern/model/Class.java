//Generated on Wed Jan 11 17:47:59 CET 2012 with EGF 0.6.1.qualifier
...
public class Class extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_333 = NL + "\tpublic Object eInvoke(int operationID, ";
	protected final String TEXT_334 = " arguments) throws ";
	protected final String TEXT_335 = NL + "\t{" + NL + "\t\tswitch (operationID";
	...
	protected final String TEXT_344 = "arguments.get(";
	protected final String TEXT_345 = ")";
	protected final String TEXT_346 = ").";
	protected final String TEXT_347 = "()";
	protected final String TEXT_348 = ", ";
	protected final String TEXT_349 = ");" + NL + "\t\t\t\treturn null;";
	...
	protected final String TEXT_357 = "arguments.get(";
	...
	protected final String TEXT_366 = NL + "\t\treturn super.eInvoke(operationID, arguments);";
	protected final String TEXT_367 = NL + "\t\treturn eDynamicInvoke(operationID, arguments);";
	...
	protected final String TEXT_371 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\tStringBuffer result = new StringBuffer(super.toString());";
	protected final String TEXT_372 = NL + "\t\tresult.append(\" (";
	protected final String TEXT_373 = ": \");";
	protected final String TEXT_374 = NL + "\t\tresult.append(\", ";
	protected final String TEXT_375 = ": \");";
	protected final String TEXT_376 = NL + "\t\tif (eVirtualIsSet(";
	protected final String TEXT_377 = ")) result.append(eVirtualGet(";
	protected final String TEXT_378 = ")); else result.append(\"<unset>\");";
	protected final String TEXT_379 = NL + "\t\tif (";
	protected final String TEXT_380 = "(";
	protected final String TEXT_381 = " & ";
	protected final String TEXT_382 = "_ESETFLAG) != 0";
	protected final String TEXT_383 = "ESet";
	protected final String TEXT_384 = ") result.append((";
	protected final String TEXT_385 = " & ";
	protected final String TEXT_386 = "_EFLAG) != 0); else result.append(\"<unset>\");";
	protected final String TEXT_387 = NL + "\t\tif (";
	protected final String TEXT_388 = "(";
	protected final String TEXT_389 = " & ";
	protected final String TEXT_390 = "_ESETFLAG) != 0";
	protected final String TEXT_391 = "ESet";
	protected final String TEXT_392 = ") result.append(";
	protected final String TEXT_393 = "_EFLAG_VALUES[(";
	protected final String TEXT_394 = " & ";
	protected final String TEXT_395 = "_EFLAG) >>> ";
	protected final String TEXT_396 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
	...
	protected final String TEXT_403 = "); else result.append(\"<unset>\");";
	protected final String TEXT_404 = NL + "\t\tresult.append(eVirtualGet(";
	protected final String TEXT_405 = ", ";
	protected final String TEXT_406 = "));";
	protected final String TEXT_407 = NL + "\t\tresult.append((";
	protected final String TEXT_408 = " & ";
	protected final String TEXT_409 = "_EFLAG) != 0);";
	...
	protected final String TEXT_414 = "_EFLAG_OFFSET]);";
	protected final String TEXT_415 = NL + "\t\tresult.append(";
	protected final String TEXT_416 = ");";
	protected final String TEXT_417 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
	protected final String TEXT_418 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_419 = NL + "\t@";
	protected final String TEXT_420 = NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_421 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	protected final String TEXT_422 = " getKey()" + NL + "\t{";
	protected final String TEXT_423 = NL + "\t\treturn new ";
	protected final String TEXT_424 = "(getTypedKey());";
	protected final String TEXT_425 = NL + "\t\treturn getTypedKey();";
	protected final String TEXT_426 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(";
	protected final String TEXT_427 = " key)" + NL + "\t{";
	protected final String TEXT_428 = NL + "\t\tgetTypedKey().addAll(";
	protected final String TEXT_429 = "(";
	protected final String TEXT_430 = ")";
	protected final String TEXT_431 = "key);";
	protected final String TEXT_432 = NL + "\t\tsetTypedKey(key);";
	protected final String TEXT_433 = NL + "\t\tsetTypedKey(((";
	...
	protected final String TEXT_438 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	protected final String TEXT_439 = " getValue()" + NL + "\t{";
	protected final String TEXT_440 = NL + "\t\treturn new ";
	protected final String TEXT_441 = "(getTypedValue());";
	protected final String TEXT_442 = NL + "\t\treturn getTypedValue();";
	protected final String TEXT_443 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	protected final String TEXT_444 = " setValue(";
	protected final String TEXT_445 = " value)" + NL + "\t{" + NL + "\t\t";
	protected final String TEXT_446 = " oldValue = getValue();";
	protected final String TEXT_447 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
	protected final String TEXT_448 = "(";
	protected final String TEXT_449 = ")";
	protected final String TEXT_450 = "value);";
	protected final String TEXT_451 = NL + "\t\tsetTypedValue(value);";
	protected final String TEXT_452 = NL + "\t\tsetTypedValue(((";
	...
	protected final String TEXT_457 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_458 = NL + "\t@SuppressWarnings(\"unchecked\")";
	protected final String TEXT_459 = NL + "\tpublic ";
	protected final String TEXT_460 = " getEMap()" + NL + "\t{" + NL + "\t\t";
	protected final String TEXT_461 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
	protected final String TEXT_462 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
