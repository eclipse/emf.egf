...
public class EditoraddItemProviderFactoriesoverride {
	...
	public static synchronized EditoraddItemProviderFactoriesoverride create(
	...
	public void set__CollectionOfSelectionChangedListener(
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		for (GenPackage aGenPackage : genModel
				.getAllGenPackagesWithClassifiers()) {
			if (!aGenPackage.getGenClasses().isEmpty()
					&& aGenPackage.getGenModel().hasEditSupport()) {
				stringBuffer.append(TEXT_2);
				stringBuffer.append(aGenPackage
