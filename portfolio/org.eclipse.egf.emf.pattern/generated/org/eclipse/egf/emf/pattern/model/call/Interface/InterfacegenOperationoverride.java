...
public class InterfacegenOperationoverride {
	...
	public static synchronized InterfacegenOperationoverride create(
	...
	protected final String TEXT_2 = NL + "\t/**" + NL
			+ "\t * The cached validation expression for the '{@link #";
	protected final String TEXT_3 = "(";
	protected final String TEXT_4 = ") <em>";
	protected final String TEXT_5 = "</em>}' invariant operation." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	protected final String TEXT_6 = "(";
	protected final String TEXT_7 = ")" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\tprotected static final ";
	protected final String TEXT_8 = " ";
	protected final String TEXT_9 = "__EEXPRESSION = \"";
	protected final String TEXT_10 = "\";";
	protected final String TEXT_11 = NL;
	protected final String TEXT_12 = NL + "\t/**" + NL
			+ "\t * The cached invocation delegate for the '{@link #";
	protected final String TEXT_13 = "(";
	protected final String TEXT_14 = ") <em>";
	protected final String TEXT_15 = "</em>}' operation." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_86 = " ite)" + NL + "\t\t{" + NL
			+ "\t\t\tthrow new ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (isImplementation) {
			if (genOperation.isInvariant()
				...
				stringBuffer.append(CodeGenUtil.upperName(
						genClass.getUniqueName(genOperation),
						genModel.getLocale()));
				stringBuffer.append(TEXT_9);
				stringBuffer
						.append(genOperation.getInvariantExpression("\t\t"));
		...
		if (!isImplementation) {
			...
			if (genOperation.hasBody()) {
				...
				stringBuffer.append(genOperation.getBody(genModel
						.getIndentation(stringBuffer)));
			} else if (genOperation.isInvariant()) {
				GenClass opClass = genOperation.getGenClass();
				String diagnostics = genOperation.getGenParameters().get(0)
						.getName();
				String context = genOperation.getGenParameters().get(1)
						.getName();
				if (genOperation.hasInvariantExpression()) {
					stringBuffer.append(TEXT_36);
					stringBuffer.append(opClass.getGenPackage()
				...
				if (genOperation.isVoid()) {
					...
					if (size > 0) {
						...
						stringBuffer
								.append(genModel
										.getImportedName("org.eclipse.emf.common.util.BasicEList"));
						stringBuffer.append(TEXT_66);
						stringBuffer.append(size);
						stringBuffer.append(TEXT_67);
						stringBuffer.append(genOperation
								.getParametersArray(genClass));
