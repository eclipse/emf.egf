...
public class SwitchClass extends
	...
	protected final String TEXT_4 = NL
			...
			+ NL + " * starting with the actual class of the object" + NL
			+ " * and proceeding up the inheritance hierarchy" + NL
			+ " * until a non-null result is returned," + NL
			+ " * which is the result of the switch." + NL
			+ " * <!-- end-user-doc -->" + NL + " * @see ";
	...
	protected final String TEXT_11 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected static ";
	protected final String TEXT_12 = " modelPackage;" + NL + "" + NL + "\t/**"
			+ NL + "\t * Creates an instance of the switch." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_13 = "()" + NL + "\t{" + NL
			+ "\t\tif (modelPackage == null)" + NL + "\t\t{" + NL
			+ "\t\t\tmodelPackage = ";
	...
	protected final String TEXT_15 = " doSwitch(EObject theEObject)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_16 = " doSwitch(EClass theEClass, EObject theEObject)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_19 = " eSuperTypes = theEClass.getESuperTypes();"
			+ NL
			+ "\t\t\treturn"
			+ NL
			+ "\t\t\t\teSuperTypes.isEmpty() ?"
	...
	protected final String TEXT_21 = "eSuperTypes.get(0), theEObject);"
			+ NL
			+ "\t\t}"
			+ NL
			+ "\t}"
			...
			+ "\t * @return the first non-null result returned by a <code>caseXXX</code> call."
			+ NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_22 = " doSwitch(int classifierID, EObject theEObject)"
			+ NL + "\t{" + NL + "\t\tswitch (classifierID)" + NL + "\t\t{";
	...
	protected final String TEXT_43 = " = defaultCase(theEObject);" + NL
			+ "\t\t\t\treturn ";
	protected final String TEXT_44 = ";" + NL + "\t\t\t}";
	protected final String TEXT_45 = NL
			+ "\t\t\tdefault: return defaultCase(theEObject);" + NL + "\t\t}"
			+ NL + "\t}";
	...
	protected final String TEXT_51 = " object)" + NL + "\t{" + NL
			+ "\t\treturn null;" + NL + "\t}";
	protected final String TEXT_52 = NL
			...
			+ NL + "\t * @see #doSwitch(org.eclipse.emf.ecore.EObject)" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	protected final String TEXT_53 = " defaultCase(EObject object)" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genModel.useGenerics()) {
			...
			for (GenClass genClass : genPackage.getAllSwitchGenClasses()) {
				...
				for (GenTypeParameter genTypeParameter : genClass
		...
		String templateParameters = genModel.useGenerics() ? "<"
		...
		for (GenClass genClass : genPackage.getGenClasses()) {
			if (!genClass.isExternalInterface() && !genClass.isEObject()
					|| genClass.isMapEntry()) {
				String result = "result".equals(genClass.getSafeUncapName()) ? "theResult"
						: "result";
				...
				for (GenClass baseGenClass : genClass.getSwitchGenClasses()) {
					...
					stringBuffer.append(genPackage
							.getClassUniqueName(baseGenClass));
	...
	public boolean preCondition() throws Exception {
		...
		canGenerate = canGenerate
				&& (genPackage.hasClassifiers()
						&& genPackage.isAdapterFactory() && !genPackage
						.getGenClasses().isEmpty());
		return canGenerate;
	}
}