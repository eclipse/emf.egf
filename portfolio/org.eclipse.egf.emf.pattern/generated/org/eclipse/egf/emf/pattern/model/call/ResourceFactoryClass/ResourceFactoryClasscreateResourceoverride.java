...
public class ResourceFactoryClasscreateResourceoverride {
	...
	public static synchronized ResourceFactoryClasscreateResourceoverride create(
	...
	protected final String TEXT_4 = "(uri);" + NL
	...
	protected final String TEXT_12 = ");" + NL + "" + NL
			+ "\t\tresult.getDefaultSaveOptions().put(";
	protected final String TEXT_13 = ".OPTION_SCHEMA_LOCATION, Boolean.TRUE);"
			+ NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
	protected final String TEXT_14 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);"
			+ NL + "\t\tresult.getDefaultSaveOptions().put(";
	protected final String TEXT_15 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);"
			+ NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
	...
	protected final String TEXT_21 = "(uri);" + NL
			+ "\t\tresult.getDefaultSaveOptions().put(";
	protected final String TEXT_22 = ".OPTION_XML_MAP, xmlMap);" + NL
			+ "\t\tresult.getDefaultLoadOptions().put(";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genPackage.hasExtendedMetaData()) {
			...
			stringBuffer.append(genModel
					.getImportedName("org.eclipse.emf.ecore.xmi.XMLResource"));
