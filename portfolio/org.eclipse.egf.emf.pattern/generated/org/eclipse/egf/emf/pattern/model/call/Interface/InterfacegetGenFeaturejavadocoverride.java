...
public class InterfacegetGenFeaturejavadocoverride {
	...
	public static synchronized InterfacegetGenFeaturejavadocoverride create(
	...
	protected final String TEXT_28 = NL + "\t * <p>" + NL
			+ "\t * If the meaning of the '<em>";
	protected final String TEXT_29 = "</em>' ";
	protected final String TEXT_30 = " isn't clear," + NL
			+ "\t * there really should be more of a description here..." + NL
			+ "\t * </p>";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genFeature.isListType()) {
			if (genFeature.isMapType()) {
				...
				if (valueFeature.isListType()) {
					...
					stringBuffer.append(valueFeature
							.getQualifiedListItemType(genClass));
		...
		if (genFeature.isBidirectional()
				&& !genFeature.getReverse().getGenClass().isMapEntry()) {
			GenFeature reverseGenFeature = genFeature.getReverse();
			if (!reverseGenFeature.isSuppressedGetVisibility()) {
				stringBuffer.append(TEXT_22);
				stringBuffer.append(reverseGenFeature.getGenClass()
		...
		if (genFeature.hasDocumentation()) {
			...
			stringBuffer.append(genFeature.getDocumentation(genModel
