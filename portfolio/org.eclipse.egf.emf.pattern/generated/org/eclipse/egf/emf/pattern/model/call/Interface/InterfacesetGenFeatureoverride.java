...
public class InterfacesetGenFeatureoverride {
	...
	protected final String TEXT_37 = " msgs = null;" + NL + "\t\t\tif (eInternalContainer() != null)" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (isInterface) {
			stringBuffer.append(TEXT_1);
			{
				...
				CallHelper.executeWithParameterInjection(
						"platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0yZT8GJ-Ed-FqczH3ESmRw", new ExecutionContext(
		...
		if (!isImplementation) {
			...
			stringBuffer.append(TEXT_12);
			{
				...
				callParameters.put("positiveOffsetCorrection", positiveOffsetCorrection);
				CallHelper.executeWithParameterInjection(
						"platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0y1Y0GJ-Ed-FqczH3ESmRw", new ExecutionContext(
								(InternalPatternContext) ctx), callParameters);
			}
