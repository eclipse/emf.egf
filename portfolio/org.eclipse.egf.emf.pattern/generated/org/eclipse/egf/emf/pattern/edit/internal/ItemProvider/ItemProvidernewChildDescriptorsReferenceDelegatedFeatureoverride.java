...
return parameters; }
    ...
    final Map<String, Object> parameters__zv0AIGJ_EdFqczH3ESmRw = new HashMap<String, Object>();
parameters__zv0AIGJ_EdFqczH3ESmRw.put("createClass", createClass);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("createFeature", createFeature);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("delegatedFeature", delegatedFeature);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("createClassifier", createClassifier);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("childCreationData", childCreationData);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("genClass", genClass);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("genPackage", genPackage);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("genModel", genModel);
parameters__zv0AIGJ_EdFqczH3ESmRw.put("_List", _List);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_04NBAGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__zv0AIGJ_EdFqczH3ESmRw);
