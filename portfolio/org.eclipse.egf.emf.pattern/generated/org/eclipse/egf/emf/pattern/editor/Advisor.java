...
public class Advisor extends org.eclipse.egf.emf.pattern.base.GenModelJava {
	...
	protected final String TEXT_4 = NL + "import java.io.File;" + NL
	...
	protected final String TEXT_7 = NL + NL
			+ "import org.eclipse.equinox.app.IApplication;" + NL
			+ "import org.eclipse.equinox.app.IApplicationContext;" + NL + ""
			+ NL + "import org.eclipse.jface.action.GroupMarker;" + NL
			+ "import org.eclipse.jface.action.IAction;" + NL
			+ "import org.eclipse.jface.action.IMenuManager;" + NL
			+ "import org.eclipse.jface.action.MenuManager;" + NL
			+ "import org.eclipse.jface.action.Separator;" + NL
	...
	protected final String TEXT_9 = NL
			+ "import org.eclipse.swt.graphics.Point;" + NL
			+ "import org.eclipse.swt.widgets.Display;";
	protected final String TEXT_10 = NL
			+ "import org.eclipse.swt.widgets.FileDialog;" + NL
			+ "import org.eclipse.swt.widgets.Shell;";
	protected final String TEXT_11 = NL
			+ "import org.eclipse.ui.IEditorDescriptor;" + NL
			+ "import org.eclipse.ui.IFolderLayout;" + NL
			+ "import org.eclipse.ui.IPageLayout;" + NL
			+ "import org.eclipse.ui.IPerspectiveFactory;" + NL
			+ "import org.eclipse.ui.IWorkbench;" + NL
			+ "import org.eclipse.ui.IWorkbenchActionConstants;" + NL
			+ "import org.eclipse.ui.IWorkbenchPage;" + NL
			+ "import org.eclipse.ui.IWorkbenchWindow;" + NL
			+ "import org.eclipse.ui.PartInitException;" + NL
			+ "import org.eclipse.ui.PlatformUI;" + NL
	...
	protected final String TEXT_13 = NL
			...
			+ NL + "import org.eclipse.emf.common.util.URI;";
	protected final String TEXT_14 = NL
			+ "import org.eclipse.emf.common.util.UniqueEList;";
	protected final String TEXT_15 = NL
			+ "import org.eclipse.emf.edit.ui.action.LoadResourceAction;" + NL
			+ "import org.eclipse.emf.edit.ui.util.EditUIUtil;" + NL + "" + NL
			+ "import ";
	...
	protected final String TEXT_23 = NL
			+ "\tprivate static final String[] FILE_EXTENSION_FILTERS = ";
	...
	protected final String TEXT_26 = NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tprivate static String[] getFileExtensionFilters()" + NL
			+ "\t{" + NL + "\t\t";
	...
	protected final String TEXT_35 = NL
			...
			+ NL + "\t{" + NL + "\t\treturn ";
	protected final String TEXT_36 = ".INSTANCE.getString(key);"
			+ NL
			+ "\t}"
			+ NL
			+ ""
			...
			+ "\t{" + NL + "\t\treturn ";
	protected final String TEXT_37 = ".INSTANCE.getString(key, new Object [] { s1 });"
			+ NL
			+ "\t}"
			+ NL
			+ ""
	...
	protected final String TEXT_61 = NL + "\t" + NL + "\t/**" + NL
			+ "\t * Open URI action for the objects from the ";
	...
	protected final String TEXT_63 = NL
			+ "\t\t\t\tfor (URI uri : loadResourceDialog.getURIs())" + NL
			+ "\t\t\t\t{" + NL
	...
	protected final String TEXT_66 = NL
			...
			+ NL + "\t\t\tString[] allFilters = new String[size];" + NL
			+ "\t\t\t";
	...
	protected final String TEXT_68 = "() : null;" + NL + "\t\t\t" + NL
			...
			+ NL + "\t\t\t{" + NL + "\t\t\t\tif (includeGroupFilter)" + NL
			+ "\t\t\t\t{" + NL + "\t\t\t\t\tif (i != 0)" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tgroup.append(';');" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\tgroup.append(fileExtensionFilters[i]);" + NL
			+ "\t\t\t\t}" + NL
			+ "\t\t\t\tallFilters[i + offset] = fileExtensionFilters[i];" + NL
			+ "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif (includeGroupFilter)"
			+ NL + "\t\t\t{" + NL + "\t\t\t\tallFilters[0] = group.toString();"
			+ NL + "\t\t\t}" + NL + "\t\t\tif (includeAllFilter)" + NL
			+ "\t\t\t{" + NL
	...
	protected final String TEXT_70 = NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tfilename += extension;" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t}" + NL + "\t\t\tresult[i] = filename;" + NL + "\t\t}"
			+ NL + "\t\treturn result;" + NL + "\t}";
	protected final String TEXT_71 = NL
			...
			+ NL + "\t\tif (editorDescriptor == null)" + NL + "\t\t{" + NL
			+ "\t\t\tMessageDialog.openError(" + NL
			+ "\t\t\t\tworkbenchWindow.getShell()," + NL
	...
	protected final String TEXT_73 = NL
			...
			+ NL + "\t\t\t}" + NL + "\t\t\tcatch (PartInitException exception)"
			+ NL + "\t\t\t{" + NL + "\t\t\t\tMessageDialog.openError(" + NL
			+ "\t\t\t\t\tworkbenchWindow.getShell()," + NL
	...
	protected final String TEXT_80 = NL
			...
			+ NL + "\t{" + NL + "\t\treturn new WindowAdvisor(configurer);"
			+ NL + "\t}" + NL + "}";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		String _UniqueEListOfString = "UniqueEList"
				+ (genModel.useGenerics() ? "<String>" : "");
		String _StringBuilder = genModel
				.getImportedName(genModel.useGenerics() ? "java.lang.StringBuilder"
		...
		if (!genModel.isRichAjaxPlatform()) {
			...
			if (genModel.getAllGenPackagesWithConcreteClasses().size() == 1) {
				...
				stringBuffer.append(genModel
						.getAllGenPackagesWithConcreteClasses().get(0)
				...
				for (GenPackage genPackage : genModel
					...
					stringBuffer
							.append(genPackage.getImportedEditorClassName());
