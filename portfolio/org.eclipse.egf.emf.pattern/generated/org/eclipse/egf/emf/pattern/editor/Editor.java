...
public class Editor extends org.eclipse.egf.emf.pattern.base.GenPackageJava {
	...
	protected final String TEXT_60 = " extensions, String prefix)" + NL + "\t{"
			+ NL + "\t\t";
	...
	protected final String TEXT_73 = ".this);"
			+ NL
			+ ""
			+ NL
	...
	protected final String TEXT_74 = ".this);" + NL
			...
			+ "\t\t\t\t}" + NL + "\t\t\t\telse if (p == ";
	protected final String TEXT_75 = ".this)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\thandleActivate();" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
	...
	protected final String TEXT_94 = "();"
			...
			+ "\t\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t\t}" + NL + ""
			+ NL + "\t\t\t\t\t\tpublic ";
	protected final String TEXT_95 = " getChangedResources()" + NL
			+ "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\treturn changedResources;"
			+ NL + "\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\tpublic ";
	protected final String TEXT_96 = " getRemovedResources()"
			+ NL
			+ "\t\t\t\t\t\t{"
			+ NL
	...
	protected final String TEXT_97 = ".this, false);"
			+ NL
			+ "\t\t\t\t\t\t\t\t\t }"
			+ NL
			+ "\t\t\t\t\t\t\t\t }"
	...
	protected final String TEXT_98 = ".this)" + NL + "\t\t\t\t\t\t\t\t\t {"
			...
			+ "\t\t\t\t\t";
	protected final String TEXT_99 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t};";
	...
	protected final String TEXT_101 = ".this, false);"
			+ NL
			+ "\t\t\t}"
			+ NL
			+ "\t\t\telse"
	...
	protected final String TEXT_110 = NL + "\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t null," + NL
	...
	protected final String TEXT_117 = NL
			...
			+ NL + "\t\t\t\t\t";
	protected final String TEXT_118 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}";
	protected final String TEXT_119 = NL
			...
			+ NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
	protected final String TEXT_120 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
	...
	protected final String TEXT_130 = " collection)" + NL + "\t{" + NL
			+ "\t\tfinal ";
	protected final String TEXT_131 = " theSelection = collection;"
			+ NL
			+ "\t\t// Make sure it's okay."
			+ NL
			+ "\t\t//"
	...
	protected final String TEXT_237 = NL
			...
			+ "\t\t\treturn this;" + NL + "\t\t}";
	protected final String TEXT_238 = NL + "\t\telse" + NL + "\t\t{" + NL
	...
	protected final String TEXT_250 = " selection)" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t";
	protected final String TEXT_251 = ".this.setSelectionToViewer(selection);"
			+ NL + "\t\t\t\t\t\t";
	protected final String TEXT_252 = ".this.setFocus();" + NL + "\t\t\t\t\t}"
			+ NL;
	...
	protected final String TEXT_259 = " selectedElements = ((IStructuredSelection)selection).iterator();"
			+ NL
	...
	protected final String TEXT_279 = "(IProgressMonitor monitor)" + NL
			+ "\t\t\t\t{" + NL
	...
	protected final String TEXT_287 = NL
			...
			+ "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_288 = ".INSTANCE.log(exception);"
			+ NL
			+ "\t\t}"
			+ NL
			+ "\t\tupdateProblemIndication = true;"
	...
	protected final String TEXT_290 = NL + "\tpublic boolean isSaveAsAllowed()"
	...
	protected final String TEXT_294 = "(getSite().getShell(), null, SWT.NONE)"
			+ NL + "\t\t\t{";
	protected final String TEXT_295 = NL + "\t\t\t\t@Override";
	protected final String TEXT_296 = NL + "\t\t\t\tprotected boolean isSave()"
	...
	protected final String TEXT_298 = NL
			...
			+ NL + "\t\t\t\t\t";
	protected final String TEXT_299 = " uris = getURIs();" + NL
			+ "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tURI uri = ";
	protected final String TEXT_300 = "uris.get(0);" + NL
			+ "\t\t\t\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_301 = "(uri));" + NL
			+ "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}.open();";
	...
	protected final String TEXT_304 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);"
			+ NL + "\t\tString[] files = ";
	protected final String TEXT_305 = ".openFilePathDialog(getSite().getShell(), ";
	protected final String TEXT_306 = ".SAVE, filters);" + NL
	...
	protected final String TEXT_308 = NL
			...
			+ NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_309 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
	...
	protected final String TEXT_311 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);"
			+ NL
	...
	protected final String TEXT_313 = NL
			...
			+ "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_314 = ".INSTANCE.log(exception);" + NL
			+ "\t\t}" + NL + "\t}";
	...
	protected final String TEXT_319 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_321 = NL + "\tpublic void setFocus()" + NL
			+ "\t{";
	protected final String TEXT_322 = NL + "\t\tif (currentViewerPane != null)"
	...
	protected final String TEXT_329 = NL
			...
			+ "\t\t\t{" + NL + "\t\t\t\t";
	protected final String TEXT_330 = " collection = ((IStructuredSelection)selection).toList();"
			+ NL
	...
	protected final String TEXT_333 = NL + "\t\t\t\t\t\tbreak;" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL
			+ "\t\t\telse" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_334 = NL
			...
			+ NL + "\t{" + NL + "\t\treturn ";
	protected final String TEXT_335 = ".INSTANCE.getString(key);"
			+ NL
			+ "\t}"
			+ NL
			+ ""
			...
			+ "\t{" + NL + "\t\treturn ";
	protected final String TEXT_336 = ".INSTANCE.getString(key, new Object [] { s1 });"
			+ NL
			+ "\t}"
			+ NL
			+ ""
	...
	protected final String TEXT_338 = NL + "\tpublic void dispose()" + NL
