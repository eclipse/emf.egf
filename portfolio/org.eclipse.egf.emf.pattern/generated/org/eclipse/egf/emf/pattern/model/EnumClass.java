...
public class EnumClass extends org.eclipse.egf.emf.pattern.base.GenEnumJava {
	...
	protected final String TEXT_5 = "</b></em>'," + NL
			+ " * and utility methods for working with them." + NL
			+ " * <!-- end-user-doc -->";
	...
	protected final String TEXT_25 = "</b></em>' literal object." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_39 = "</b></em>' literal value." + NL
			+ "\t * <!-- begin-user-doc -->";
	protected final String TEXT_40 = NL + "\t * <p>" + NL
			+ "\t * If the meaning of '<em><b>";
	protected final String TEXT_41 = "</b></em>' literal object isn't clear,"
			+ NL + "\t * there really should be more of a description here..."
			+ NL + "\t * </p>";
	...
	protected final String TEXT_53 = "</b></em>' literal object." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	protected final String TEXT_54 = NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\tpublic static final ";
	...
	protected final String TEXT_62 = NL + "\t/**" + NL
			+ "\t * An array of all the '<em><b>";
	protected final String TEXT_63 = "</b></em>' enumerators." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate static final ";
	protected final String TEXT_64 = "[] VALUES_ARRAY =" + NL + "\t\tnew ";
	protected final String TEXT_65 = "[]" + NL + "\t\t{";
	protected final String TEXT_66 = NL + "\t\t\t";
	protected final String TEXT_67 = ",";
	protected final String TEXT_68 = NL + "\t\t};" + NL + "" + NL + "\t/**"
			+ NL + "\t * A public read-only list of all the '<em><b>";
	protected final String TEXT_69 = "</b></em>' enumerators." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic static final List";
	protected final String TEXT_70 = "<";
	protected final String TEXT_71 = ">";
	protected final String TEXT_72 = " VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));"
			+ NL + "" + NL + "\t/**" + NL + "\t * Returns the '<em><b>";
	protected final String TEXT_73 = "</b></em>' literal with the specified literal value."
			+ NL
			+ "\t * <!-- begin-user-doc -->"
			+ NL
			+ "\t * <!-- end-user-doc -->"
	...
	protected final String TEXT_75 = " literal)" + NL + "\t{" + NL
			+ "\t\tfor (int i = 0; i < VALUES_ARRAY.length; ++i)" + NL
			+ "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_76 = " result = VALUES_ARRAY[i];" + NL
			+ "\t\t\tif (result.toString().equals(literal))" + NL + "\t\t\t{"
			+ NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}"
			+ NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "\t/**"
			+ NL + "\t * Returns the '<em><b>";
	protected final String TEXT_77 = "</b></em>' literal with the specified name."
			+ NL
			+ "\t * <!-- begin-user-doc -->"
			+ NL
			+ "\t * <!-- end-user-doc -->"
	...
	protected final String TEXT_79 = " name)" + NL + "\t{" + NL
			+ "\t\tfor (int i = 0; i < VALUES_ARRAY.length; ++i)" + NL
			+ "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_80 = " result = VALUES_ARRAY[i];" + NL
			+ "\t\t\tif (result.getName().equals(name))" + NL + "\t\t\t{" + NL
			+ "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL
			+ "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * Returns the '<em><b>";
	protected final String TEXT_81 = "</b></em>' literal with the specified integer value."
			+ NL
			+ "\t * <!-- begin-user-doc -->"
			+ NL
			+ "\t * <!-- end-user-doc -->"
			...
			+ NL
			+ "\t */" + NL + "\tpublic static ";
	protected final String TEXT_82 = " get(int value)" + NL + "\t{" + NL
			+ "\t\tswitch (value)" + NL + "\t\t{";
	protected final String TEXT_83 = NL + "\t\t\tcase ";
	protected final String TEXT_84 = ": return ";
	protected final String TEXT_85 = ";";
	protected final String TEXT_86 = NL + "\t\t}" + NL + "\t\treturn null;"
			+ NL + "\t}" + NL;
	protected final String TEXT_87 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate final int value;" + NL + "" + NL
			+ "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate final ";
	protected final String TEXT_88 = " name;" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate final ";
	protected final String TEXT_89 = " literal;" + NL;
	protected final String TEXT_90 = NL + "\t/**" + NL
			+ "\t * Only this class can construct instances." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate ";
	...
	protected final String TEXT_94 = NL + "\t\tthis.value = value;" + NL
			+ "\t\tthis.name = name;" + NL + "\t\tthis.literal = literal;";
	...
	protected final String TEXT_97 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic int getValue()" + NL + "\t{" + NL
			+ "\t  return value;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_98 = " getName()" + NL + "\t{" + NL
			+ "\t  return name;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_99 = " getLiteral()"
			+ NL
			+ "\t{"
			+ NL
			+ "\t  return literal;"
	...
	protected final String TEXT_102 = " toString()" + NL + "\t{" + NL
			+ "\t\treturn literal;" + NL + "\t}" + NL + "\t";
	...
	protected final String TEXT_105 = NL
			...
			+ NL + " * <!-- begin-user-doc -->" + NL
			+ " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */"
			+ NL + "interface Internal";
	protected final String TEXT_106 = " extends org.eclipse.emf.common.util.Enumerator"
			+ NL + "{" + NL + "\t// Empty " + NL + "}";
	protected final String TEXT_107 = NL + "/**" + NL
			...
			+ " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */"
			+ NL + "class Internal";
	protected final String TEXT_108 = " extends org.eclipse.emf.common.util.AbstractEnumerator"
			+ NL
			+ "{"
			+ NL
			+ "\t/**"
			...
			+ "\t * @generated"
			+ NL
			+ "\t */" + NL + "\tprotected Internal";
	protected final String TEXT_109 = "(int value, ";
	protected final String TEXT_110 = " name, ";
	protected final String TEXT_111 = " literal)" + NL + "\t{" + NL
			+ "\t\tsuper(value, name, literal);" + NL + "\t}" + NL + "}";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genEnum.hasDocumentation()) {
			...
			stringBuffer.append(genEnum.getDocumentation(genModel
		...
		stringBuffer
				.append(genModel.isSuppressEMFMetaData()
						&& !genModel.isSuppressInterfaces() ? "Internal"
						+ genEnum.getName()
						: genModel
								.getImportedName(isEnum ? "org.eclipse.emf.common.util.Enumerator"
		...
		if (isEnum) {
			if (genEnum.getGenEnumLiterals().isEmpty()) {
				...
				for (Iterator<GenEnumLiteral> l = genEnum.getGenEnumLiterals()
						.iterator(); l.hasNext();) {
					...
					stringBuffer.append(Literals.toStringLiteral(
							genEnumLiteral.getLiteral(), genModel));
		...
		for (GenEnumLiteral genEnumLiteral : genEnum.getGenEnumLiterals()) {
			...
			if (genEnumLiteral.hasDocumentation()) {
				...
				stringBuffer.append(genEnumLiteral.getDocumentation(genModel
						.getIndentation(stringBuffer)));
