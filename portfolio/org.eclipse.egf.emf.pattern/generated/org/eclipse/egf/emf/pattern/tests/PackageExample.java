...
public class PackageExample extends
	...
	protected final String TEXT_5 = "</b></em>' package." + NL
	...
	protected final String TEXT_11 = NL
			...
			+ NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @param args the file paths or URIs." + NL
			+ "\t * @generated" + NL + "\t */" + NL
			+ "\tpublic static void main(String[] args)" + NL + "\t{" + NL
			+ "\t\t// Create a resource set to hold the resources." + NL
			+ "\t\t//" + NL + "\t\t";
	...
	protected final String TEXT_16 = "());"
			...
			+ NL + "\t\t//" + NL
			+ "\t\tresourceSet.getURIConverter().getContentHandlers().add" + NL
			+ "\t\t\t(new ";
	...
	protected final String TEXT_23 = NL
			...
			+ NL + "\t\t\t(Resource.Factory.Registry.DEFAULT_EXTENSION, " + NL
			+ "\t\t\t new ";
	protected final String TEXT_24 = "());";
	protected final String TEXT_25 = NL
			+ NL
			+ "\t\t// Register the package to ensure it is available during loading."
			+ NL + "\t\t//" + NL + "\t\tresourceSet.getPackageRegistry().put"
			+ NL + "\t\t\t(";
	...
	protected final String TEXT_62 = ".out, null);" + NL + "\t\t\t}" + NL
			+ "\t\t\tcatch (";
	protected final String TEXT_63 = " exception) " + NL + "\t\t\t{" + NL
			+ "\t\t\t\texception.printStackTrace();" + NL + "\t\t\t}";
	...
	protected final String TEXT_65 = NL
			...
			+ NL + "\t\t\t\t// Otherwise, it's directly treated as a URL." + NL
			+ "\t\t\t\t//" + NL + "\t\t\t\t";
	...
	protected final String TEXT_69 = ".createFileURI(file.getAbsolutePath()): URI.createURI(args[i]);"
			+ NL
			+ ""
			+ NL
			+ "\t\t\t\ttry"
			...
			+ NL
			+ "\t\t\t\t\t//" + NL + "\t\t\t\t\t";
	protected final String TEXT_70 = " resource = resourceSet.getResource(uri, true);"
			+ NL + "\t\t\t\t\tSystem.out.println(\"Loaded \" + uri);";
	protected final String TEXT_71 = NL + NL
			+ "\t\t\t\t\t// Validate the contents of the loaded resource." + NL
			+ "\t\t\t\t\t//";
	...
	protected final String TEXT_82 = ".INSTANCE.validate(eObject);" + NL
			+ "\t\t\t\t\t\tif (diagnostic.getSeverity() != Diagnostic.OK)" + NL
			+ "\t\t\t\t\t\t{" + NL
	...
	protected final String TEXT_85 = NL
			...
			+ NL + "\t{" + NL + "\t\tSystem.out.print(indent);" + NL
			+ "\t\tSystem.out.println(diagnostic.getMessage());";
	protected final String TEXT_86 = NL
			+ "\t\tfor (Diagnostic child : diagnostic.getChildren())" + NL
			+ "\t\t{" + NL + "\t\t\tprintDiagnostic(child, indent + \"  \");";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		String _RuntimeException = genModel
				.getImportedName("java.lang.RuntimeException");
		...
		String _Diagnostic = genModel
				.getImportedName("org.eclipse.emf.common.util.Diagnostic");
		String _URI = genModel
				.getImportedName("org.eclipse.emf.common.util.URI");
		String _EObject = genModel
				.getImportedName("org.eclipse.emf.ecore.EObject");
		String _Diagnostician = genModel
				.getImportedName("org.eclipse.emf.ecore.util.Diagnostician");
		String _Resource = genModel
				.getImportedName("org.eclipse.emf.ecore.resource.Resource");
		String _ResourceSet = genModel
				.getImportedName("org.eclipse.emf.ecore.resource.ResourceSet");
		String _ResourceSetImpl = genModel
				.getImportedName("org.eclipse.emf.ecore.resource.impl.ResourceSetImpl");
		...
		if (genPackage.isContentType()) {
			...
			stringBuffer.append(genModel.getImportedName(genPackage
					.getQualifiedEffectiveResourceFactoryClassName()));
			stringBuffer.append(TEXT_16);
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.xmi.impl.RootXMLContentHandlerImpl"));
		...
		if (genPackage.getRootClass() != null) {
			...
			if (genPackage.getRootFeature() != null) {
				...
				stringBuffer.append(rootClass.getGenPackage()
						.getQualifiedEFactoryInternalInstanceAccessor());
				...
				if (documentRoot.isDynamic()) {
					...
					stringBuffer.append(rootFeature
			...
			stringBuffer
					.append(genModel.getImportedName("java.io.IOException"));
	...
	public boolean preCondition() throws Exception {
		...
		canGenerate = canGenerate
				&& (genPackage.hasClassifiers() && genPackage
