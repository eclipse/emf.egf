...
public class PluginXML extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_16 = NL + "         <export name=\"*\"/>" + NL
			+ "      </library>" + NL + "   </runtime>";
	...
	protected final String TEXT_24 = NL + "      <extender" + NL
			+ "            uri=\"";
	...
	protected final String TEXT_47 = NL + "         </describer>" + NL
			+ "      </content-type>" + NL + "   </extension>";
	...
	protected final String TEXT_51 = NL + NL + "   <extension" + NL
			+ "         point=\"org.eclipse.core.runtime.applications\"" + NL
			+ "         id=\"";
	protected final String TEXT_52 = "Application\">" + NL
			+ "      <application>" + NL + "         <run class=\"";
	protected final String TEXT_53 = "$Application\"/>" + NL
			+ "      </application>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.perspectives\">" + NL
			+ "      <perspective" + NL
			+ "            name=\"%_UI_Perspective_label\"" + NL
			+ "            class=\"";
	protected final String TEXT_54 = "$Perspective\"" + NL
			+ "            id=\"";
	protected final String TEXT_55 = "Perspective\">" + NL
			+ "      </perspective>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.commands\">" + NL
			+ "      <command" + NL
			+ "            name=\"%_UI_Menu_OpenURI_label\"" + NL
			+ "            description=\"%_UI_Menu_OpenURI_description\"" + NL
			+ "            categoryId=\"org.eclipse.ui.category.file\"" + NL
			+ "            id=\"";
	protected final String TEXT_56 = "OpenURICommand\"/>";
	protected final String TEXT_57 = NL + "      <command" + NL
			+ "            name=\"%_UI_Menu_Open_label\"" + NL
	...
	protected final String TEXT_60 = NL
			+ "   <extension point=\"org.eclipse.ui.bindings\">" + NL
			+ "      <key" + NL + "            commandId=\"";
	protected final String TEXT_61 = "OpenURICommand\""
			...
			+ NL + "      <key" + NL + "            commandId=\"";
	protected final String TEXT_62 = "OpenCommand\""
			+ NL
			+ "            sequence=\"M1+O\""
			+ NL
			+ "            schemeId=\"org.eclipse.ui.defaultAcceleratorConfiguration\"/>"
	...
	protected final String TEXT_63 = NL + NL
			+ "   <extension point=\"org.eclipse.ui.actionSets\">" + NL
			+ "      <actionSet" + NL + "            label=\"%_UI_";
	protected final String TEXT_64 = "_ActionSet_label\"" + NL
			+ "            visible=\"true\"" + NL + "            id=\"";
	protected final String TEXT_65 = "ActionSet\">" + NL + "         <action"
			+ NL + "               label=\"%_UI_Menu_About_label\"" + NL
			+ "               class=\"";
	protected final String TEXT_66 = "$AboutAction\"" + NL
			+ "               menubarPath=\"help/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_67 = "AboutAction\"/>" + NL
			+ "         <action" + NL
			+ "               label=\"%_UI_Menu_OpenURI_label\"" + NL
			+ "               definitionId=\"";
	protected final String TEXT_68 = "OpenURICommand\"" + NL
			+ "               class=\"";
	protected final String TEXT_69 = "$OpenURIAction\"" + NL
			+ "               menubarPath=\"file/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_70 = "OpenURIAction\"/>";
	protected final String TEXT_71 = NL + "         <action" + NL
			+ "               label=\"%_UI_Menu_Open_label\"" + NL
			+ "               definitionId=\"";
	protected final String TEXT_72 = "OpenCommand\"" + NL
			+ "               class=\"";
	protected final String TEXT_73 = "$OpenAction\"" + NL
			+ "               menubarPath=\"file/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_74 = "OpenAction\"/>";
	protected final String TEXT_75 = NL + "      </actionSet>" + NL
			+ "   </extension>";
	protected final String TEXT_76 = NL + NL
			+ "   <extension point=\"org.eclipse.ui.actionSets\">" + NL
			+ "      <actionSet" + NL + "            label=\"%_UI_";
	protected final String TEXT_77 = "_ActionSet_label\"" + NL
			+ "            visible=\"true\"" + NL + "            id=\"";
	protected final String TEXT_78 = "ActionSet\">" + NL + "         <action"
			+ NL + "               label=\"%_UI_";
	protected final String TEXT_79 = "_label\"" + NL
			+ "               class=\"";
	protected final String TEXT_80 = "$NewAction\"" + NL
			+ "               menubarPath=\"file/new/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_81 = "NewAction\"/>" + NL
			+ "      </actionSet>" + NL + "   </extension>";
	protected final String TEXT_82 = NL + NL
			+ "   <extension point=\"org.eclipse.ui.newWizards\">" + NL
			+ "      <category" + NL
			+ "            id=\"org.eclipse.emf.ecore.Wizard.category.ID\""
			+ NL + "            name=\"%_UI_Wizard_category\"/>" + NL
			+ "      <wizard" + NL + "            id=\"";
	...
	protected final String TEXT_86 = "ModelFile.gif\">" + NL
			+ "         <description>%_UI_";
	protected final String TEXT_87 = "_description</description>"
			+ NL
			+ "         <selection class=\"org.eclipse.core.resources.IResource\"/>"
			+ NL + "      </wizard>" + NL + "   </extension>";
	protected final String TEXT_88 = NL + NL
			+ "   <extension point=\"org.eclipse.ui.editors\">" + NL
			+ "      <editor" + NL + "            id=\"";
	protected final String TEXT_89 = "ID\"" + NL + "            name=\"%_UI_";
	protected final String TEXT_90 = "_label\"" + NL
	...
	protected final String TEXT_97 = NL
			+ "         <contentTypeBinding contentTypeId=\"";
	protected final String TEXT_98 = "\"/>";
	protected final String TEXT_99 = NL + "      </editor>" + NL
			+ "   </extension>";
		...
		if (genModel.sameEditEditorProject()) {
			for (GenPackage genPackage : genModel
				...
				if (!genPackage.getGenClasses().isEmpty()) {
					...
					for (ListIterator<?> j = genPackage
							.getProviderSupportedTypes().listIterator(); j
							.hasNext();) {
					...
					if (genPackage.isChildCreationExtenders()) {
						...
						if (!extendedChildCreationData.isEmpty()) {
							...
							for (Map.Entry<GenPackage, Map<GenClass, List<GenClass.ChildCreationData>>> entry : extendedChildCreationData
								...
								stringBuffer.append(genPackage
										.getChildCreationExtenderName(entry
												.getKey()));
		...
		if (genModel.sameModelEditorProject()) {
			for (GenPackage genPackage : genModel
				...
				if (genPackage.isContentType()) {
					...
					stringBuffer
							.append(genPackage.isXMIResource() ? "org.eclipse.emf.ecore.xmi"
