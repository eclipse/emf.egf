...
public class PluginXML extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_6 = "\"" + NL + "      version=\"1.0.0\"" + NL + "      provider-name=\"%providerName\"" + NL
			+ "      class=\"";
	...
	protected final String TEXT_17 = NL + NL + "   <extension point=\"org.eclipse.emf.edit.itemProviderAdapterFactories\">" + NL
			+ "      <factory" + NL + "            uri=\"";
	...
	protected final String TEXT_29 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.generated_package\">" + NL + "      <package"
			+ NL + "            uri=\"";
	...
	protected final String TEXT_37 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.content_parser\">" + NL + "      <parser" + NL
	...
	protected final String TEXT_48 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.extension_parser\">" + NL + "      <parser"
			+ NL + "            type=\"";
	protected final String TEXT_49 = "\"" + NL + "            class=\"";
	protected final String TEXT_50 = "\"/>" + NL + "   </extension>";
	protected final String TEXT_51 = NL + NL + "   <extension" + NL + "         point=\"org.eclipse.core.runtime.applications\"" + NL
			+ "         id=\"";
	protected final String TEXT_52 = "Application\">" + NL + "      <application>" + NL + "         <run class=\"";
	protected final String TEXT_53 = "$Application\"/>" + NL + "      </application>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.perspectives\">" + NL + "      <perspective" + NL
			+ "            name=\"%_UI_Perspective_label\"" + NL + "            class=\"";
	protected final String TEXT_54 = "$Perspective\"" + NL + "            id=\"";
	protected final String TEXT_55 = "Perspective\">" + NL + "      </perspective>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.commands\">" + NL + "      <command" + NL
			+ "            name=\"%_UI_Menu_OpenURI_label\"" + NL + "            description=\"%_UI_Menu_OpenURI_description\"" + NL
			+ "            categoryId=\"org.eclipse.ui.category.file\"" + NL + "            id=\"";
	protected final String TEXT_56 = "OpenURICommand\"/>" + NL + "      <command" + NL + "            name=\"%_UI_Menu_Open_label\"" + NL
			+ "            description=\"%_UI_Menu_Open_description\"" + NL + "            categoryId=\"org.eclipse.ui.category.file\""
			+ NL + "            id=\"";
	protected final String TEXT_57 = "OpenCommand\"/>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.bindings\">" + NL + "      <key" + NL + "            commandId=\"";
	protected final String TEXT_58 = "OpenURICommand\"" + NL + "            sequence=\"M1+U\"" + NL
			+ "            schemeId=\"org.eclipse.ui.defaultAcceleratorConfiguration\"/>" + NL + "      <key" + NL
			+ "            commandId=\"";
	protected final String TEXT_59 = "OpenCommand\"" + NL + "            sequence=\"M1+O\"" + NL
			+ "            schemeId=\"org.eclipse.ui.defaultAcceleratorConfiguration\"/>" + NL + "   </extension>" + NL + "" + NL
			+ "   <extension point=\"org.eclipse.ui.actionSets\">" + NL + "      <actionSet" + NL + "            label=\"%_UI_";
	protected final String TEXT_60 = "_ActionSet_label\"" + NL + "            visible=\"true\"" + NL + "            id=\"";
	protected final String TEXT_61 = "ActionSet\">" + NL + "         <action" + NL + "               label=\"%_UI_Menu_About_label\"" + NL
			+ "               class=\"";
	protected final String TEXT_62 = "$AboutAction\"" + NL + "               menubarPath=\"help/additions\"" + NL + "               id=\"";
	protected final String TEXT_63 = "AboutAction\"/>" + NL + "         <action" + NL + "               label=\"%_UI_Menu_OpenURI_label\""
			+ NL + "               definitionId=\"";
	protected final String TEXT_64 = "OpenURICommand\"" + NL + "               class=\"";
	protected final String TEXT_65 = "$OpenURIAction\"" + NL + "               menubarPath=\"file/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_66 = "OpenURIAction\"/>" + NL + "         <action" + NL + "               label=\"%_UI_Menu_Open_label\""
			+ NL + "               definitionId=\"";
	protected final String TEXT_67 = "OpenCommand\"" + NL + "               class=\"";
	protected final String TEXT_68 = "$OpenAction\"" + NL + "               menubarPath=\"file/additions\"" + NL + "               id=\"";
	protected final String TEXT_69 = "OpenAction\"/>" + NL + "      </actionSet>" + NL + "   </extension>";
	protected final String TEXT_70 = NL + NL + "   <extension point=\"org.eclipse.ui.actionSets\">" + NL + "      <actionSet" + NL
			+ "            label=\"%_UI_";
	protected final String TEXT_71 = "_ActionSet_label\"" + NL + "            visible=\"true\"" + NL + "            id=\"";
	protected final String TEXT_72 = "ActionSet\">" + NL + "         <action" + NL + "               label=\"%_UI_";
	protected final String TEXT_73 = "_label\"" + NL + "               class=\"";
	protected final String TEXT_74 = "$NewAction\"" + NL + "               menubarPath=\"file/new/additions\"" + NL
			+ "               id=\"";
	protected final String TEXT_75 = "NewAction\"/>" + NL + "      </actionSet>" + NL + "   </extension>";
	protected final String TEXT_76 = NL + NL + "   <extension point=\"org.eclipse.ui.newWizards\">" + NL + "      <category" + NL
			+ "            id=\"org.eclipse.emf.ecore.Wizard.category.ID\"" + NL + "            name=\"%_UI_Wizard_category\"/>" + NL
			+ "      <wizard" + NL + "            id=\"";
	protected final String TEXT_77 = "ID\"" + NL + "            name=\"%_UI_";
	protected final String TEXT_78 = "_label\"" + NL + "            class=\"";
	protected final String TEXT_79 = "\"" + NL + "            category=\"org.eclipse.emf.ecore.Wizard.category.ID\"" + NL
			+ "            icon=\"icons/full/obj16/";
	protected final String TEXT_80 = "ModelFile.gif\">" + NL + "         <description>%_UI_";
	protected final String TEXT_81 = "_description</description>" + NL
			+ "         <selection class=\"org.eclipse.core.resources.IResource\"/>" + NL + "      </wizard>" + NL + "   </extension>";
	protected final String TEXT_82 = NL + NL + "   <extension point=\"org.eclipse.ui.editors\">" + NL + "      <editor" + NL
			+ "            id=\"";
	protected final String TEXT_83 = "ID\"" + NL + "            name=\"%_UI_";
	protected final String TEXT_84 = "_label\"" + NL + "            icon=\"icons/full/obj16/";
	protected final String TEXT_85 = "ModelFile.gif\"";
	protected final String TEXT_86 = NL + "            extensions=\"";
	protected final String TEXT_87 = "\"";
	protected final String TEXT_88 = NL + "            class=\"";
	protected final String TEXT_89 = "\"" + NL + "            contributorClass=\"";
	protected final String TEXT_90 = "\">";
	protected final String TEXT_91 = NL + "         <contentTypeBinding contentTypeId=\"";
	protected final String TEXT_92 = "\"/>";
	protected final String TEXT_93 = NL + "      </editor>" + NL + "   </extension>";
	protected final String TEXT_94 = NL + NL + "</plugin>" + NL;
