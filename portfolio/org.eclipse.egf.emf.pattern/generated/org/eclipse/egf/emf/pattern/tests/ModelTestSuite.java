...
public class ModelTestSuite extends
		org.eclipse.egf.emf.pattern.base.GenModelJava {
	...
	protected final String TEXT_5 = "</b></em>' model." + NL
	...
	protected final String TEXT_11 = NL + NL + "\t/**" + NL
			...
			+ "\t{" + NL + "\t\t";
	protected final String TEXT_12 = ".run(suite());" + NL + "\t}" + NL + ""
	...
	protected final String TEXT_19 = NL + "\t\treturn suite;" + NL + "\t}" + NL
			+ "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_20 = "(String name)" + NL + "\t{" + NL
			+ "\t\tsuper(name);" + NL + "\t}" + NL + "" + NL + "} //";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		stringBuffer.append(genModel
				.getImportedName("junit.framework.TestSuite"));
		...
		stringBuffer
				.append(genModel.getImportedName("junit.textui.TestRunner"));
