...
public class ItemProviderAdapterFactory extends
	...
	protected final String TEXT_118 = NL + "\t\t\t\treturn null;" + NL
			+ "\t\t\t}" + NL + " ";
	protected final String TEXT_119 = NL + "\t\t\t/**" + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */" + NL + "\t\t\tprotected ";
	protected final String TEXT_120 = " createChildParameter(Object feature, Object child)"
			+ NL + "\t\t\t{" + NL + "\t\t\t\treturn new ";
	protected final String TEXT_121 = "(null, feature, child);" + NL
			+ "\t\t\t}" + NL + "" + NL + "\t\t}" + NL + "" + NL + "\t\t/**"
			+ NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic ";
	...
	protected final String TEXT_126 = ")object);" + NL
			+ "\t\t   return result;" + NL + "\t\t}" + NL + "" + NL + "\t\t/**"
			+ NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic ";
	protected final String TEXT_127 = " getResourceLocator()" + NL + "\t\t{"
			+ NL + "\t\t\treturn ";
	protected final String TEXT_128 = ".INSTANCE;" + NL + "\t\t}" + NL + "\t}"
			+ NL;
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genPackage.isExtensibleProviderFactory()) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.edit.provider.ChildCreationExtenderManager"));
