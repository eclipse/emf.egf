 ...
 */
    ...
    final Map<String, Object> parameters__rrVRsGKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rrVRsGKSEd8eoMv8ZThYQ.put("argument", parameter);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern.base/egf/EMF_Pattern_Base.fcore#_XHLrsCwtEd-jc5T-XaRJlg", new ExecutionContext((InternalPatternContext) ctx), parameters__rrVRsGKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rrfCsGKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("createClass", createClass);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("createFeature", createFeature);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("delegatedFeature", delegatedFeature);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("createClassifier", createClassifier);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("childCreationData", childCreationData);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("classEntry", classEntry);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("packageEntry", packageEntry);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("useGenerics", useGenerics);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("_ArrayList", _ArrayList);
parameters__rrfCsGKSEd8eoMv8ZThYQ.put("_Collection", _Collection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_05_JsWJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rrfCsGKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rrfCsWKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("createDataType", createDataType);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("createFeature", createFeature);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("delegatedFeature", delegatedFeature);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("createClassifier", createClassifier);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("childCreationData", childCreationData);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("classEntry", classEntry);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("packageEntry", packageEntry);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("useGenerics", useGenerics);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("_ArrayList", _ArrayList);
parameters__rrfCsWKSEd8eoMv8ZThYQ.put("_Collection", _Collection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_06lmoGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rrfCsWKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rrfCsmKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("createClass", createClass);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("createFeature", createFeature);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("delegatedFeature", delegatedFeature);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("createClassifier", createClassifier);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("childCreationData", childCreationData);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("classEntry", classEntry);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("packageEntry", packageEntry);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("useGenerics", useGenerics);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("_ArrayList", _ArrayList);
parameters__rrfCsmKSEd8eoMv8ZThYQ.put("_Collection", _Collection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_07e-gGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rrfCsmKSEd8eoMv8ZThYQ);

    //ItemProvider/newChildDescriptorsReferenceFeature.override.javajetinc 
    stringBuffer.append(TEXT_113);
    } else { GenDataType createDataType = (GenDataType)createClassifier;
    stringBuffer.append(TEXT_114);
    final Map<String, Object> parameters__rrfCs2KSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("createDataType", createDataType);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("createFeature", createFeature);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("delegatedFeature", delegatedFeature);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("createClassifier", createClassifier);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("childCreationData", childCreationData);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("classEntry", classEntry);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("packageEntry", packageEntry);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("useGenerics", useGenerics);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("_ArrayList", _ArrayList);
parameters__rrfCs2KSEd8eoMv8ZThYQ.put("_Collection", _Collection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_08OlYGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rrfCs2KSEd8eoMv8ZThYQ);
