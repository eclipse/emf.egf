...
public class InterfaceeIsSetoverride {
	...
	public static synchronized InterfaceeIsSetoverride create(
	...
	protected final String TEXT_4 = NL
			+ "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL
			+ "\t\tswitch (featureID";
		...
		if (genModel.useGenerics()) {
			for (GenFeature genFeature : genClass.getEIsSetGenFeatures()) {
				if (genFeature.isListType()
						...
						&& !genFeature.isWrappedFeatureMapType()
						&& !genClass.isField(genFeature)
						&& genFeature.isField()
