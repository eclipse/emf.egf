...
public class PluginProperties extends
	...
	protected final String TEXT_3 = " Edit Support" + NL
			+ "providerName = www.example.org" + NL;
	protected final String TEXT_4 = NL + "_UI_CreateChild_text = {0}" + NL
			+ "_UI_CreateChild_text2 = {1} ";
	...
	protected final String TEXT_7 = NL
			+ "_UI_PropertyDescriptor_description = The {0} of the {1}" + NL;
	...
	protected final String TEXT_10 = NL + "_UI_Unknown_type = Object" + NL + ""
			+ NL + "_UI_Unknown_datatype= Value" + NL;
	...
	protected final String TEXT_17 = NL + "_UI_Unknown_feature = Unspecified"
			+ NL;
	...
	protected void method_setReporterVariables(final StringBuffer stringBuffer,
		...
		targetPathName = genModel.getEditProjectDirectory()
				+ "/plugin.properties";
