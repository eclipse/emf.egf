...
public class ItemProvider extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_15 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_16 = "(AdapterFactory adapterFactory)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_19 = " getPropertyDescriptors(Object object)"
	...
	protected final String TEXT_22 = NL + "\t\t}" + NL
			+ "\t\treturn itemPropertyDescriptors;" + NL + "\t}" + NL;
	protected final String TEXT_23 = NL + "\t/**" + NL
			+ "\t * This adds a property descriptor for the ";
	protected final String TEXT_24 = " feature." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_31 = " getChildrenFeatures(Object object)" + NL
	...
	protected final String TEXT_38 = " getChildFeature(Object object, Object child)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_44 = ".gif." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_64 = "(notification, notification.getNotifier(), false, true));"
			+ NL + "\t\t\t\treturn;";
	protected final String TEXT_65 = NL + "\t\t\tcase ";
	protected final String TEXT_66 = ":";
	protected final String TEXT_67 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_68 = "(notification, notification.getNotifier(), true, false));"
			+ NL + "\t\t\t\treturn;";
	protected final String TEXT_69 = NL + "\t\t\tcase ";
	protected final String TEXT_70 = ":";
	protected final String TEXT_71 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_72 = "(notification, notification.getNotifier(), true, true));"
			+ NL + "\t\t\t\treturn;";
	...
	protected final String TEXT_78 = " newChildDescriptors, Object object)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_87 = " selection)" + NL + "\t{" + NL
	...
	protected final String TEXT_90 = ".isFeatureMap((EStructuralFeature)childFeature))"
			+ NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_91 = ".Entry entry = (FeatureMap.Entry)childObject;"
			+ NL
	...
	protected final String TEXT_94 = NL + NL + "\t\tif (qualify)" + NL
