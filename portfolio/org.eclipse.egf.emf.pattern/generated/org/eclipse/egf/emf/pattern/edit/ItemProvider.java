...
public class ItemProvider extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_28 = NL + "\t/**" + NL + "\t * This specifies how to implement {@link #getChildren} and is used to deduce an appropriate feature for an" + NL
	...
	protected final String TEXT_57 = NL + "\t/**" + NL + "\t * This returns the label styled text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_62 = NL + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_63 = NL + "\t@Override";
	protected final String TEXT_64 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
	protected final String TEXT_65 = NL + NL + "\t\tswitch (notification.getFeatureID(";
	protected final String TEXT_66 = ".class))" + NL + "\t\t{";
	protected final String TEXT_67 = NL + "\t\t\tcase ";
	protected final String TEXT_68 = ":";
	protected final String TEXT_69 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_70 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
	protected final String TEXT_71 = NL + "\t\t\tcase ";
	protected final String TEXT_72 = ":";
	protected final String TEXT_73 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_74 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
	protected final String TEXT_75 = NL + "\t\t\tcase ";
	protected final String TEXT_76 = ":";
	protected final String TEXT_77 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_78 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
	protected final String TEXT_79 = NL + "\t\t}";
	protected final String TEXT_80 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
	protected final String TEXT_81 = NL + "\t/**" + NL + "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children" + NL + "\t * that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->"
			+ NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_82 = NL + "\t@Override";
	protected final String TEXT_83 = NL + "\tprotected void collectNewChildDescriptors(";
	protected final String TEXT_84 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
	protected final String TEXT_85 = NL;
	protected final String TEXT_86 = NL;
	protected final String TEXT_87 = NL;
	protected final String TEXT_88 = NL;
	protected final String TEXT_89 = NL + "\t}" + NL;
	protected final String TEXT_90 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_91 = NL + "\t@Override";
	protected final String TEXT_92 = NL + "\tpublic String getCreateChildText(Object owner, Object feature, Object child, ";
	protected final String TEXT_93 = " selection)" + NL + "\t{" + NL + "\t\tObject childFeature = feature;" + NL + "\t\tObject childObject = child;" + NL;
	protected final String TEXT_94 = NL + "\t\tif (childFeature instanceof ";
	protected final String TEXT_95 = " && ";
	protected final String TEXT_96 = ".isFeatureMap((EStructuralFeature)childFeature))" + NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_97 = ".Entry entry = (FeatureMap.Entry)childObject;" + NL + "\t\t\tchildFeature = entry.getEStructuralFeature();" + NL + "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
	protected final String TEXT_98 = NL + "\t\tboolean qualify =";
	protected final String TEXT_99 = NL + "\t\t\tchildFeature == ";
	protected final String TEXT_100 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
	protected final String TEXT_101 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
	protected final String TEXT_102 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_103 = NL + "\t@Override";
	protected final String TEXT_104 = NL + "\tpublic ";
	protected final String TEXT_105 = " getResourceLocator()" + NL + "\t{";
	protected final String TEXT_106 = NL + "\t\treturn ((";
	protected final String TEXT_107 = ")adapterFactory).getResourceLocator();";
	protected final String TEXT_108 = NL + "\t\treturn ";
	protected final String TEXT_109 = ".INSTANCE;";
