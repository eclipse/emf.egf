...
public class ResourceFactoryClass extends
	...
	protected final String TEXT_17 = NL + "\t/**" + NL
			+ "\t * Creates an instance of the resource factory." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	...
	protected final String TEXT_28 = NL
			+ "\tpublic Resource createResource(URI uri)" + NL + "\t{";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genPackage.hasExtendedMetaData()
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.xmi.XMLResource$XMLMap"));
			stringBuffer.append(TEXT_15);
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.xmi.impl.XMLMapImpl"));
		...
		if (genPackage.hasExtendedMetaData()
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.util.BasicExtendedMetaData"));
			stringBuffer.append(TEXT_20);
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.impl.EPackageRegistryImpl"));
