...
public class ResourceClass extends
	...
	protected final String TEXT_4 = NL + NL + "/**" + NL
			+ " * <!-- begin-user-doc -->" + NL
			+ " * The <b>Resource </b> associated with the package." + NL
			+ " * <!-- end-user-doc -->" + NL + " * @see ";
	...
	protected final String TEXT_12 = NL + "\t/**" + NL
			+ "\t * Creates an instance of the resource." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
			+ "\t * @param uri the URI of the new resource." + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	protected final String TEXT_13 = "(URI uri)" + NL + "\t{" + NL
			+ "\t\tsuper(uri);";
	...
	protected final String TEXT_18 = " options) throws IOException"
			+ NL
			+ "\t{"
			+ NL
			...
			+ NL + "\t\t\t\t  (";
	protected final String TEXT_19 = ")options.get(XMLResource.OPTION_PARSER_FEATURES), "
			+ NL + "\t\t\t\t  (";
	protected final String TEXT_20 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), "
			+ NL
	...
	protected final String TEXT_23 = " options) throws IOException"
			+ NL
			+ "\t{"
			+ NL
			+ "\t\tif (options != null && Boolean.TRUE.equals(options.get(OPTION_USE_DATA_CONVERTER)))"
			...
			+ "\t\t\t\t  (";
	protected final String TEXT_24 = ")options.get(XMLResource.OPTION_PARSER_FEATURES), "
			+ NL + "\t\t\t\t  (";
	...
	protected final String TEXT_27 = " properties, boolean useLexicalHandler) throws IOException"
			+ NL + "\t{" + NL + "\t\t";
	...
	protected final String TEXT_29 = "();"
			...
			+ NL + "\t\tif (features != null)" + NL + "\t\t{" + NL
			+ "\t\t\trequiredFeatures.putAll(features);" + NL + "\t\t}" + NL
			+ "\t\t" + NL + "\t\tif (properties == null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_46 = " previous, Attributes attributes)" + NL
			+ "\t\t{" + NL + "\t\t\t ";
	...
	protected final String TEXT_53 = ".pushOnto(previous);" + NL
			+ "\t\t\t result";
	protected final String TEXT_54 = ".handleAttributes(attributes);" + NL
			+ "\t\t\t return result";
	...
	protected final String TEXT_66 = "Value;" + NL + "\t\t}" + NL + "" + NL
			+ "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
	...
	protected final String TEXT_109 = ".equals(namespace))" + NL + "\t\t\t\t{"
			+ NL + "\t\t\t\t\treturn ";
	...
	protected final String TEXT_138 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{"
	...
	protected final String TEXT_141 = NL + "\t\t\tpublic void create()" + NL
			+ "\t\t\t{" + NL + "\t\t\t\tthe";
	...
	protected final String TEXT_151 = "Value;" + NL + "\t\t\t}" + NL + "\t\t"
			+ NL + "\t\t}" + NL;
	...
	protected final String TEXT_155 = " previous, Attributes attributes)" + NL
			+ "\t\t{" + NL + "\t\t\t ";
	...
	protected final String TEXT_162 = ".pushOnto(previous);" + NL
			+ "\t\t\t result";
	protected final String TEXT_163 = ".handleAttributes(attributes);" + NL
			+ "\t\t\t return result";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genPackage.isDataTypeConverters()
			...
			final String _MapStringBoolean = genModel.useGenerics() ? "Map<String, Boolean>"
					: "Map";
			final String _MapStringWildcard = genModel.useGenerics() ? "Map<String, ?>"
					: "Map";
			if (!isXMLTypePackage) {
			...
			for (GenClass genClass : genPackage.getGenClasses()) {
				...
				for (GenFeature genFeature : genClass.getAllGenFeatures()) {
					String name = extendedMetaData.getName(genFeature
							.getEcoreFeature());
					if ((elements.contains(genFeature.getEcoreFeature()) || attributes
				...
				for (GenFeature genFeature : genClass.getAllGenFeatures()) {
					String name = extendedMetaData.getName(genFeature
							.getEcoreFeature());
					if (attributes.contains(genFeature.getEcoreFeature())
							&& !genFeature.isDerived()
							&& name.indexOf(":") == -1) {
						String namespace = Literals.toStringLiteral(
								extendedMetaData.getNamespace(genFeature
