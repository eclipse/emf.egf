...
public class TestCase extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_6 = NL + " * <p>" + NL
			+ " * The following features are tested:" + NL + " * <ul>";
	...
	protected final String TEXT_12 = NL + " * <p>" + NL
			+ " * The following operations are tested:" + NL + " * <ul>";
	...
	protected final String TEXT_19 = NL + " * @generated" + NL + " */" + NL
			+ "public";
	...
	protected final String TEXT_31 = " test case." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	...
	protected final String TEXT_33 = NL + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic static void main(String[] args)" + NL
			+ "\t{" + NL + "\t\t";
	protected final String TEXT_34 = ".run(";
	protected final String TEXT_35 = ".class);" + NL + "\t}";
	protected final String TEXT_36 = NL + NL + "\t/**" + NL
			+ "\t * Constructs a new ";
	protected final String TEXT_37 = " test case with the given name." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_38 = "(String name)" + NL + "\t{" + NL
			+ "\t\tsuper(name);" + NL + "\t}";
	protected final String TEXT_39 = NL + NL + "\t/**" + NL
			+ "\t * Sets the fixture for this ";
	protected final String TEXT_40 = " test case." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected void setFixture(";
	protected final String TEXT_41 = " fixture)" + NL + "\t{" + NL
			+ "\t\tthis.fixture = fixture;" + NL + "\t}";
	protected final String TEXT_42 = NL + NL + "\t/**" + NL
			+ "\t * Returns the fixture for this ";
	protected final String TEXT_43 = " test case." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_65 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
			+ "\t * @see junit.framework.TestCase#tearDown()" + NL
			+ "\t * @generated" + NL + "\t */";
	protected final String TEXT_66 = NL + "\t@Override";
	protected final String TEXT_67 = NL
			+ "\tprotected void tearDown() throws Exception" + NL + "\t{" + NL
			+ "\t\tsetFixture(null);" + NL + "\t}";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (!genClass.getImplementedGenOperations().isEmpty()) {
			...
			for (GenOperation genOperation : genClass
				...
				stringBuffer.append(genOperation.getGenClass()
						.getQualifiedInterfaceName());
		...
		stringBuffer.append(genClass.isModelRoot() ? genModel
				.getImportedName("junit.framework.TestCase") : genClass
		...
		if (!genClass.isAbstract()) {
			...
			stringBuffer.append(genModel
					.getImportedName("junit.textui.TestRunner"));
