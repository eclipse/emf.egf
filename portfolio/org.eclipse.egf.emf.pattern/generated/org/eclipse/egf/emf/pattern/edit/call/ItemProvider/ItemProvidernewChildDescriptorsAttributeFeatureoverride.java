...
public class ItemProvidernewChildDescriptorsAttributeFeatureoverride {
	...
	public static synchronized ItemProvidernewChildDescriptorsAttributeFeatureoverride create(
	...
	protected final String TEXT_1 = NL + NL + "\t\tnewChildDescriptors.add"
			+ NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
	...
	public void set_createDataType(
	...
	public void set_delegatedFeature(
			org.eclipse.emf.codegen.ecore.genmodel.GenFeature object) {
	...
	public void set_createClassifier(
	...
	public void set_childCreationData(
			org.eclipse.emf.codegen.ecore.genmodel.GenClass.ChildCreationData object) {
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (createFeature.isEnumBasedType()) {
			...
			stringBuffer.append(createDataType.getGenPackage()
					.getQualifiedEFactoryInstanceAccessor());
			stringBuffer.append(TEXT_8);
			stringBuffer
					.append(createDataType.getQualifiedClassifierAccessor());
