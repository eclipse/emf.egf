...
public class BuildProperties extends
		org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_5 = NL + "               plugin.xml,\\" + NL
			+ "               plugin.properties" + NL + "jars.compile.order = ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		String pluginClassesLocation = genModel.isRuntimeJar() ? genModel
				.getEditorPluginID() + ".jar" : ".";
