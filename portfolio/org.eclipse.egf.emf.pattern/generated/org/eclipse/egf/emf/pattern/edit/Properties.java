...
public class Properties extends org.eclipse.egf.emf.pattern.base.GenModelJava {
	...
	protected final String TEXT_7 = NL + "\t/**" + NL
			...
			+ "\t */" + NL + "\t@Key(\"_UI_CreateChild_text\")" + NL
			+ "\t@DefaultMessage(\"{0}\")" + NL
			+ "\tString createChildText(Object type);" + NL + "" + NL + "\t/**"
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Key(\"_UI_CreateChild_text2\")" + NL
			+ "\t@DefaultMessage(\"{1} ";
	...
	protected final String TEXT_15 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Key(\"_UI_Unknown_type\")" + NL
			+ "\t@DefaultMessage(\"Object\")" + NL + "\tString unknownType();"
			+ NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Key(\"_UI_Unknown_datatype\")" + NL
			+ "\t@DefaultMessage(\"Value\")" + NL
	...
	protected final String TEXT_18 = "_feature\")" + NL
			+ "\t@DefaultMessage(\"";
	...
	protected final String TEXT_24 = "_description\")" + NL
			+ "\t@DefaultMessage(\"";
	...
	protected final String TEXT_28 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Key(\"_UI_Unknown_feature\")" + NL
			+ "\t@DefaultMessage(\"Unspecified\")" + NL
	...
	protected final String TEXT_31 = "_literal\")" + NL
			+ "\t@DefaultMessage(\"";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		stringBuffer.append(genModel
				.getImportedName("com.google.gwt.i18n.client.Messages"));
