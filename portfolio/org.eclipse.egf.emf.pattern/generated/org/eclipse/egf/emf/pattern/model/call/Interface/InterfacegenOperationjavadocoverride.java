...
public class InterfacegenOperationjavadocoverride {
	...
	public static synchronized InterfacegenOperationjavadocoverride create(
	...
	protected final String TEXT_3 = NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genOperation.hasDocumentation()
				|| genOperation.hasParameterDocumentation()) {
			stringBuffer.append(TEXT_4);
			if (genOperation.hasDocumentation()) {
				stringBuffer.append(TEXT_5);
				stringBuffer.append(genOperation.getDocumentation(genModel
