...
public class FactoryClass extends
	...
	protected final String TEXT_163 = ", null, null))" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_166 = "exception == null) return result;" + NL
			+ "    " + NL + "\t\tthrow exception;";
	...
	protected final String TEXT_191 = ".get(initialValue);"
			+ NL
	...
	protected final String TEXT_231 = NL
			+ "\t\tif (initialValue == null) return null;" + NL + "\t\t";
	protected final String TEXT_232 = " result = null;" + NL
			+ "\t\tRuntimeException exception = null;";
	...
	protected final String TEXT_246 = ".INSTANCE.validate(eDataType, result, null, null))"
			+ NL
			+ "\t\t\t{"
			+ NL
			+ "\t\t\t\treturn result;"
	...
	protected final String TEXT_301 = NL + "\t\t\tresult.append(' ');" + NL
			+ "\t\t}" + NL
			+ "\t\treturn result.substring(0, result.length() - 1);";
	protected final String TEXT_302 = NL
			+ "\t\tif (instanceValue == null) return null;";
	protected final String TEXT_303 = NL + "\t\tif (";
	protected final String TEXT_304 = ".isInstance(instanceValue))" + NL
			+ "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{";
	...
	protected final String TEXT_374 = ")instanceValue;" + NL
	...
	protected final String TEXT_390 = NL + "\t\t\tresult.append(' ');" + NL
			+ "\t\t}" + NL
			+ "\t\treturn result.substring(0, result.length() - 1);";
	...
	protected final String TEXT_401 = ".isInstance(instanceValue))" + NL
			+ "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{";
	...
	protected final String TEXT_416 = "</em>'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
			+ "\t * @return a new object of class '<em>";
	protected final String TEXT_417 = "</em>'." + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t";
	...
	protected final String TEXT_421 = "</em>' corresponding the given literal."
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_423 = "(String literal);"
			+ NL
			+ ""
			+ NL
			+ "\t/**"
	...
	protected final String TEXT_424 = "</em>'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_433 = ")getEPackage();" + NL + "\t}" + NL + ""
	...
	protected final String TEXT_436 = " getPackage()" + NL + "\t{" + NL
			+ "\t\treturn ";
