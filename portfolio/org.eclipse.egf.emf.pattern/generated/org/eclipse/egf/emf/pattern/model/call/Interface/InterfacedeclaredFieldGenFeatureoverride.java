...
public class InterfacedeclaredFieldGenFeatureoverride {
	...
	public static synchronized InterfacedeclaredFieldGenFeatureoverride create(
	...
	protected final String TEXT_2 = NL + "\t/**" + NL
			+ "\t * The cached setting delegate for the '{@link #";
	protected final String TEXT_3 = "() <em>";
	protected final String TEXT_4 = "</em>}' ";
	protected final String TEXT_5 = "." + NL + "\t * <!-- begin-user-doc -->"
	...
	protected final String TEXT_16 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_22 = NL + "\t/**" + NL
			+ "\t * The empty value for the '{@link #";
	protected final String TEXT_23 = "() <em>";
	protected final String TEXT_24 = "</em>}' array accessor." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_35 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	protected final String TEXT_36 = "()" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */";
	...
	protected final String TEXT_52 = "." + NL + "\t * <!-- begin-user-doc -->"
	...
	protected final String TEXT_57 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL
			+ "\tprotected static final int ";
	...
	protected final String TEXT_63 = "_EFLAG_OFFSET;" + NL + "" + NL + "\t/**"
			+ NL + "\t * The array of enumeration values for '{@link ";
	protected final String TEXT_64 = " ";
	protected final String TEXT_65 = "}'" + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\tprivate static final ";
	...
	protected final String TEXT_79 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_88 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
	...
	protected final String TEXT_99 = NL + "\t/**" + NL
			+ "\t * The flag representing whether the ";
	protected final String TEXT_100 = " ";
	protected final String TEXT_101 = " has been set." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL
			+ "\tprotected static final int ";
	...
	protected final String TEXT_106 = " has been set." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genFeature.hasSettingDelegate()) {
			...
			if (genModel.isArrayAccessors() && genFeature.isListType()
			...
			if (genFeature.hasEDefault()
					&& (!genFeature.isVolatile() || !genModel
							.isReflectiveDelegation()
							&& (!genFeature.hasDelegateFeature() || !genFeature
									.isUnsettable()))) {
				...
				if ("".equals(staticDefaultValue)) {
					...
					stringBuffer.append(genFeature.getEcoreFeature()
			...
			if (genClass.isField(genFeature)) {
				if (genClass.isFlag(genFeature)) {
					...
					stringBuffer
							.append(genClass.getFlagSize(genFeature) > 1 ? "s"
									: "");
