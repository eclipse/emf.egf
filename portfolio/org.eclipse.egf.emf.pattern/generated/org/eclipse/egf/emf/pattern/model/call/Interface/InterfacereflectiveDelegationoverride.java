...
public class InterfacereflectiveDelegationoverride {
	...
	public static synchronized InterfacereflectiveDelegationoverride create(
	...
	protected final String TEXT_4 = NL
			+ "\tprotected int eStaticFeatureCount()" + NL + "\t{" + NL
			+ "\t\treturn ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (isImplementation
				&& (genModel.getFeatureDelegation() == GenDelegationKind.REFLECTIVE_LITERAL || genModel
						.isDynamicDelegation())
				&& (genClass.getClassExtendsGenClass() == null || (genClass
						.getClassExtendsGenClass().getGenModel()
			...
			stringBuffer.append(genClass.getClassExtendsGenClass() == null ? 0
					: genClass.getClassExtendsGenClass().getAllGenFeatures()
							.size());
