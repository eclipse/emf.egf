...
return parameters; }
    ...
    final Map<String, Object> parameters__2jofsGKMEd_wNQtGaQlw = new HashMap<String, Object>();
parameters__2jofsGKMEd_wNQtGaQlw.put("genOperation", genOperation);
parameters__2jofsGKMEd_wNQtGaQlw.put("genClass", genClass);
parameters__2jofsGKMEd_wNQtGaQlw.put("genPackage", genPackage);
parameters__2jofsGKMEd_wNQtGaQlw.put("genModel", genModel);
parameters__2jofsGKMEd_wNQtGaQlw.put("isJDK50", isJDK50);
parameters__2jofsGKMEd_wNQtGaQlw.put("isInterface", isInterface);
parameters__2jofsGKMEd_wNQtGaQlw.put("isImplementation", isImplementation);
parameters__2jofsGKMEd_wNQtGaQlw.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__2jofsGKMEd_wNQtGaQlw.put("singleWildcard", singleWildcard);
parameters__2jofsGKMEd_wNQtGaQlw.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__2jofsGKMEd_wNQtGaQlw.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_02kCQGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__2jofsGKMEd_wNQtGaQlw);
