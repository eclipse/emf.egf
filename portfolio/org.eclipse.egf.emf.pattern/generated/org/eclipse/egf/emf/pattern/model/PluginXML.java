...
public class PluginXML extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_20 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.generated_package\">" + NL + "      <package"
			+ NL + "            uri=\"";
	...
	protected final String TEXT_28 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.content_parser\">" + NL + "      <parser" + NL
	...
	protected final String TEXT_34 = "_content_type\"" + NL + "            priority=\"normal\">" + NL
	...
	protected final String TEXT_39 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.extension_parser\">" + NL + "      <parser"
			+ NL + "            type=\"";
