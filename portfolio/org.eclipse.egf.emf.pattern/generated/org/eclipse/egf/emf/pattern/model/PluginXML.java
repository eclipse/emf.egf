...
public class PluginXML extends org.eclipse.egf.emf.pattern.base.GenModelText {
	...
	protected final String TEXT_15 = NL + "   </requires>" + NL + "" + NL
			+ "   <runtime>";
	...
	protected final String TEXT_19 = NL + "         <export name=\"*\"/>" + NL
			+ "      </library>" + NL + "   </runtime>";
	...
	protected final String TEXT_34 = "_content_type\""
			+ NL
			+ "            priority=\"normal\">"
			+ NL
	...
	protected final String TEXT_38 = NL + "         </describer>" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genModel.isBundleManifest()) {
			...
			if (genModel.hasModelPluginClass()) {
				...
				stringBuffer
						.append(genModel.getQualifiedModelPluginClassName());
	...
	public boolean preCondition() throws Exception {
		...
		canGenerate = canGenerate
				...
				&& (genModel.hasPluginSupport()
						&& !genModel.sameModelEditProject() && !genModel
