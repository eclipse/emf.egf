...
public class PackageClass extends
	...
	protected final String TEXT_7 = NL + NL + "/**" + NL
			...
			+ " * It contains accessors for the meta objects to represent" + NL
			+ " * <ul>" + NL + " *   <li>each class,</li>" + NL
			+ " *   <li>each feature of each class,</li>";
	protected final String TEXT_8 = NL
			+ " *   <li>each operation of each class,</li>";
	protected final String TEXT_9 = NL + " *   <li>each enum,</li>" + NL
			+ " *   <li>and each data type</li>" + NL + " * </ul>" + NL
			+ " * <!-- end-user-doc -->";
	...
	protected final String TEXT_17 = NL + NL + "/**" + NL
			+ " * <!-- begin-user-doc -->" + NL
			+ " * An implementation of the model <b>Package</b>." + NL
	...
	protected final String TEXT_37 = NL + NL + "\t/**" + NL
			+ "\t * The package content type ID." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t";
	...
	protected final String TEXT_40 = NL + NL + "\t/**" + NL
			+ "\t * The singleton instance of the package." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t";
	...
	protected final String TEXT_64 = "." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_69 = "</em>' class." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_74 = "</em>' operation." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_79 = "</em>' class." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t * @ordered" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_83 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected String packageFilename = \"";
	...
	protected final String TEXT_89 = NL
			...
			+ NL + "\t * if one already exists." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
			+ "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL
			+ "\t * @see ";
	protected final String TEXT_90 = "#eNS_URI" + NL + "\t * @see #init()" + NL
	...
	protected final String TEXT_93 = "#eINSTANCE} when that field is accessed."
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
	protected final String TEXT_94 = NL + "\t * @see #createPackageContents()"
			+ NL + "\t * @see #initializePackageContents()";
	protected final String TEXT_95 = NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tpublic static ";
	protected final String TEXT_96 = " init()" + NL + "\t{" + NL
			+ "\t\tif (isInited) return (";
	protected final String TEXT_97 = ")";
	protected final String TEXT_98 = ".Registry.INSTANCE.getEPackage(";
	protected final String TEXT_99 = ".eNS_URI);" + NL;
	protected final String TEXT_100 = NL + "\t\tinitializeRegistryHelpers();"
			+ NL;
	protected final String TEXT_101 = NL
			+ "\t\t// Obtain or create and register package" + NL + "\t\t";
	...
	protected final String TEXT_148 = NL + "\t\t// Register package validator"
			+ NL + "\t\t";
	protected final String TEXT_149 = ".Registry.INSTANCE.put" + NL
			+ "\t\t\t(the";
	protected final String TEXT_150 = ", " + NL + "\t\t\t new ";
	protected final String TEXT_151 = ".Descriptor()" + NL + "\t\t\t {" + NL
			+ "\t\t\t\t public ";
	protected final String TEXT_152 = " getEValidator()" + NL + "\t\t\t\t {"
			+ NL + "\t\t\t\t\t return ";
	protected final String TEXT_153 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL
			+ "\t\t\t });" + NL;
	protected final String TEXT_154 = NL
			+ "\t\t// Mark meta-data to indicate it can't be changed" + NL
			+ "\t\tthe";
	protected final String TEXT_155 = ".freeze();" + NL;
	protected final String TEXT_156 = NL + "  " + NL
			+ "\t\t// Update the registry and return the package" + NL + "\t\t";
	...
	protected final String TEXT_161 = NL + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic static void initializeRegistryHelpers()"
			+ NL + "\t{";
	...
	protected final String TEXT_165 = ".Helper() " + NL + "\t\t\t {" + NL
			+ "\t\t\t\t public boolean isInstance(Object instance)" + NL
			+ "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
	...
	protected final String TEXT_193 = "</em>}'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_200 = "</em>}'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_207 = NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_234 = "</em>}'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_262 = "</em>}' operation." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_292 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic void createPackageContents()" + NL
			+ "\t{" + NL + "\t\tif (isCreated) return;" + NL
			+ "\t\tisCreated = true;";
	...
	protected final String TEXT_314 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
	protected final String TEXT_315 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic void initializePackageContents()" + NL
			+ "\t{" + NL + "\t\tif (isInitialized) return;" + NL
			+ "\t\tisInitialized = true;" + NL + "" + NL
			+ "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL
	...
	protected final String TEXT_563 = NL + NL + "\t\t// Create resource" + NL
	...
	protected final String TEXT_570 = "</b>." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected void create";
	protected final String TEXT_571 = "Annotations()" + NL + "\t{" + NL
			+ "\t\tString source = ";
	...
	protected final String TEXT_576 = "\t" + NL + "\t\taddAnnotation" + NL
			+ "\t\t  (";
	protected final String TEXT_577 = ", " + NL + "\t\t   source, " + NL
			+ "\t\t   new String[] " + NL + "\t\t   {";
	...
	protected final String TEXT_614 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL
			+ "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL
			+ "" + NL + "\t\t";
	protected final String TEXT_615 = " url = getClass().getResource(packageFilename);"
			+ NL
			+ "\t\tif (url == null)"
			+ NL
			+ "\t\t{"
	...
	protected final String TEXT_620 = "().createResource(uri);" + NL
			+ "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL
			+ "\t\t}" + NL + "\t\tcatch (";
	protected final String TEXT_621 = " exception)" + NL + "\t\t{" + NL
			+ "\t\t\tthrow new ";
	protected final String TEXT_622 = "(exception);" + NL + "\t\t}" + NL
			+ "\t\tinitializeFromLoadedEPackage(this, (";
	protected final String TEXT_623 = ")resource.getContents().get(0));" + NL
			+ "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
	protected final String TEXT_624 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{"
			+ NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL
			+ "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**"
			+ NL + "\t * Sets the instance class on the given classifier." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_625 = NL + "\t@Override";
	protected final String TEXT_626 = NL + "\tprotected void fixInstanceClass(";
	protected final String TEXT_627 = " eClassifier)" + NL + "\t{" + NL
	...
	protected final String TEXT_631 = NL
			+ "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
	...
	protected final String TEXT_636 = NL
			+ "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL
			+ "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
	...
	protected final String TEXT_641 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)"
			+ NL + "\t{" + NL + "\t\t";
	protected final String TEXT_642 = " o = addEOperation(owner, type, name, lowerBound, upperBound);"
			+ NL
	...
	protected final String TEXT_646 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)"
			+ NL + "\t{" + NL + "\t\t";
	protected final String TEXT_647 = " p = ecoreFactory.createEParameter();"
			+ NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL
			+ "\t\tp.setLowerBound(lowerBound);" + NL
			+ "\t\tp.setUpperBound(upperBound);" + NL
			+ "\t\tp.setUnique(isUnique);" + NL
			+ "\t\tp.setOrdered(isOrdered);" + NL
			+ "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL
			+ "\t}" + NL + "\t";
	protected final String TEXT_648 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * Defines literals for the meta objects that represent" + NL
			+ "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL
			+ "\t *   <li>each feature of each class,</li>";
	protected final String TEXT_649 = NL
			+ "\t *   <li>each operation of each class,</li>";
	protected final String TEXT_650 = NL + "\t *   <li>each enum,</li>" + NL
			+ "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t";
	...
	protected final String TEXT_674 = " feature." + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\t";
	...
	protected final String TEXT_678 = NL + "\t\t/**" + NL
			+ "\t\t * The meta object literal for the '<em><b>";
	protected final String TEXT_679 = "</b></em>' operation." + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\t";
	...
	protected void method_setArgument(final StringBuffer stringBuffer,
		...
		argument = ((Object[]) new Object[] { new Object[] {
				...
				genPackage.getGenModel().isSuppressEMFMetaData()
						|| genPackage.getGenModel().isSuppressInterfaces() ? Boolean.TRUE
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (isImplementation) {
			...
			if (genPackage.isLiteralsInterface()) {
				genModel.addPseudoImport(genPackage
						.getQualifiedPackageInterfaceName() + ".Literals");
			}
			for (GenClassifier genClassifier : genPackage
		...
		if (isInterface) {
			...
			if (genPackage.hasDocumentation()) {
				...
				stringBuffer.append(genPackage.getDocumentation(genModel
		...
		if (isImplementation) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.impl.EPackageImpl"));
			if (!isInterface) {
		...
		if (isInterface) {
			...
			if (genPackage.isContentType()) {
				...
				stringBuffer.append(publicStaticFinalFlag);
				stringBuffer.append(genModel
						.getImportedName("java.lang.String"));
					...
					if (genModel.isOperationReflection()) {
						for (GenOperation genOperation : genClass
							...
							if (genClass.getOverrideGenOperation(genOperation) == null) {
								...
								stringBuffer.append(genClass.getOperationID(
										genOperation, false));
								stringBuffer.append(TEXT_76);
								stringBuffer.append(genClass
										.getOperationValue(genOperation));
		...
		if (isImplementation) {
			...
			if (genPackage.isLoadedInitialization()
					|| !genPackage.getPackageLoadInterDependencies().isEmpty()) {
			...
			if (!genPackage.isLoadedInitialization()
					|| !genPackage.getPackageBuildInterDependencies().isEmpty()) {
			...
			if (genPackage.hasConstraints()) {
				...
				stringBuffer.append(genModel
						.getImportedName("org.eclipse.emf.ecore.EValidator"));
			...
			if (genModel.getRuntimePlatform() == GenRuntimePlatform.GWT) {
				...
				for (GenClassifier genClassifier : genPackage
					...
					if (genClassifier instanceof GenClass) {
						...
						if (!genClass.isDynamic()) {
							...
							stringBuffer
									.append(genClass.isMapEntry() ? genClass
											.getImportedClassName() : genClass
						...
						if (!genDataType.isPrimitiveType()
							...
							if (genDataType.isArrayType()) {
								String componentType = genDataType
										.getRawImportedInstanceClassName();
								String indices = "";
								while (componentType.endsWith("[]")) {
									componentType = componentType.substring(0,
											componentType.length() - 2);
									indices += "[]";
								}
				...
				stringBuffer
						.append(genModel
								.getImportedName("com.google.gwt.user.client.rpc.IsSerializable"));
		...
		for (GenClassifier genClassifier : genPackage.getGenClassifiers()) {
			...
			if (isImplementation) {
				...
				if (genPackage.isLoadedInitialization()) {
					...
					stringBuffer.append(genPackage
							.getLocalClassifierIndex(genClassifier));
			...
			if (genClassifier instanceof GenClass) {
				...
				for (GenFeature genFeature : genClass.getGenFeatures()) {
					...
					if (isImplementation) {
						...
						stringBuffer
								.append(genFeature.getFeatureAccessorName());
						...
						if (!genPackage.isLoadedInitialization()) {
							...
							stringBuffer.append(genClass
									.getLocalFeatureIndex(genFeature));
				...
				if (genModel.isOperationReflection()) {
					for (GenOperation genOperation : genClass
						...
						if (isInterface) {
							...
							stringBuffer
									.append(genOperation.getFormattedName());
						...
						if (isImplementation) {
							...
							if (!genPackage.isLoadedInitialization()) {
								...
								stringBuffer.append(genClass
										.getLocalOperationIndex(genOperation));
		...
		if (isImplementation) {
			if (!genPackage.isLoadedInitialization()) {
				...
				if (!genPackage.getGenClasses().isEmpty()) {
					...
					for (Iterator<GenClass> c = genPackage.getGenClasses()
							.iterator(); c.hasNext();) {
				...
				if (!genPackage.getGenEnums().isEmpty()) {
					...
					for (GenEnum genEnum : genPackage.getGenEnums()) {
						...
						stringBuffer
								.append(genEnum.getClassifierInstanceName());
				...
				class InformationIterator {
					...
					InformationIterator(EGenericType eGenericType) {
						iterator = EcoreUtil.getAllContents(Collections
								.singleton(eGenericType));
					}
					...
					Information next() {
						...
						EGenericType eGenericType = information.eGenericType = (EGenericType) iterator
								.next();
						...
						if (eGenericType.getEClassifier() != null) {
							GenClassifier genClassifier = genModel
									.findGenClassifier(eGenericType
											.getEClassifier());
							information.type = genPackage
									.getPackageInstanceVariable(genClassifier
											.getGenPackage())
									+ ".get"
							...
							if (eTypeParameter.eContainer() instanceof EClass) {
								information.type = genModel.findGenClassifier(
										(EClass) eTypeParameter.eContainer())
										.getClassifierInstanceName()
										+ "_"
								...
								information.type = "t"
										+ (((EOperation) eTypeParameter
												.eContainer())
												.getETypeParameters().indexOf(
														eTypeParameter) + 1);
							}
						} else {
							information.type = "";
						...
						if (information.depth > 0) {
							if (eGenericType.eContainmentFeature().isMany()) {
								information.accessor = "getE"
										+ eGenericType.eContainmentFeature()
												.getName().substring(1)
										+ "().add";
							} else {
				...
				if (!genPackage.getPackageInitializationDependencies()
						.isEmpty()) {
					stringBuffer.append(TEXT_316);
					for (GenPackage dep : genPackage
						...
						stringBuffer.append(genPackage
								.getPackageInstanceVariable(dep));
				...
				if (!genPackage.getSubGenPackages().isEmpty()) {
					...
					for (GenPackage sub : genPackage.getSubGenPackages()) {
						...
						stringBuffer.append(genPackage
								.getPackageInstanceVariable(sub));
				...
				if (!genPackage.getGenClasses().isEmpty()) {
					...
					if (genModel.useGenerics()) {
						...
						for (GenClassifier genClassifier : genPackage
								.getGenClassifiers()) {
							for (GenTypeParameter genTypeParameter : genClassifier
								...
								if (!genTypeParameter.getEcoreTypeParameter()
									...
									stringBuffer.append(genTypeParameter
											.getName());
					...
					if (genModel.useGenerics()) {
						...
						for (GenClassifier genClassifier : genPackage
							...
							for (GenTypeParameter genTypeParameter : genClassifier
									.getGenTypeParameters()) {
								for (EGenericType bound : genTypeParameter
										.getEcoreTypeParameter().getEBounds()) {
					...
					for (GenClass genClass : genPackage.getGenClasses()) {
						if (!genClass.hasGenericSuperTypes()) {
							for (GenClass baseGenClass : genClass
									.getBaseGenClasses()) {
								...
								stringBuffer
										.append(genPackage
												.getPackageInstanceVariable(baseGenClass
														.getGenPackage()));
								stringBuffer.append(TEXT_351);
								stringBuffer.append(baseGenClass
										.getClassifierAccessorName());
								stringBuffer.append(TEXT_352);
							}
						} else {
							for (EGenericType superType : genClass
									.getEcoreClass().getEGenericSuperTypes()) {
								for (InformationIterator i = new InformationIterator(
										superType); i.hasNext();) {
									Information info = i.next();
									String prefix = "";
					...
					for (Iterator<GenClass> c = genPackage.getGenClasses()
						...
						if (hasInstanceTypeName) {
							...
							stringBuffer.append(genClass.getEcoreClass()
									.getInstanceTypeName());
						...
						for (GenFeature genFeature : genClass.getGenFeatures()) {
							...
							if (genFeature.isReferenceType()) {
								GenFeature reverseGenFeature = genFeature
										.getReverse();
								String reverse = reverseGenFeature == null ? "null"
										: genPackage
												.getPackageInstanceVariable(reverseGenFeature
														.getGenPackage())
												+ ".get"
												+ reverseGenFeature
								...
								if (genFeature.hasGenericType()) {
									...
									stringBuffer
											.append(genPackage
													.getPackageInstanceVariable(genFeature
															.getTypeGenPackage()));
								...
								stringBuffer
										.append(genFeature.getDerivedFlag());
								stringBuffer.append(TEXT_404);
								stringBuffer
										.append(genFeature.getOrderedFlag());
								stringBuffer.append(TEXT_405);
								stringBuffer.append(genModel.getNonNLS());
								stringBuffer.append(genModel.getNonNLS(
										genFeature.getDefaultValue(), 2));
								for (GenFeature keyFeature : genFeature
										.getKeys()) {
									...
									stringBuffer
											.append(genPackage
													.getPackageInstanceVariable(keyFeature
															.getGenPackage()));
									stringBuffer.append(TEXT_408);
									stringBuffer.append(keyFeature
											.getFeatureAccessorName());
						...
						for (GenOperation genOperation : genClass
							...
							if (genModel.useGenerics()) {
								...
								if (genOperation.isVoid()
										|| genOperation.hasGenericType()) {
									stringBuffer.append(TEXT_435);
								} else {
									stringBuffer
											.append(genPackage
													.getPackageInstanceVariable(genOperation
															.getTypeGenPackage()));
								...
								if (!genOperation.getEcoreOperation()
										.isOrdered()
							...
							if (genModel.useGenerics()) {
								for (ListIterator<GenTypeParameter> t = genOperation
										.getGenTypeParameters().listIterator(); t
										.hasNext();) {
									GenTypeParameter genTypeParameter = t
											.next();
									String typeParameterVariable = "";
									if (!genTypeParameter
											.getEcoreTypeParameter()
											.getEBounds().isEmpty()
											|| genTypeParameter.isUsed()) {
										if (maxTypeParameterAssignment <= t
												.previousIndex()) {
									...
									stringBuffer.append(genModel.getNonNLS());
									for (EGenericType typeParameter : genTypeParameter
											.getEcoreTypeParameter()
											.getEBounds()) {
										for (InformationIterator i = new InformationIterator(
												typeParameter); i.hasNext();) {
											Information info = i.next();
											String typePrefix = "";
											if (maxGenericTypeAssignment <= info.depth) {
												++maxGenericTypeAssignment;
							...
							for (GenParameter genParameter : genOperation
								...
								if (genModel.useGenerics()) {
									...
									if (genParameter.hasGenericType()) {
										...
										stringBuffer
												.append(genPackage
														.getPackageInstanceVariable(genParameter
																.getTypeGenPackage()));
									...
									stringBuffer.append(genModel.getNonNLS());
								} else if (!genParameter.getEcoreParameter()
										.isOrdered()
										|| !genParameter.getEcoreParameter()
												.isUnique()) {
							...
							if (genOperation.hasGenericExceptions()) {
								for (EGenericType genericExceptions : genOperation
										.getEcoreOperation()
										.getEGenericExceptions()) {
									for (InformationIterator i = new InformationIterator(
											genericExceptions); i.hasNext();) {
										Information info = i.next();
										String typePrefix = "";
										if (maxGenericTypeAssignment <= info.depth) {
											++maxGenericTypeAssignment;
								...
								for (GenClassifier genException : genOperation
										.getGenExceptions()) {
									stringBuffer.append(TEXT_531);
									stringBuffer
											.append(genPackage
													.getPackageInstanceVariable(genException
															.getGenPackage()));
									stringBuffer.append(TEXT_532);
									stringBuffer.append(genException
											.getClassifierAccessorName());
				...
				if (!genPackage.getGenEnums().isEmpty()) {
					...
					for (Iterator<GenEnum> e = genPackage.getGenEnums()
							.iterator(); e.hasNext();) {
						...
						stringBuffer.append(genModel.getNonNLS());
						for (GenEnumLiteral genEnumLiteral : genEnum
								.getGenEnumLiterals()) {
							stringBuffer.append(TEXT_549);
							stringBuffer.append(genEnum
									.getClassifierInstanceName());
							stringBuffer.append(TEXT_550);
							stringBuffer
									.append(genEnum.getImportedName().equals(
											genEnum.getClassifierID()) ? genEnum
											.getQualifiedName() : genEnum
											.getImportedName());
							stringBuffer.append(TEXT_551);
							stringBuffer.append(genEnumLiteral
				...
				if (!genPackage.getGenDataTypes().isEmpty()) {
					...
					for (GenDataType genDataType : genPackage.getGenDataTypes()) {
						...
						if (hasInstanceTypeName) {
							...
							stringBuffer.append(genDataType.getEcoreDataType()
									.getInstanceTypeName());
				...
				if (!genPackage.isEcorePackage()
						&& !genPackage.getAnnotationSources().isEmpty()) {
					stringBuffer.append(TEXT_564);
					for (String annotationSource : genPackage
				...
				for (String annotationSource : genPackage
					...
					for (EAnnotation eAnnotation : genPackage
							.getAllAnnotations()) {
						...
						if (annotationSource == null ? eAnnotation.getSource() == null
								: annotationSource.equals(eAnnotation
										.getSource())) {
							stringBuffer.append(TEXT_576);
							stringBuffer
									.append(genPackage
											.getAnnotatedModelElementAccessor(eAnnotation));
							stringBuffer.append(TEXT_577);
							for (Iterator<Map.Entry<String, String>> k = eAnnotation
									.getDetails().iterator(); k.hasNext();) {
								Map.Entry<String, String> detail = k.next();
								String key = Literals.toStringLiteral(
										detail.getKey(), genModel);
								String value = Literals.toStringLiteral(
										detail.getValue(), genModel);
								stringBuffer.append(TEXT_578);
								stringBuffer.append(key);
								stringBuffer.append(TEXT_579);
								stringBuffer.append(value);
								stringBuffer.append(k.hasNext() ? "," : "");
								stringBuffer.append(genModel.getNonNLS(key
										+ value));
							}
							...
							if (!annotationReferenceDataList.isEmpty()) {
								...
								stringBuffer
										.append(genModel
												.getImportedName("org.eclipse.emf.common.util.URI"));
								stringBuffer.append(TEXT_584);
								for (Iterator<GenPackage.AnnotationReferenceData> k = annotationReferenceDataList
										.iterator(); k.hasNext();) {
									GenPackage.AnnotationReferenceData annotationReferenceData = k
											.next();
									...
									if (annotationReferenceData.containingGenPackage != genPackage) {
										stringBuffer
												.append(annotationReferenceData.containingGenPackage
														.getImportedPackageInterfaceName());
										stringBuffer.append(TEXT_587);
									}
									stringBuffer.append(TEXT_588);
									stringBuffer
											.append(annotationReferenceData.uriFragment);
						...
						for (EAnnotation nestedEAnnotation : genPackage
								.getAllNestedAnnotations(eAnnotation)) {
							String nestedAnnotationSource = nestedEAnnotation
									.getSource();
							int depth = 1;
							for (EObject eContainer = nestedEAnnotation
									.eContainer(); eContainer != eAnnotation; eContainer = eContainer
									.eContainer()) {
								++depth;
							}
							...
							for (Iterator<Map.Entry<String, String>> l = nestedEAnnotation
									.getDetails().iterator(); l.hasNext();) {
							...
							if (!nestedAnnotationReferenceDataList.isEmpty()) {
								...
								for (Iterator<GenPackage.AnnotationReferenceData> l = nestedAnnotationReferenceDataList
										.iterator(); l.hasNext();) {
									GenPackage.AnnotationReferenceData annotationReferenceData = l
											.next();
				...
				if (genPackage.isLoadingInitialization()) {
					...
					stringBuffer.append(genModel
							.getImportedName("java.io.IOException"));
					stringBuffer.append(TEXT_621);
					stringBuffer
							.append(genModel
									.getImportedName("org.eclipse.emf.common.util.WrappedException"));
			...
			if (needsAddEParameter) {
				...
				stringBuffer.append(genModel
						.getImportedName("org.eclipse.emf.ecore.EParameter"));
		...
		stringBuffer.append(isInterface ? genPackage.getPackageInterfaceName()
