...
public class PackageClass extends org.eclipse.egf.emf.pattern.base.GenPackageJava {
	...
	protected final String TEXT_7 = NL + NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * The <b>Package</b> for the model." + NL
			+ " * It contains accessors for the meta objects to represent" + NL + " * <ul>" + NL + " *   <li>each class,</li>" + NL
			+ " *   <li>each feature of each class,</li>" + NL + " *   <li>each enum,</li>" + NL + " *   <li>and each data type</li>" + NL
			+ " * </ul>" + NL + " * <!-- end-user-doc -->";
	...
	protected final String TEXT_15 = NL + NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL
			+ " * An implementation of the model <b>Package</b>." + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */";
	...
	protected final String TEXT_22 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_23 = " copyright = ";
	protected final String TEXT_24 = ";";
	protected final String TEXT_25 = NL;
	protected final String TEXT_26 = NL + "\t/**" + NL + "\t * The package name." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_27 = " eNAME = \"";
	protected final String TEXT_28 = "\";";
	protected final String TEXT_29 = NL + NL + "\t/**" + NL + "\t * The package namespace URI." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_30 = " eNS_URI = \"";
	protected final String TEXT_31 = "\";";
	protected final String TEXT_32 = NL + NL + "\t/**" + NL + "\t * The package namespace name." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_33 = " eNS_PREFIX = \"";
	protected final String TEXT_34 = "\";";
	protected final String TEXT_35 = NL + NL + "\t/**" + NL + "\t * The package content type ID." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_36 = " eCONTENT_TYPE = \"";
	protected final String TEXT_37 = "\";";
	protected final String TEXT_38 = NL + NL + "\t/**" + NL + "\t * The singleton instance of the package." + NL
	...
	protected final String TEXT_44 = "</em>}' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @see ";
	protected final String TEXT_45 = NL + "\t * The meta object id for the '{@link ";
	protected final String TEXT_46 = " <em>";
	protected final String TEXT_47 = "</em>}' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @see ";
	protected final String TEXT_48 = NL + "\t * The meta object id for the '{@link ";
	protected final String TEXT_49 = " <em>";
	protected final String TEXT_50 = "</em>}' enum." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @see ";
	...
	protected final String TEXT_62 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated"
			+ NL + "\t * @ordered" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_67 = "</em>' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\t";
	protected final String TEXT_68 = "int ";
	protected final String TEXT_69 = " = ";
	protected final String TEXT_70 = ";" + NL;
	protected final String TEXT_71 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprotected String packageFilename = \"";
	protected final String TEXT_72 = "\";";
	protected final String TEXT_73 = NL;
	protected final String TEXT_74 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprivate ";
	protected final String TEXT_75 = " ";
	protected final String TEXT_76 = " = null;" + NL;
	protected final String TEXT_77 = NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>, registered with" + NL
			+ "\t * {@link org.eclipse.emf.ecore.EPackage.Registry EPackage.Registry} by the package" + NL + "\t * package URI value." + NL
			+ "\t * <p>Note: the correct way to create the package is via the static" + NL
			+ "\t * factory method {@link #init init()}, which also performs" + NL
			+ "\t * initialization of the package, or returns the registered package," + NL + "\t * if one already exists." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry"
			+ NL + "\t * @see ";
	...
	protected final String TEXT_80 = ");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL
			+ "" + NL + "\t/**" + NL
			+ "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL
			+ "\t * " + NL + "\t * <p>This method is used to initialize {@link ";
	protected final String TEXT_81 = "#eINSTANCE} when that field is accessed." + NL
			+ "\t * Clients should not invoke it directly. Instead, they should simply access that field to obtain the package." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
	...
	protected final String TEXT_87 = ".eNS_URI);" + NL + "" + NL + "\t\t// Obtain or create and register package" + NL + "\t\t";
	protected final String TEXT_88 = " the";
	protected final String TEXT_89 = " = (";
	protected final String TEXT_90 = ")(";
	protected final String TEXT_91 = ".Registry.INSTANCE.get(eNS_URI) instanceof ";
	protected final String TEXT_92 = " ? ";
	protected final String TEXT_93 = ".Registry.INSTANCE.get(eNS_URI) : new ";
	...
	protected final String TEXT_105 = ".eNS_URI) instanceof ";
	protected final String TEXT_106 = " ? ";
	protected final String TEXT_107 = ".Registry.INSTANCE.getEPackage(";
	protected final String TEXT_108 = ".eNS_URI) : ";
	protected final String TEXT_109 = ".eINSTANCE);";
	protected final String TEXT_110 = NL;
	protected final String TEXT_111 = NL + "\t\t// Load packages";
	protected final String TEXT_112 = NL + "\t\tthe";
	protected final String TEXT_113 = ".loadPackage();";
	protected final String TEXT_114 = NL + "\t\t";
	protected final String TEXT_115 = ".loadPackage();";
	protected final String TEXT_116 = NL;
	protected final String TEXT_117 = NL + "\t\t// Create package meta-data objects";
	...
	protected final String TEXT_124 = ".initializePackageContents();";
	protected final String TEXT_125 = NL + "\t\t";
	protected final String TEXT_126 = ".initializePackageContents();";
	protected final String TEXT_127 = NL;
	protected final String TEXT_128 = NL + "\t\t// Fix loaded packages";
	protected final String TEXT_129 = NL + "\t\tthe";
	protected final String TEXT_130 = ".fixPackageContents();";
	protected final String TEXT_131 = NL + "\t\t";
	protected final String TEXT_132 = ".fixPackageContents();";
	protected final String TEXT_133 = NL;
	protected final String TEXT_134 = NL + "\t\t// Register package validator" + NL + "\t\t";
	protected final String TEXT_135 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
	protected final String TEXT_136 = ", " + NL + "\t\t\t new ";
	protected final String TEXT_137 = ".Descriptor()" + NL + "\t\t\t {" + NL + "\t\t\t\t public ";
	protected final String TEXT_138 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
	protected final String TEXT_139 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
	protected final String TEXT_140 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
	protected final String TEXT_141 = ".freeze();" + NL;
	protected final String TEXT_142 = NL + "  " + NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
	protected final String TEXT_143 = ".Registry.INSTANCE.put(";
	protected final String TEXT_144 = ".eNS_URI, the";
	protected final String TEXT_145 = ");" + NL + "\t\treturn the";
	protected final String TEXT_146 = ";" + NL + "\t}" + NL;
	protected final String TEXT_147 = NL;
	protected final String TEXT_148 = NL + "\t/**";
	protected final String TEXT_149 = NL + "\t * Returns the meta object for class '{@link ";
	protected final String TEXT_150 = " <em>";
	protected final String TEXT_151 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_156 = NL + "\t * Returns the meta object for enum '{@link ";
	protected final String TEXT_157 = " <em>";
	protected final String TEXT_158 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @return the meta object for enum '<em>";
	protected final String TEXT_159 = "</em>'." + NL + "\t * @see ";
	...
	protected final String TEXT_165 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @return the meta object for data type '<em>";
	protected final String TEXT_166 = "</em>'.";
	protected final String TEXT_167 = NL + "\t * @see ";
	protected final String TEXT_168 = NL + "\t * @model ";
	protected final String TEXT_169 = NL + "\t *        ";
	protected final String TEXT_170 = NL + "\t * @model";
	protected final String TEXT_171 = NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_172 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_180 = ".Registry.INSTANCE.getEPackage(";
	protected final String TEXT_181 = ".eNS_URI).getEClassifiers().get(";
	...
	protected final String TEXT_188 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
	protected final String TEXT_189 = " '{@link ";
	protected final String TEXT_190 = "#";
	protected final String TEXT_191 = " <em>";
	protected final String TEXT_192 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @return the meta object for the ";
	protected final String TEXT_193 = " '<em>";
	protected final String TEXT_194 = "</em>'." + NL + "\t * @see ";
	protected final String TEXT_195 = "#";
	protected final String TEXT_196 = "()";
	protected final String TEXT_197 = NL + "\t * @see #get";
	protected final String TEXT_198 = "()" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_199 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_216 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_217 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */";
	protected final String TEXT_218 = NL + "\tpublic ";
	protected final String TEXT_219 = " get";
	protected final String TEXT_220 = "()" + NL + "\t{" + NL + "\t\treturn (";
	protected final String TEXT_221 = ")getEFactoryInstance();" + NL + "\t}";
	protected final String TEXT_222 = NL + "\t";
	protected final String TEXT_223 = " get";
	protected final String TEXT_224 = "();";
	protected final String TEXT_225 = NL;
	protected final String TEXT_226 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL
			+ "\t * Creates the meta-model objects for the package.  This method is" + NL
			+ "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void createPackageContents()" + NL
			+ "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
	protected final String TEXT_227 = NL + NL + "\t\t// Create classes and their features";
	...
	protected final String TEXT_237 = NL + NL + "\t\t// Create enums";
	protected final String TEXT_238 = NL + "\t\t";
	protected final String TEXT_239 = " = createEEnum(";
	protected final String TEXT_240 = ");";
	protected final String TEXT_241 = NL + NL + "\t\t// Create data types";
	protected final String TEXT_242 = NL + "\t\t";
	protected final String TEXT_243 = " = createEDataType(";
	protected final String TEXT_244 = ");";
	protected final String TEXT_245 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
	protected final String TEXT_246 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL
			+ "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL
			+ "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package"
			+ NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
	protected final String TEXT_247 = NL + NL + "\t\t// Obtain other dependent packages";
	protected final String TEXT_248 = NL + "\t\t";
	protected final String TEXT_249 = " ";
	protected final String TEXT_250 = " = (";
	protected final String TEXT_251 = ")";
	protected final String TEXT_252 = ".Registry.INSTANCE.getEPackage(";
	protected final String TEXT_253 = ".eNS_URI);";
	protected final String TEXT_254 = NL + NL + "\t\t// Add subpackages";
	protected final String TEXT_255 = NL + "\t\tgetESubpackages().add(";
	protected final String TEXT_256 = ");";
	protected final String TEXT_257 = NL + NL + "\t\t// Create type parameters";
	protected final String TEXT_258 = NL + "\t\t";
	protected final String TEXT_259 = " ";
	protected final String TEXT_260 = "_";
	protected final String TEXT_261 = " = addETypeParameter(";
	protected final String TEXT_262 = ", \"";
	protected final String TEXT_263 = "\");";
	protected final String TEXT_264 = NL + "\t\taddETypeParameter(";
	protected final String TEXT_265 = ", \"";
	protected final String TEXT_266 = "\");";
	protected final String TEXT_267 = NL + NL + "\t\t// Set bounds for type parameters";
	protected final String TEXT_268 = NL + "\t\t";
	protected final String TEXT_269 = "g";
	protected final String TEXT_270 = " = createEGenericType(";
	protected final String TEXT_271 = ");";
	protected final String TEXT_272 = NL + "\t\tg";
	protected final String TEXT_273 = ".";
	protected final String TEXT_274 = "(g";
	protected final String TEXT_275 = ");";
	protected final String TEXT_276 = NL + "\t\t";
	protected final String TEXT_277 = "_";
	protected final String TEXT_278 = ".getEBounds().add(g1);";
	protected final String TEXT_279 = NL + NL + "\t\t// Add supertypes to classes";
	protected final String TEXT_280 = NL + "\t\t";
	protected final String TEXT_281 = ".getESuperTypes().add(";
	protected final String TEXT_282 = ".get";
	protected final String TEXT_283 = "());";
	protected final String TEXT_284 = NL + "\t\t";
	protected final String TEXT_285 = "g";
	protected final String TEXT_286 = " = createEGenericType(";
	protected final String TEXT_287 = ");";
	protected final String TEXT_288 = NL + "\t\tg";
	protected final String TEXT_289 = ".";
	protected final String TEXT_290 = "(g";
	protected final String TEXT_291 = ");";
	protected final String TEXT_292 = NL + "\t\t";
	protected final String TEXT_293 = ".getEGenericSuperTypes().add(g1);";
	protected final String TEXT_294 = NL + NL + "\t\t// Initialize classes and features; add operations and parameters";
	protected final String TEXT_295 = NL + "\t\tinitEClass(";
	protected final String TEXT_296 = ", ";
	protected final String TEXT_297 = "null";
	protected final String TEXT_298 = ".class";
	...
	protected final String TEXT_307 = "g";
	protected final String TEXT_308 = " = createEGenericType(";
	protected final String TEXT_309 = ");";
	protected final String TEXT_310 = NL + "\t\tg";
	protected final String TEXT_311 = ".";
	protected final String TEXT_312 = "(g";
	protected final String TEXT_313 = ");";
	protected final String TEXT_314 = NL + "\t\tinitEReference(get";
	protected final String TEXT_315 = "(), ";
	protected final String TEXT_316 = "g1";
	...
	protected final String TEXT_335 = NL + "\t\tget";
	protected final String TEXT_336 = "().getEKeys().add(";
	protected final String TEXT_337 = ".get";
	protected final String TEXT_338 = "());";
	protected final String TEXT_339 = NL + "\t\tinitEAttribute(get";
	protected final String TEXT_340 = "(), ";
	protected final String TEXT_341 = "g1";
	...
	protected final String TEXT_360 = "addEOperation(";
	...
	protected final String TEXT_372 = "addEOperation(";
	...
	protected final String TEXT_382 = "addEOperation(";
	...
	protected final String TEXT_390 = "addEOperation(";
	protected final String TEXT_391 = ", null, \"";
	protected final String TEXT_392 = "\");";
	protected final String TEXT_393 = NL + "\t\t";
	protected final String TEXT_394 = "addETypeParameter(op, \"";
	protected final String TEXT_395 = "\");";
	protected final String TEXT_396 = NL + "\t\t";
	protected final String TEXT_397 = "g";
	protected final String TEXT_398 = " = createEGenericType(";
	protected final String TEXT_399 = ");";
	protected final String TEXT_400 = NL + "\t\tg";
	protected final String TEXT_401 = ".";
	protected final String TEXT_402 = "(g";
	protected final String TEXT_403 = ");";
	protected final String TEXT_404 = NL + "\t\tt";
	protected final String TEXT_405 = ".getEBounds().add(g1);";
	protected final String TEXT_406 = NL + "\t\t";
	protected final String TEXT_407 = "g";
	protected final String TEXT_408 = " = createEGenericType(";
	protected final String TEXT_409 = ");";
	protected final String TEXT_410 = NL + "\t\tg";
	protected final String TEXT_411 = ".";
	protected final String TEXT_412 = "(g";
	protected final String TEXT_413 = ");";
	protected final String TEXT_414 = NL + "\t\taddEParameter(op, ";
	...
	protected final String TEXT_424 = NL + "\t\taddEParameter(op, ";
	...
	protected final String TEXT_434 = NL + "\t\taddEParameter(op, ";
	protected final String TEXT_435 = "g1";
	...
	protected final String TEXT_443 = "g";
	protected final String TEXT_444 = " = createEGenericType(";
	protected final String TEXT_445 = ");";
	protected final String TEXT_446 = NL + "\t\tg";
	protected final String TEXT_447 = ".";
	protected final String TEXT_448 = "(g";
	protected final String TEXT_449 = ");";
	protected final String TEXT_450 = NL + "\t\taddEException(op, g";
	protected final String TEXT_451 = ");";
	protected final String TEXT_452 = NL + "\t\taddEException(op, ";
	protected final String TEXT_453 = ".get";
	protected final String TEXT_454 = "());";
	protected final String TEXT_455 = NL + "\t\t";
	protected final String TEXT_456 = "g";
	protected final String TEXT_457 = " = createEGenericType(";
	protected final String TEXT_458 = ");";
	protected final String TEXT_459 = NL + "\t\tg";
	protected final String TEXT_460 = ".";
	protected final String TEXT_461 = "(g";
	protected final String TEXT_462 = ");";
	protected final String TEXT_463 = NL + "\t\tinitEOperation(op, g1);";
	protected final String TEXT_464 = NL;
	protected final String TEXT_465 = NL + NL + "\t\t// Initialize enums and add enum literals";
	protected final String TEXT_466 = NL + "\t\tinitEEnum(";
	protected final String TEXT_467 = ", ";
	protected final String TEXT_468 = ".class, \"";
	protected final String TEXT_469 = "\");";
	protected final String TEXT_470 = NL + "\t\taddEEnumLiteral(";
	protected final String TEXT_471 = ", ";
	protected final String TEXT_472 = ".";
	protected final String TEXT_473 = ");";
	protected final String TEXT_474 = NL;
	protected final String TEXT_475 = NL + NL + "\t\t// Initialize data types";
	protected final String TEXT_476 = NL + "\t\tinitEDataType(";
	protected final String TEXT_477 = ", ";
	protected final String TEXT_478 = ".class, \"";
	protected final String TEXT_479 = "\", ";
	protected final String TEXT_480 = ", ";
	protected final String TEXT_481 = ", \"";
	protected final String TEXT_482 = "\"";
	protected final String TEXT_483 = ");";
	protected final String TEXT_484 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(eNS_URI);";
	protected final String TEXT_485 = NL + NL + "\t\t// Create annotations";
	protected final String TEXT_486 = NL + "\t\t// ";
	protected final String TEXT_487 = NL + "\t\tcreate";
	protected final String TEXT_488 = "Annotations();";
	protected final String TEXT_489 = NL + "\t}" + NL;
	protected final String TEXT_490 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
	protected final String TEXT_491 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
	protected final String TEXT_492 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
	protected final String TEXT_493 = "null;";
	protected final String TEXT_494 = "\"";
	protected final String TEXT_495 = "\";";
	protected final String TEXT_496 = "\t";
	protected final String TEXT_497 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
	protected final String TEXT_498 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {";
	protected final String TEXT_499 = NL + "\t\t\t ";
	protected final String TEXT_500 = ", ";
	protected final String TEXT_501 = NL + "\t\t   }";
	protected final String TEXT_502 = ");";
	protected final String TEXT_503 = ",";
	protected final String TEXT_504 = NL + "\t\t   new ";
	protected final String TEXT_505 = "[] " + NL + "\t\t   {";
	protected final String TEXT_506 = NL + "\t\t\t ";
	protected final String TEXT_507 = ".createURI(";
	protected final String TEXT_508 = ".";
	protected final String TEXT_509 = "eNS_URI).appendFragment(\"";
	protected final String TEXT_510 = "\")";
	protected final String TEXT_511 = ",";
	protected final String TEXT_512 = NL + "\t\t   });";
	protected final String TEXT_513 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
	protected final String TEXT_514 = ", " + NL + "\t\t   ";
	protected final String TEXT_515 = "," + NL + "\t\t   ";
	protected final String TEXT_516 = "null,";
	protected final String TEXT_517 = "\"";
	protected final String TEXT_518 = "\",";
	protected final String TEXT_519 = NL + "\t\t   new String[] " + NL + "\t\t   {";
	protected final String TEXT_520 = NL + "\t\t\t ";
	protected final String TEXT_521 = ", ";
	protected final String TEXT_522 = NL + "\t\t   }";
	protected final String TEXT_523 = ");";
	protected final String TEXT_524 = ",";
	protected final String TEXT_525 = NL + "\t\t   new ";
	protected final String TEXT_526 = "[] " + NL + "\t\t   {";
	protected final String TEXT_527 = NL + "\t\t\t ";
	protected final String TEXT_528 = ".createURI(";
	protected final String TEXT_529 = ".";
	protected final String TEXT_530 = "eNS_URI).appendFragment(\"";
	protected final String TEXT_531 = "\")";
	protected final String TEXT_532 = ",";
	protected final String TEXT_533 = NL + "\t\t   });";
	protected final String TEXT_534 = NL + "\t}" + NL;
	protected final String TEXT_535 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL
			+ "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL
			+ "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
	protected final String TEXT_536 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL
			+ "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
	protected final String TEXT_537 = NL + "\t\t}" + NL + "\t\t";
	protected final String TEXT_538 = " uri = ";
	protected final String TEXT_539 = ".createURI(url.toString());" + NL + "\t\t";
	protected final String TEXT_540 = " resource = new ";
	protected final String TEXT_541 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL
			+ "\t\t}" + NL + "\t\tcatch (";
	protected final String TEXT_542 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
	protected final String TEXT_543 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
	protected final String TEXT_544 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
	protected final String TEXT_545 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL
			+ "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL
			+ "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_546 = NL + "\t@Override";
	protected final String TEXT_547 = NL + "\tprotected void fixInstanceClass(";
	protected final String TEXT_548 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL
			+ "\t\t{";
	protected final String TEXT_549 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
	protected final String TEXT_550 = ".\" + eClassifier.getName());";
	protected final String TEXT_551 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
	protected final String TEXT_552 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
	protected final String TEXT_553 = NL + "\t\t\t\tcase ";
	protected final String TEXT_554 = ":";
	protected final String TEXT_555 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL
			+ "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
	protected final String TEXT_556 = ".\" + eClassifier.getName());";
	protected final String TEXT_557 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}"
			+ NL + "\t\t\t}";
	protected final String TEXT_558 = NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_559 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_560 = " addEOperation(";
	protected final String TEXT_561 = " owner, ";
	protected final String TEXT_562 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL
			+ "\t{" + NL + "\t\t";
	protected final String TEXT_563 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);"
			+ NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL + "\t";
	protected final String TEXT_564 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_565 = " addEParameter(";
	protected final String TEXT_566 = " owner, ";
	protected final String TEXT_567 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL
			+ "\t{" + NL + "\t\t";
	protected final String TEXT_568 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);"
			+ NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL
			+ "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
	protected final String TEXT_569 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL
			+ "\t *   <li>each feature of each class,</li>" + NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>"
			+ NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
	protected final String TEXT_570 = "public ";
	protected final String TEXT_571 = "interface Literals" + NL + "\t{";
	protected final String TEXT_572 = NL + "\t\t/**";
	protected final String TEXT_573 = NL + "\t\t * The meta object literal for the '{@link ";
	protected final String TEXT_574 = " <em>";
	protected final String TEXT_575 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @see ";
	protected final String TEXT_576 = NL + "\t\t * The meta object literal for the '{@link ";
	protected final String TEXT_577 = " <em>";
	protected final String TEXT_578 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @see ";
	protected final String TEXT_579 = NL + "\t\t * The meta object literal for the '{@link ";
	protected final String TEXT_580 = " <em>";
	protected final String TEXT_581 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @see ";
	protected final String TEXT_582 = NL + "\t\t * The meta object literal for the '<em>";
	protected final String TEXT_583 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
	protected final String TEXT_584 = NL + "\t\t * @see ";
	protected final String TEXT_585 = NL + "\t\t * @see ";
	protected final String TEXT_586 = "#get";
	protected final String TEXT_587 = "()" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
	protected final String TEXT_588 = " ";
	protected final String TEXT_589 = " = eINSTANCE.get";
	protected final String TEXT_590 = "();" + NL;
	protected final String TEXT_591 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
	protected final String TEXT_592 = "</b></em>' ";
	protected final String TEXT_593 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
	...
	protected void method_setArgument(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		argument = ((Object[]) new Object[] { new Object[] { genPackage,
				genModel.isSuppressEMFMetaData() || genModel.isSuppressInterfaces() ? Boolean.TRUE : Boolean.FALSE, Boolean.TRUE } })[0];
						...
						if (eGenericType.getEClassifier() != null) {
							...
							if (eTypeParameter.eContainer() instanceof EClass) {
								information.type = genModel.findGenClassifier((EClass) eTypeParameter.eContainer())
										...
										+ "_" + eGenericType.getETypeParameter().getName();
							} else {
								information.type = "t"
										+ (((EOperation) eTypeParameter.eContainer()).getETypeParameters().indexOf(eTypeParameter) + 1);
							}
						} else {
							information.type = "";
						}
						...
						for (GenOperation genOperation : genClass.getGenOperations()) {
								...
								for (ListIterator<GenTypeParameter> t = genOperation.getGenTypeParameters().listIterator(); t.hasNext();) {
									...
									if (!genTypeParameter.getEcoreTypeParameter().getEBounds().isEmpty() || genTypeParameter.isUsed()) {
										if (maxTypeParameterAssignment <= t.previousIndex()) {
											...
											typeParameterVariable = genModel.getImportedName("org.eclipse.emf.ecore.ETypeParameter") + " t"
													+ t.nextIndex() + " = ";
										} else {
							...
							for (GenParameter genParameter : genOperation.getGenParameters()) {
								if (genParameter.hasGenericType()) {
									for (InformationIterator i = new InformationIterator(genParameter.getEcoreParameter().getEGenericType()); i
											.hasNext();) {
										Information info = i.next();
										String typePrefix = "";
										if (maxGenericTypeAssignment <= info.depth) {
							...
							if (!genOperation.isVoid() && genOperation.hasGenericType()) {
								for (InformationIterator i = new InformationIterator(genOperation.getEcoreOperation().getEGenericType()); i
										.hasNext();) {
									Information info = i.next();
									String typePrefix = "";
									if (maxGenericTypeAssignment <= info.depth) {
				...
				if (!genPackage.getGenEnums().isEmpty()) {
					...
					for (Iterator<GenEnum> e = genPackage.getGenEnums().iterator(); e.hasNext();) {
						...
						for (GenEnumLiteral genEnumLiteral : genEnum.getGenEnumLiterals()) {
							...
							stringBuffer.append(genEnum.getImportedName().equals(genEnum.getClassifierID()) ? genEnum.getQualifiedName()
				...
				for (String annotationSource : genPackage.getAnnotationSources()) {
					...
					for (EAnnotation eAnnotation : genPackage.getAllAnnotations()) {
						...
						for (EAnnotation nestedEAnnotation : genPackage.getAllNestedAnnotations(eAnnotation)) {
							...
							int depth = 1;
							for (EObject eContainer = nestedEAnnotation.eContainer(); eContainer != eAnnotation; eContainer = eContainer
									.eContainer()) {
								++depth;
							}
							...
							if (!nestedAnnotationReferenceDataList.isEmpty()) {
								...
								for (Iterator<GenPackage.AnnotationReferenceData> l = nestedAnnotationReferenceDataList.iterator(); l
										.hasNext();) {
