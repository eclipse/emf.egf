...
return parameters; }
    ...
    final Map<String, Object> parameters__rijJIGKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rijJIGKSEd8eoMv8ZThYQ.put("genFeature", genFeature);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("isJDK50", isJDK50);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("isInterface", isInterface);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("isImplementation", isImplementation);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("singleWildcard", singleWildcard);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__rijJIGKSEd8eoMv8ZThYQ.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0nXIoGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rijJIGKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rijJIWKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rijJIWKSEd8eoMv8ZThYQ.put("genFeature", genFeature);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("isJDK50", isJDK50);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("isInterface", isInterface);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("isImplementation", isImplementation);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("singleWildcard", singleWildcard);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__rijJIWKSEd8eoMv8ZThYQ.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0nqqoGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rijJIWKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rijJImKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rijJImKSEd8eoMv8ZThYQ.put("setAccessorOperation", setAccessorOperation);
parameters__rijJImKSEd8eoMv8ZThYQ.put("genFeature", genFeature);
parameters__rijJImKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rijJImKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rijJImKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rijJImKSEd8eoMv8ZThYQ.put("isJDK50", isJDK50);
parameters__rijJImKSEd8eoMv8ZThYQ.put("isInterface", isInterface);
parameters__rijJImKSEd8eoMv8ZThYQ.put("isImplementation", isImplementation);
parameters__rijJImKSEd8eoMv8ZThYQ.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__rijJImKSEd8eoMv8ZThYQ.put("singleWildcard", singleWildcard);
parameters__rijJImKSEd8eoMv8ZThYQ.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__rijJImKSEd8eoMv8ZThYQ.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0nz0kGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rijJImKSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__rijJI2KSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__rijJI2KSEd8eoMv8ZThYQ.put("setAccessorOperation", setAccessorOperation);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("genFeature", genFeature);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("isJDK50", isJDK50);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("isInterface", isInterface);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("isImplementation", isImplementation);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("singleWildcard", singleWildcard);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__rijJI2KSEd8eoMv8ZThYQ.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0qMaMGJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__rijJI2KSEd8eoMv8ZThYQ);
    ...
    final Map<String, Object> parameters__risTEGKSEd8eoMv8ZThYQ = new HashMap<String, Object>();
parameters__risTEGKSEd8eoMv8ZThYQ.put("setAccessorOperation", setAccessorOperation);
parameters__risTEGKSEd8eoMv8ZThYQ.put("genFeature", genFeature);
parameters__risTEGKSEd8eoMv8ZThYQ.put("genClass", genClass);
parameters__risTEGKSEd8eoMv8ZThYQ.put("genPackage", genPackage);
parameters__risTEGKSEd8eoMv8ZThYQ.put("genModel", genModel);
parameters__risTEGKSEd8eoMv8ZThYQ.put("isJDK50", isJDK50);
parameters__risTEGKSEd8eoMv8ZThYQ.put("isInterface", isInterface);
parameters__risTEGKSEd8eoMv8ZThYQ.put("isImplementation", isImplementation);
parameters__risTEGKSEd8eoMv8ZThYQ.put("publicStaticFinalFlag", publicStaticFinalFlag);
parameters__risTEGKSEd8eoMv8ZThYQ.put("singleWildcard", singleWildcard);
parameters__risTEGKSEd8eoMv8ZThYQ.put("negativeOffsetCorrection", negativeOffsetCorrection);
parameters__risTEGKSEd8eoMv8ZThYQ.put("positiveOffsetCorrection", positiveOffsetCorrection);
CallHelper.executeWithParameterInjection("platform:/plugin/org.eclipse.egf.emf.pattern/egf/EMF_Pattern.fcore#_0qMaRWJ-Ed-FqczH3ESmRw", new ExecutionContext((InternalPatternContext) ctx), parameters__risTEGKSEd8eoMv8ZThYQ);
