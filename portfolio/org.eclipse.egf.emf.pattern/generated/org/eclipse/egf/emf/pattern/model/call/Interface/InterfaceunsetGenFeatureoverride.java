...
public class InterfaceunsetGenFeatureoverride {
	...
	public static synchronized InterfaceunsetGenFeatureoverride create(
	...
	protected final String TEXT_45 = "(msgs);" + NL
			+ "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}" + NL
			+ "\t\telse" + NL + "\t\t{";
	...
	protected final String TEXT_61 = NL + "\t\t\tif (eNotificationRequired())"
			+ NL + "\t\t\t\teNotify(new ";
	...
	protected final String TEXT_102 = NL + "\t\tif (eNotificationRequired())"
			+ NL + "\t\t\teNotify(new ";
	...
	protected final String TEXT_133 = NL + "\t\tif (eNotificationRequired())"
			+ NL + "\t\t\teNotify(new ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (!isImplementation) {
			...
			if (genModel.isDynamicDelegation()) {
				...
				stringBuffer.append(genClass.getUnsetAccessorOperation(
						genFeature).getBody(
