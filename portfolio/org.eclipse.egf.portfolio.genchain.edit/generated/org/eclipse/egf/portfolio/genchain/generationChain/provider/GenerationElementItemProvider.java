...
public class GenerationElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_GenerationElement_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_GenerationElement_name_feature", "_UI_GenerationElement_type"), GenerationChainPackage.Literals.GENERATION_ELEMENT__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addContainerPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_GenerationElement_container_feature"), getString("_UI_PropertyDescriptor_description", "_UI_GenerationElement_container_feature", "_UI_GenerationElement_type"), GenerationChainPackage.Literals.GENERATION_ELEMENT__CONTAINER, true, false, true, null, null, null));
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(GenerationElement.class)) {
