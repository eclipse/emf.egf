...
method_fileFooter(ictx.getBuffer(), ictx);
    CallHelper.callBack(new CallbackContext(ictx), element);
...
return loop;
    ...
    protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx, final org.eclipse.emf.ecore.EPackage element)throws Exception {

    stringBuffer.append(TEXT_1);
    stringBuffer.append( element.getName() );
    stringBuffer.append(TEXT_2);
    }
    protected void method_setVariable(final StringBuffer stringBuffer, final PatternContext ctx, final org.eclipse.emf.ecore.EPackage element)throws Exception {
