...
public class PackageReport extends emf.docgen.html.EPackageDocGen {
	...
	protected final String TEXT_2 = "</p>" + NL;
	...
	public String orchestration(PatternContext ctx) throws Exception {
		...
		method_writeESubpackages(new StringBuffer(), ictx);

		method_writeEClasses(new StringBuffer(), ictx);

		method_writeEDataType(new StringBuffer(), ictx);

		method_writeEEnum(new StringBuffer(), ictx);
