...
public class ProductionPlanFactoryImpl extends EFactoryImpl implements ProductionPlanFactory {
  ...
  public static ProductionPlanFactory init() {
    try {
      ProductionPlanFactory theProductionPlanFactory = (ProductionPlanFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/egf/1.0.0/productionplan"); //$NON-NLS-1$ 
