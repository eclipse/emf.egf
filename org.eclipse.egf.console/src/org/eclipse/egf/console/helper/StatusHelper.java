...
package org.eclipse.egf.console.helper;
...
public class StatusHelper {
  ...
  public static IStatus newStatus(int severity, String message, Throwable exception) {
    ...
    return new Status(
      severity, 
      EGFConsolePlugin.getDefault().getPluginID(), 
      severity,
      statusMessage, 
      exception
    );
  ...
  */
  protected static IStatus newStatus(String pluginID, IStatus[] stati, String message, Throwable exception) {
    ...
    return new MultiStatus(
      pluginID != null && pluginID.trim().length() > 0 ? pluginID : EGFConsolePlugin.getDefault().getPluginID(), 
      IStatus.ERROR, 
      stati, 
      message, 
      exception
