...
public class FilteredTypeSelectionDialog extends FilteredItemsSelectionDialog {

  private static final String DIALOG_SETTINGS = "org.eclipse.egf.core.ui.dialogs.FilteredTypeSelectionDialog"; //$NON-NLS-1$
  ...
  private class TypeItemsFilter extends ItemsFilter {
    ...
    private int _MyFilterVersion = _filterVersion;

    private TypeInfoFilter _infoFilter;
  ...
  public FilteredTypeSelectionDialog(Shell parentShell, IProject project, Class<?> clazz, String current, TypeSelectionExtension extension, boolean multipleSelection) {
    ...
    setMessage(NLS.bind(CoreUIMessages._UI_SelectTypeSubClass, _clazz.getName()));
  ...
  protected void fillContentProvider(AbstractContentProvider contentProvider, ItemsFilter itemsFilter, IProgressMonitor monitor) throws CoreException {
    // Invoke
    SubMonitor subMonitor = SubMonitor.convert(monitor, _clazz != null ? NLS.bind(CoreUIMessages.FilteredTypeSelectionDialog_findTypeHierarchy, _clazz.getName()) : CoreUIMessages.FilteredTypeSelectionDialog_findType, 1000);
