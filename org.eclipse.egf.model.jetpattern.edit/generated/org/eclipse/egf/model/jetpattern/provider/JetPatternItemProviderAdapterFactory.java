 ...
 * @generated
 */
public class JetPatternItemProviderAdapterFactory extends JetPatternAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier,
    IDisposable {
  /**
  ...
  public static class PatternChildCreationExtender implements IChildCreationExtender {
    ...
    protected static class CreationSwitch extends PatternSwitch<Object> {
      ...
      public Object casePattern(Pattern object) {
        newChildDescriptors
            .add(createChildParameter(PatternPackage.Literals.PATTERN__NATURE, JetPatternFactory.eINSTANCE.createJetNature()));
