...
public class ConsoleOutputTestResultItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConsoleOutputTestResult_text_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ConsoleOutputTestResult_text_feature", "_UI_ConsoleOutputTestResult_type"),
                 TestPackage.Literals.CONSOLE_OUTPUT_TEST_RESULT__TEXT,
                 true,
                 true,
                 false,
  ...
  public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ConsoleOutputTestResult.class)) {
