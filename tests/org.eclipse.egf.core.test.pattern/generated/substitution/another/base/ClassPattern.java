...
ExecutionContext ctx__AMqksEidEdTSsH7K_bxQ = new ExecutionContext(ictx);
CallHelper.executeWithInjection("_4ahL8Eh5Ed-A7KV9v5yLhw", ctx__AMqksEidEdTSsH7K_bxQ, parameters);
}

    ExecutionContext ctx__AMrLwEidEdTSsH7K_bxQ = new ExecutionContext(ictx);
ctx__AMrLwEidEdTSsH7K_bxQ.setValue(PatternContext.INJECTED_CONTEXT, parameter);
CallHelper.execute("_7RsNYEh5Ed-A7KV9v5yLhw", ctx__AMrLwEidEdTSsH7K_bxQ);
