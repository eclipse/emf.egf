...
toInject.setName("MyClassName");
    ...
    ExecutionContext ctx__vJvB4FbDEd8M5d7emTXBQ = new ExecutionContext((InternalPatternContext) ctx);
ctx__vJvB4FbDEd8M5d7emTXBQ.setValue(PatternContext.INJECTED_CONTEXT, toInject);
CallHelper.execute("_-d1XsFa7Ed-_dcUlU_GyPA", ctx__vJvB4FbDEd8M5d7emTXBQ);
