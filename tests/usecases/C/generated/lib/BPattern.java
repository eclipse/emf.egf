...
public class BPattern {
	...
	public static synchronized BPattern create(String lineSeparator) {
		nl = lineSeparator;
		BPattern result = new BPattern();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "node B" + NL;
	...
	public String generate(Object argument) throws Exception {
		...
		for (Object parameterParameter : parameterList) {
			...
			this.parameter = (package_b.B) parameterParameter;
	...
	protected package_b.B parameter = null;

	public void set_parameter(package_b.B object) {
